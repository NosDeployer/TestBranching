...
namespace LiquiForce.LFSLive.CWP.Reports {
    ...
    public class rToBePrepped : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "LiquiForce.LFSLive.CWP.Reports.rToBePrepped.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrToBePrepped : Component, ICachedReport {
        
        public CachedrToBePrepped() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rToBePrepped rpt = new rToBePrepped();
            rpt.Site = this.Site;
            return rpt;
        }
