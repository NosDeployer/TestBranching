...
{
    /// <summary>
    /// ServicesAddRequestCostInformationGateway
    /// </summary>
    public class ServicesAddRequestCostInformationGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ServicesAddRequestCostInformationGateway()
        ...
        public ServicesAddRequestCostInformationGateway(DataSet data)
        ...
        public DataRow GetRow(int serviceId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.FleetManagement.Services.ServiceAddRequestCostInformationGateway.GetRow");
            }
        }
