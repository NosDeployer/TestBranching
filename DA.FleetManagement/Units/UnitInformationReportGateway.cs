...
{
    /// <summary>
    /// UnitInformationReportGateway
    /// </summary>
    public class UnitInformationReportGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public UnitInformationReportGateway()
        ...
        public UnitInformationReportGateway(DataSet data)
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "UnitInformationReport";
        ...
        {
            FillDataWithStoredProcedure("LFS_FM_UNITINFORMATIONREPORTGATEWAY_LOAD", new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_FM_UNITINFORMATIONREPORTGATEWAY_LOADBYUNITID", new SqlParameter("@unitId", unitId), new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_FM_UNITINFORMATIONREPORTGATEWAY_LOADBYUNITTYPE", new SqlParameter("@unitType", unitType), new SqlParameter("@companyId", companyId));
            return Data;
        }
