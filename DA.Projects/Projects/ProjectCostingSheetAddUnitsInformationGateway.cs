...
{
    /// <summary>
    /// ProjectCostingSheetAddUnitsInformationGateway
    /// </summary>
    public class ProjectCostingSheetAddUnitsInformationGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Default constructor
        /// </summary>
        public ProjectCostingSheetAddUnitsInformationGateway()
        ...
        public ProjectCostingSheetAddUnitsInformationGateway(DataSet data)
        ...
        public DataRow GetRow(int costingSheetId, string work_, int unitId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.Projects.Projects.ProjectCostingSheetAddUnitsInformationGateway.GetRow");
            }
        }
