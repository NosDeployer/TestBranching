...
{
    /// <summary>
    /// ProjectCostingSheetMaterialsGateway
    /// </summary>
    public class ProjectCostingSheetMaterialsGateway : DataTableGateway
    {
        ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ProjectCostingSheetMaterialsGateway()
            : base("LFS_PROJECT_COSTING_SHEET_MATERIAL")
        {
        }
        ...
        public ProjectCostingSheetMaterialsGateway(DataSet data)
            : base(data, "LFS_PROJECT_COSTING_SHEET_MATERIAL")
        {
        }
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "LFS_PROJECT_COSTING_SHEET_MATERIAL";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[LFS_PROJECT_COSTING_SHEET_MATERIAL] ([CostingSheetID], [MaterialID], [RefID], [UnitOfMeasurement], [Quantity], [CostCad], [TotalCostCad], [CostUsd], [TotalCostUsd], [Deleted], [COMPANY_ID], [StartDate], [EndDate], [Function_]) VALUES (@CostingSheetID, @MaterialID, @RefID, @UnitOfMeasurement, @Quantity, @CostCad, @TotalCostCad, @CostUsd, @TotalCostUsd, @Deleted, @COMPANY_ID, @StartDate, @EndDate, @Function_);
SELECT CostingSheetID, MaterialID, RefID, UnitOfMeasurement, Quantity, CostCad, TotalCostCad, CostUsd, TotalCostUsd, Deleted, COMPANY_ID, StartDate, EndDate, Function_ FROM LFS_PROJECT_COSTING_SHEET_MATERIAL WHERE (CostingSheetID = @CostingSheetID) AND (MaterialID = @MaterialID) AND (RefID = @RefID)";
...
SELECT CostingSheetID, MaterialID, RefID, UnitOfMeasurement, Quantity, CostCad, TotalCostCad, CostUsd, TotalCostUsd, Deleted, COMPANY_ID, StartDate, EndDate, Function_ FROM LFS_PROJECT_COSTING_SHEET_MATERIAL WHERE (CostingSheetID = @CostingSheetID) AND (MaterialID = @MaterialID) AND (RefID = @RefID)";
        ...
        public void Insert(int costingSheetId, int materialId, int refId, string unitOfMeasurement, double quantity, decimal costCad, decimal totalCostCad, decimal costUsd, decimal totalCostUsd, bool deleted, int companyId, DateTime startDate, DateTime endDate, string function_)
        {
            ...
            string command = "INSERT INTO [dbo].[LFS_PROJECT_COSTING_SHEET_MATERIAL] ([CostingSheetID], [MaterialID], [RefID], [UnitOfMeasurement], [Quantity], [CostCad], " +
                             " [TotalCostCad], [CostUsd], [TotalCostUsd], [Deleted], [COMPANY_ID], [StartDate],[EndDate], [Function_]) VALUES (@CostingSheetID, @MaterialID, @RefID, @UnitOfMeasurement, @Quantity, " +
                             " @CostCad, @TotalCostCad, @CostUsd, @TotalCostUsd, @Deleted, @COMPANY_ID, @StartDate, @EndDate, @Function_)";

            ExecuteScalar(command, costingSheetIdParameter, materialIdParameter, refIdParameter, unitOfMeasurementParameter, quantityParameter, costCadParameter, totalCostCadParameter, costUsdParameter, totaldCostUsdParameter, deletedParameter, companyIdParameter, startDateParameter, endDateParameter, function_Parameter);
        }
        ...
        public void Update(int costingSheetId, int materialId, int refId, string originalUnitOfMeasurement, double originalQuantity, decimal originalCostCad, decimal originalTotalCostCad, decimal originalCostUsd, decimal originalTotalCostUsd, bool originalDeleted, int originalCompanyId, DateTime originalStartDate, DateTime originalEndDate, string originalFunction_, string newUnitOfMeasurement, double newQuantity, decimal newCostCad, decimal newTotalCostCad, decimal newCostUsd, decimal newTotalCostUsd, bool newDeleted, int newCompanyId, DateTime newStartDate, DateTime newEndDate, string newFunction_)
        {
            ...
            string command = "UPDATE [dbo].[LFS_PROJECT_COSTING_SHEET_MATERIAL] SET [CostingSheetID] = @CostingSheetID, [MaterialID] = @MaterialID, [RefID] = @RefID, [UnitOfMeasurement] = @UnitOfMeasurement, "+
        ...
        public int DeleteAll(int originalCostingSheetId, int originalCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_PROJECT_COSTING_SHEET_MATERIAL] SET  [Deleted] = @Deleted  " +
