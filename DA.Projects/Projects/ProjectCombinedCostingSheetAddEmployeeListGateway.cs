...
{
    /// <summary>
    /// ProjectCombinedCostingSheetAddEmployeeListGateway
    /// </summary>
    public class ProjectCombinedCostingSheetAddEmployeeListGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Default constructor
        /// </summary>
        public ProjectCombinedCostingSheetAddEmployeeListGateway()
            : base("EmployeeList")
        {
        }
        ...
        public ProjectCombinedCostingSheetAddEmployeeListGateway(DataSet data)
        ...
        public DataRow GetRow(int employeeId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.Projects.Projects.ProjectCombinedCostingSheetAddEmployeeListGateway.GetRow");
            }
        }
