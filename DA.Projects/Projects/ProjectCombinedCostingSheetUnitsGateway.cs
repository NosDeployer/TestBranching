...
{
    /// <summary>
    /// ProjectCombinedCostingSheetUnitsGateway
    /// </summary>
    public class ProjectCombinedCostingSheetUnitsGateway : DataTableGateway
    {
        ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ProjectCombinedCostingSheetUnitsGateway()
            : base("LFS_PROJECT_COMBINED_COSTING_SHEET_UNITS")
        {
        }
        ...
        public ProjectCombinedCostingSheetUnitsGateway(DataSet data)
            : base(data, "LFS_PROJECT_COMBINED_COSTING_SHEET_UNITS")
        {
        }
...
SELECT CostingSheetID, Work_, UnitID, RefID, UnitOfMeasurement, Quantity, CostCad, TotalCostCad, CostUsd, TotalCostUsd, Deleted, COMPANY_ID, StartDate, EndDate, Function_ FROM LFS_PROJECT_COMBINED_COSTING_SHEET_UNITS WHERE (CostingSheetID = @CostingSheetID) AND (RefID = @RefID) AND (UnitID = @UnitID) AND (Work_ = @Work_)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[LFS_PROJECT_COMBINED_COSTING_SHEET_UNITS] SET [CostingSheetID] = @CostingShe" +
                ...
                " Function_ FROM LFS_PROJECT_COMBINED_COSTING_SHEET_UNITS WHERE (CostingSheetID = @Costing" +
        ...
        public void Insert(int costingSheetId, string work_, int unitId, int refId, string unitOfMeasurement, double quantity, decimal costCad, decimal totalCostCad, decimal costUsd, decimal totalCostUsd, bool deleted, int companyId, DateTime startDate, DateTime endDate, string function_, int projectId)
        {
            ...
            string command = "INSERT INTO [dbo].[LFS_PROJECT_COMBINED_COSTING_SHEET_UNITS] ([CostingSheetID], [Work_], [UnitID], [RefID], [UnitOfMeasurement], [Quantity], [CostCad], "+
                             " [TotalCostCad], [CostUsd], [TotalCostUsd], [Deleted], [COMPANY_ID], [StartDate], [EndDate], [Function_], [ProjectID]) VALUES (@CostingSheetID, @Work_, @UnitID, @RefID, @UnitOfMeasurement, "+
                             " @Quantity, @CostCad, @TotalCostCad, @CostUsd, @TotalCostUsd, @Deleted, @COMPANY_ID, @StartDate, @EndDate, @Function_, @ProjectID)";
        ...
        public void Update(int costingSheetId, string work_, int unitId, int refId, string originalUnitOfMeasurement, double originalQuantity, decimal originalCostCad, decimal originalTotalCostCad, decimal originalCostUsd, decimal originalTotalCostUsd, bool originalDeleted, int originalCompanyId, DateTime originalStartDate, DateTime originalEndDate, string originalFunction_, string newUnitOfMeasurement, double newQuantity, decimal newCostCad, decimal newTotalCostCad, decimal newCostUsd, decimal newTotalCostUsd, bool newDeleted, int newCompanyId, DateTime newStartDate, DateTime newEndDate, string newFunction_)
        {
            ...
            string command = "UPDATE [dbo].[LFS_PROJECT_COMBINED_COSTING_SHEET_UNITS] SET [CostingSheetID] = @CostingSheetID, [Work_] = @Work_, [UnitID] = @UnitID, [RefID] = @RefID, [UnitOfMeasurement] = @UnitOfMeasurement, "+
        ...
        public int DeleteAll(int originalcostingSheetId, int originalCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_PROJECT_COMBINED_COSTING_SHEET_UNITS] SET  [Deleted] = @Deleted  " +
