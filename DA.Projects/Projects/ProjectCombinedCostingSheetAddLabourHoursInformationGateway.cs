...
{
    /// <summary>
    /// ProjectCombinedCostingSheetAddLabourHoursInformationGateway
    /// </summary>
    public class ProjectCombinedCostingSheetAddLabourHoursInformationGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Default constructor
        /// </summary>
        public ProjectCombinedCostingSheetAddLabourHoursInformationGateway()
        ...
        public ProjectCombinedCostingSheetAddLabourHoursInformationGateway(DataSet data)
        ...
        public DataRow GetRow(int costingSheetId, string work_, int employeeId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.Projects.Projects.ProjectCombinedCostingSheetAddLabourHoursInformationGateway.GetRow");
            }
        }
