...
namespace LiquiForce.LFSLive.DA.Projects.Projects
{
    ...
    /// </summary>
    public class ProjectCostingSheetInformationMaterialsInformationGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Default constructor
        /// </summary>
        public ProjectCostingSheetInformationMaterialsInformationGateway()
        ...
        public ProjectCostingSheetInformationMaterialsInformationGateway(DataSet data)
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "MaterialsInformation";
        ...
        {
            FillDataWithStoredProcedure("LFS_PROJECTS_PROJECTCOSTINGSHEETINFORMATIONMATERIALSINFORMATIONGATEWAY_LOADBYCOSTINGSHEETID", new SqlParameter("@costingSheetId", costingSheetId), new SqlParameter("@companyId", companyId));
            return Data;            
        }
        ...
        public DataRow GetRow(int costingSheetId, int materialId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.Projects.Projects.ProjectCostingSheetInformationMaterialsInformationGateway.GetRow");
            }
        }
