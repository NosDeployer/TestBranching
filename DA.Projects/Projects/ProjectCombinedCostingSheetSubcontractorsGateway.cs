...
{
    /// <summary>
    /// ProjectCombinedCostingSheetSubcontractorsGateway
    /// </summary>
    public class ProjectCombinedCostingSheetSubcontractorsGateway : DataTableGateway
    {
        ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ProjectCombinedCostingSheetSubcontractorsGateway()
        ...
        public ProjectCombinedCostingSheetSubcontractorsGateway(DataSet data)
...
SELECT CostingSheetID, Work_, SubcontractorID, RefID, UnitOfMeasurement, Quantity, CostCad, TotalCostCad, CostUsd, TotalCostUsd, Deleted, COMPANY_ID, StartDate, EndDate, Function_ FROM LFS_PROJECT_COMBINED_COSTING_SHEET_SUBCONTRACTOR WHERE (CostingSheetID = @CostingSheetID) AND (RefID = @RefID) AND (SubcontractorID = @SubcontractorID) AND (Work_ = @Work_)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[LFS_PROJECT_COMBINED_COSTING_SHEET_SUBCONTRACTOR] SET [CostingSheetID] = @CostingShe" +
                ...
                " Function_ FROM LFS_PROJECT_COMBINED_COSTING_SHEET_SUBCONTRACTOR WHERE (CostingSheetID = @Costing" +
        ...
        public void Insert(int costingSheetId, int subcontractorID, int refId, string unitOfMeasurement, double quantity, decimal costCad, decimal totalCostCad, decimal costUsd, decimal totalCostUsd, bool deleted, int companyId, DateTime startDate, DateTime endDate, string comment, int projectId)
        {
            ...
            string command = "INSERT INTO [dbo].[LFS_PROJECT_COMBINED_COSTING_SHEET_SUBCONTRACTOR] ([CostingSheetID], [SubcontractorID], [RefID], [UnitOfMeasurement], [Quantity], [CostCad], "+
                             " [TotalCostCad], [CostUsd], [TotalCostUsd], [Deleted], [COMPANY_ID], [StartDate], [EndDate], [Comment], [ProjectID]) VALUES (@CostingSheetID, @SubcontractorID, @RefID, @UnitOfMeasurement, "+
                             " @Quantity, @CostCad, @TotalCostCad, @CostUsd, @TotalCostUsd, @Deleted, @COMPANY_ID, @StartDate, @EndDate, @Comment, @ProjectID)";

            ExecuteScalar(command, costingSheetIdParameter, subcontractorIDParameter, refIdParameter, unitOfMeasurementParameter, quantityParameter, costCadParameter, totalCostCadParameter, costUsdParameter, totalCostUsdParameter, deletedParameter, companyIdParameter, startDateParameter, endDateParameter, commentParameter, projectIdParameter);
        }
        ...
        public void Update(int costingSheetId, int subcontractorID, int refId, string originalUnitOfMeasurement, double originalQuantity, decimal originalCostCad, decimal originalTotalCostCad, decimal originalCostUsd, decimal originalTotalCostUsd, bool originalDeleted, int originalCompanyId, DateTime originalStartDate, DateTime originalEndDate, string newUnitOfMeasurement, double newQuantity, decimal newCostCad, decimal newTotalCostCad, decimal newCostUsd, decimal newTotalCostUsd, bool newDeleted, int newCompanyId, DateTime newStartDate, DateTime newEndDate)
        {
            ...
            string command = "UPDATE [dbo].[LFS_PROJECT_COMBINED_COSTING_SHEET_SUBCONTRACTOR] SET [CostingSheetID] = @CostingSheetID, [SubcontractorID] = @SubcontractorID, [RefID] = @RefID, [UnitOfMeasurement] = @UnitOfMeasurement, "+
        ...
        public int DeleteAll(int originalcostingSheetId, int originalCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_PROJECT_COMBINED_COSTING_SHEET_SUBCONTRACTOR] SET  [Deleted] = @Deleted  " +
