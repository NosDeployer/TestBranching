...
{
    /// <summary>
    /// ProjectCostingSheetGateway
    /// </summary>
    public class ProjectCostingSheetGateway : DataTableGateway
    {
        ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ProjectCostingSheetGateway()
        ...
        public ProjectCostingSheetGateway(DataSet data)
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "LFS_PROJECT_COSTING_SHEET";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[LFS_PROJECT_COSTING_SHEET] ([ProjectID], [Name], [StartDate], [EndDate], [TotalLabourHoursCad], [TotalLabourHoursUsd], [TotalMaterialsCad], [TotalMaterialsUsd], [TotalUnitsCad], [TotalUnitsUsd], [TotalOtherCostsCad], [TotalOtherCostsUsd], [GrandTotalCad], [GrandTotalUsd], [State], [Deleted], [COMPANY_ID], [TotalSubcontractorsCad], [TotalSubcontractorsUsd], [GrandRevenue], [GrandProfit], [GrandGrossMargin]) VALUES (@ProjectID, @Name, @StartDate, @EndDate, @TotalLabourHoursCad, @TotalLabourHoursUsd, @TotalMaterialsCad, @TotalMaterialsUsd, @TotalUnitsCad, @TotalUnitsUsd, @TotalOtherCostsCad, @TotalOtherCostsUsd, @GrandTotalCad, @GrandTotalUsd, @State, @Deleted, @COMPANY_ID, @TotalSubcontractorsCad, @TotalSubcontractorsUsd, @GrandRevenue, @GrandProfit, @GrandGrossMargin);
SELECT CostingSheetID, ProjectID, Name, StartDate, EndDate, TotalLabourHoursCad, TotalLabourHoursUsd, TotalMaterialsCad, TotalMaterialsUsd, TotalUnitsCad, TotalUnitsUsd, TotalOtherCostsCad, TotalOtherCostsUsd, GrandTotalCad, GrandTotalUsd, State, Deleted, COMPANY_ID, TotalSubcontractorsCad, TotalSubcontractorsUsd, GrandRevenue, GrandProfit, GrandGrossMargin FROM LFS_PROJECT_COSTING_SHEET WHERE (CostingSheetID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[LFS_PROJECT_COSTING_SHEET] SET [ProjectID] = @ProjectID, [Name] = @" +
                ...
                "Margin WHERE (([CostingSheetID] = @Original_CostingSheetID) AND ([ProjectID] = @" +
                "Original_ProjectID) AND ([Name] = @Original_Name) AND ([StartDate] = @Original_S" +
                ...
                "rossMargin));\r\nSELECT CostingSheetID, ProjectID, Name, StartDate, EndDate, Total" +
        ...
        public int Insert(int projectId, string name, DateTime startDate, DateTime endDate, decimal totalLabourHoursCad, decimal totalLabourHoursUsd, decimal totalMaterialsCad, decimal totalMaterialsUsd, decimal totalUnitsCad, decimal totalUnitsUsd, decimal totalOtherCostsCad, decimal totalOtherCostsUsd, decimal grandTotalCad, decimal grandTotalUsd, string state, bool deleted, int companyId, decimal totalSubcontractorsCad, decimal totalSubcontractorsUsd, decimal grandRevenue, decimal grandProfit, decimal grandGrossMargin)
        {
            ...
            string command = "INSERT INTO [dbo].[LFS_PROJECT_COSTING_SHEET] ([ProjectID], [Name], [StartDate], [EndDate], [TotalLabourHoursCad], [TotalLabourHoursUsd], [TotalMaterialsCad], "+
                            ...
                            " [TotalSubcontractorsCad], [TotalSubcontractorsUsd], [GrandRevenue], [GrandProfit], [GrandGrossMargin]) " +
                             " VALUES (@ProjectID, @Name, @StartDate, @EndDate, @TotalLabourHoursCad, @TotalLabourHoursUsd, @TotalMaterialsCad, "+
                             ...
                             " @TotalSubcontractorsUsd, @GrandRevenue, @GrandProfit, @GrandGrossMargin); SELECT CostingSheetID FROM LFS_PROJECT_COSTING_SHEET WHERE (CostingSheetID = SCOPE_IDENTITY())";

            int costingSheetId = (int)ExecuteScalar(command, projectIdParameter, nameParameter, startDateParameter, endDateParameter, totalLabourHoursCadParameter, totalLabourHoursUsdParameter, totalMaterialsCadParameter, totalMaterialsUsdParameter, totalUnitsCadParameter, totalUnitsUsdParameter, totalOtherCostsCadParameter, totalOtherCostsUsdParameter, grandTotalCadParameter, grandTotalUsdParameter, stateParameter, deletedParameter, companyIdParameter, totalSubcontractorsCadParameter, totalSubcontractorsUsdParameter, grandRevenueParameter, grandProfitParameter, grandGrossMarginParameter);
        ...
        public void Update(int costingSheetId, int originalProjectId, string originalName, DateTime originalStartDate, DateTime originalEndDate, decimal originalTotalLabourHoursCad, decimal originalTotalLabourHoursUsd, decimal originalTotalMaterialsCad, decimal originalTotalMaterialsUsd, decimal originalTotalUnitsCad, decimal originalTotalUnitsUsd, decimal originalTotalOtherCostsCad, decimal originalTotalOtherCostsUsd, decimal originalGrandTotalCad, decimal originalGrandTotalUsd, string originalState, bool originalDeleted, int originalCompanyId, decimal originalTotalSubcontractorsCad, decimal originalTotalSubcontractorsUsd, decimal originalGrandRevenue, decimal originalGrandProfit, decimal originalGrandGrossMargin, int newProjectId, string newName, DateTime newStartDate, DateTime newEndDate, decimal newTotalLabourHoursCad, decimal newTotalLabourHoursUsd, decimal newTotalMaterialsCad, decimal newTotalMaterialsUsd, decimal newTotalUnitsCad, decimal newTotalUnitsUsd, decimal newTotalOtherCostsCad, decimal newTotalOtherCostsUsd, decimal newGrandTotalCad, decimal newGrandTotalUsd, string newState, bool newDeleted, int newCompanyId, decimal newTotalSubcontractorsCad, decimal newTotalSubcontractorsUsd, decimal newGrandRevenue, decimal newGrandProfit, decimal newGrandGrossMargin)
        {
            ...
            string command = "UPDATE [dbo].[LFS_PROJECT_COSTING_SHEET] " +
                " SET [ProjectID] = @ProjectID, [StartDate] = @StartDate, [EndDate] = @EndDate, " +
        ...
        public int Delete(int originalcostingSheetId, int originalCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_PROJECT_COSTING_SHEET] SET  [Deleted] = @Deleted  " +
        ...
        /// <summary>
        /// GetLastCostingSheetId
        /// </summary>
        /// <returns>Last CostingSheetID</returns>
        public int GetLastCostingSheetId()
        {
            string commandText = "SELECT MAX(CostingSheetID) AS costingSheetId FROM LFS_PROJECT_COSTING_SHEET";
        ...
        public bool ExistCostingSheetApproved(int projectId, DateTime startDate, DateTime endDate)
        {
            string commandText = "SELECT COUNT(*) FROM LFS_PROJECT_COSTING_SHEET WHERE (ProjectID = @projectId) AND ((StartDate BETWEEN @startDate AND @endDate) OR (EndDate BETWEEN @startDate AND @endDate)) AND (State = 'Approved') AND (Deleted = 0)";
            SqlCommand command = new SqlCommand(commandText, DB.Connection);
        ...
        /// <param name="projectId">projectId</param>
        /// <returns>TRUE if is used</returns>
        public bool ValidateDateOfCostingSheet(int projectId, DateTime startDate, DateTime endDate)
        {
            string commandText = "SELECT COUNT(*) FROM LFS_PROJECT WHERE (ProjectID = @projectId) AND (StartDate <= @startDate) AND (EndDate >= @endDate) AND (Deleted = 0)";
            SqlCommand command = new SqlCommand(commandText, DB.Connection);
            command.Parameters.Add(new SqlParameter("@projectId", projectId));
            command.Parameters.Add(new SqlParameter("@startDate", startDate));
            command.Parameters.Add(new SqlParameter("@endDate", endDate));
