...
namespace LiquiForce.LFSLive.DA.Projects.Projects
{
    ...
    /// </summary>
    public class ProjectCostingSheetInformationLabourHoursInformationGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Default constructor
        /// </summary>
        public ProjectCostingSheetInformationLabourHoursInformationGateway()
        ...
        public ProjectCostingSheetInformationLabourHoursInformationGateway(DataSet data)
        ...
        {
            FillDataWithStoredProcedure("LFS_PROJECTS_PROJECTCOSTINGSHEETINFORMATIONLABOURHOURSINFORMATIONGATEWAY_LOADBYCOSTINGSHEETID", new SqlParameter("@costingSheetId", costingSheetId), new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        public DataRow GetRow(int costingSheetId, string work_, int employeeId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.Projects.Projects.ProjectCostingSheetInformationLabourHoursInformationGateway.GetRow");
            }
        }
