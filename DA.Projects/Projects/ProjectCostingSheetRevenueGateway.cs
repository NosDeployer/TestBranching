...
{
    /// <summary>
    /// ProjectCostingSheetRevenueGateway
    /// </summary>
    public class ProjectCostingSheetRevenueGateway : DataTableGateway
    {
        ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ProjectCostingSheetRevenueGateway()
        ...
        public ProjectCostingSheetRevenueGateway(DataSet data)
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "LFS_PROJECT_COSTING_SHEET_REVENUE";
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[LFS_PROJECT_COSTING_SHEET_REVENUE] WHERE (([CostingSheetID] = @Original_CostingSheetID) AND ([RefIDRevenue] = @Original_RefIDRevenue) AND ([Revenue] = @Original_Revenue) AND ([COMPANY_ID] = @Original_COMPANY_ID) AND ((@IsNull_StartDate = 1 AND [StartDate] IS NULL) OR ([StartDate] = @Original_StartDate)) AND ((@IsNull_EndDate = 1 AND [EndDate] IS NULL) OR ([EndDate] = @Original_EndDate)) AND ([Deleted] = @Original_Deleted))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[LFS_PROJECT_COSTING_SHEET_REVENUE] ([CostingSheetID], [RefIDRevenue], [Revenue], [Comment], [COMPANY_ID], [StartDate], [EndDate], [Deleted]) VALUES (@CostingSheetID, @RefIDRevenue, @Revenue, @Comment, @COMPANY_ID, @StartDate, @EndDate, @Deleted);
SELECT CostingSheetID, RefIDRevenue, Revenue, Comment, COMPANY_ID, StartDate, EndDate, Deleted FROM LFS_PROJECT_COSTING_SHEET_REVENUE WHERE (CostingSheetID = @CostingSheetID) AND (RefIDRevenue = @RefIDRevenue)";
...
SELECT CostingSheetID, RefIDRevenue, Revenue, Comment, COMPANY_ID, StartDate, EndDate, Deleted FROM LFS_PROJECT_COSTING_SHEET_REVENUE WHERE (CostingSheetID = @CostingSheetID) AND (RefIDRevenue = @RefIDRevenue)";
        ...
        public void Insert(int costingSheetId, int refIDRevenue, decimal revenue, bool deleted, int companyId, DateTime startDate, DateTime endDate, string comment)
        {
            ...
            string command = "INSERT INTO [dbo].[LFS_PROJECT_COSTING_SHEET_REVENUE] ([CostingSheetID], [RefIDRevenue], [Revenue], [Deleted], [COMPANY_ID], [StartDate], [EndDate], [Comment]) " + 
                             " VALUES (@CostingSheetID, @RefIDRevenue, @Revenue, @Deleted, @COMPANY_ID, @StartDate, @EndDate, @Comment)";
            
            ExecuteScalar(command, costingSheetIdParameter, refIDRevenueParameter, revenueParameter, deletedParameter, companyIdParameter, startDateParameter, endDateParameter, commentParameter);
        }
        ...
        public void Update(int costingSheetId, int refIDRevenue, decimal originalRevenue, bool originalDeleted, int originalCompanyId, DateTime originalStartDate, DateTime originalEndDate, string originalComment, decimal newRevenue, bool newDeleted, int newCompanyId, DateTime newStartDate, DateTime newEndDate, string newComment)
        {
            ...
            string command = "UPDATE [dbo].[LFS_PROJECT_COSTING_SHEET_REVENUE] SET [CostingSheetID] = @CostingSheetID, [RefIDRevenue] = @RefIDRevenue, [Revenue] = @Revenue, [Deleted] = @Deleted, [COMPANY_ID] = @COMPANY_ID, " +
        ...
        public int DeleteAll(int originalcostingSheetId, int originalCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_PROJECT_COSTING_SHEET_REVENUE] SET  [Deleted] = @Deleted  " +
