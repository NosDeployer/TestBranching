...
namespace LiquiForce.LFSLive.DA.Projects.Projects
{
    ...
    /// </summary>
    public class ProjectCombinedCostingSheetInformationSubcontractorsInformationGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Default constructor
        /// </summary>
        public ProjectCombinedCostingSheetInformationSubcontractorsInformationGateway()
        ...
        public ProjectCombinedCostingSheetInformationSubcontractorsInformationGateway(DataSet data)
        ...
        {
            FillDataWithStoredProcedure("LFS_PROJECTS_PROJECTCOMBINEDCOSTINGSHEETINFORMATIONSUBCONTRACTORSINFORMATIONGATEWAY_LOADBYCOSTINGSHEETID", new SqlParameter("@costingSheetId", costingSheetId), new SqlParameter("@companyId", companyId));
            return Data;            
        }
        ...
        public DataRow GetRow(int costingSheetId, int subcontractorId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.Projects.Projects.ProjectCombinedCostingSheetInformationSubcontractorsInformationGateway.GetRow");
            }
        }
