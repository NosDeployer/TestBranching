...
namespace LiquiForce.LFSLive.DA.Projects.Projects
{
    ...
    /// </summary>
    public class ProjectCostingSheetInsurancesGateway : DataTableGateway
    {
        ///////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ProjectCostingSheetInsurancesGateway()
        ...
        public ProjectCostingSheetInsurancesGateway(DataSet data)
        ...
        public void Insert(int costingSheetId, int insuranceCompanyId, int refId, decimal rate, bool deleted, int companyId, DateTime startDate, DateTime endDate, string comment)
        {
            ...
            string command = "INSERT INTO [dbo].[LFS_PROJECT_COSTING_SHEET_INSURANCE] ([CostingSheetID], [InsuranceCompanyID], [RefID], " +
                             " [Rate], [Deleted], [COMPANY_ID], [StartDate], [EndDate] , [Comment]) VALUES (@CostingSheetID, @InsuranceCompanyID, @RefID, " +
                             " @Rate, @Deleted, @COMPANY_ID, @StartDate, @EndDate, @Comment)";

            ExecuteScalar(command, costingSheetIdParameter, insuranceCompanyIdParameter, refIdParameter, rateParameter, deletedParameter, companyIdParameter, startDateParameter, endDateParameter, commentParameter);
        }
