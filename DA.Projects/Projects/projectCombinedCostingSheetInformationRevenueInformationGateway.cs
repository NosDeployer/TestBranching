...
namespace LiquiForce.LFSLive.DA.Projects.Projects
{
    ...
    /// </summary>
    public class projectCombinedCostingSheetInformationRevenueInformationGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Default constructor
        /// </summary>
        public projectCombinedCostingSheetInformationRevenueInformationGateway()
        ...
        public projectCombinedCostingSheetInformationRevenueInformationGateway(DataSet data)
        ...
        {
            FillDataWithStoredProcedure("LFS_PROJECTS_PROJECTCOMBINEDCOSTINGSHEETINFORMATIONREVENUEINFORMATIONGATEWAY_LOADBYCOSTINGSHEETID", new SqlParameter("@costingSheetId", costingSheetId), new SqlParameter("@companyId", companyId));
            return Data;            
        }
        ...
        public DataRow GetRow(int costingSheetId, int refIdRevenue)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.Projects.Projects.projectCombinedCostingSheetInformationRevenueInformationGateway.GetRow");
            }
        }
