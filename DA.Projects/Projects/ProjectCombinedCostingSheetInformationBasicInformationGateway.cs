...
{
    /// <summary>
    /// ProjectCombinedCostingSheetInformationBasicInformationGateway
    /// </summary>
    public class ProjectCombinedCostingSheetInformationBasicInformationGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ProjectCombinedCostingSheetInformationBasicInformationGateway()
        ...
        public ProjectCombinedCostingSheetInformationBasicInformationGateway(DataSet data)
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "CombinedBasicInformation";
        ...
        {
            FillDataWithStoredProcedure("LFS_PROJECTS_PROJECTCOMBINEDCOSTINGSHEETINFORMATIONBASICINFORMATIONGATEWAY_LOADBYCOSTINGSHEETID", new SqlParameter("@costingSheetId", costingSheetId), new SqlParameter("@companyId", companyId));
            return Data;            
        }
        ...
        public DataRow GetRow(int costingSheetId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.Projects.Projects.ProjectCombinedCostingSheetInformationBasicInformationGateway.GetRow");
            }
        }
        ...
        public int GetClientID(int costingSheetId)
        {
            return (int)GetRow(costingSheetId)["ClientID"];
        }
        ...
        /// </summary>
        /// <param name="costingSheetId">costingSheetId</param>
        /// <returns>CombinedProjects</returns>
        public string GetCombinedProjects(int costingSheetId)
        {
            return (string)GetRow(costingSheetId)["CombinedProjects"];
        }
