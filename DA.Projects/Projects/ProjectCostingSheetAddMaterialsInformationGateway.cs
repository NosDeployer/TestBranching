...
{
    /// <summary>
    /// ProjectCostingSheetAddMaterialsInformationGateway
    /// </summary>
    public class ProjectCostingSheetAddMaterialsInformationGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Default constructor
        /// </summary>
        public ProjectCostingSheetAddMaterialsInformationGateway()
        ...
        public ProjectCostingSheetAddMaterialsInformationGateway(DataSet data)
        ...
        public DataRow GetRow(int costingSheetId, int materialId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.Projects.Projects.ProjectCostingSheetAddMaterialsInformationGateway.GetRow");
            }
        }
