...
{
    /// <summary>
    /// ProjectUnistBudgetGateway
    /// </summary>
    public class ProjectUnistBudgetGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ProjectUnistBudgetGateway()
        ...
        public ProjectUnistBudgetGateway(DataSet data)
...
SELECT ProjectID, Budget, Deleted, COMPANY_ID FROM LFS_PROJECT_UNITS_BUDGET WHERE (ProjectID = @ProjectID)";
        ...
        {
            FillDataWithStoredProcedure("LFS_PROJECTS_PROJECTUNITSBUDGETGATEWAY_LOADALLBYPROJECTID", new SqlParameter("@projectId", projectId));
            return Data;
        }
        ...
        public int Insert(int projectId, decimal budget, bool deleted, int companyId)
        {
            ...
            string command = "INSERT INTO [dbo].[LFS_PROJECT_UNITS_BUDGET] ([ProjectID], [Budget], [Deleted], [COMPANY_ID]) VALUES (@ProjectID, @Budget, @Deleted, @COMPANY_ID)";
        ...
        public int Update(int originalProjectId, decimal originalBudget, bool originalDeleted, int originalCompanyId, int newProjectId, decimal newBudget, bool newDeleted, int newCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_PROJECT_UNITS_BUDGET] SET [Budget] = @Budget " +
        ...
        public int Delete(int originalProjectId, int originalCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_PROJECT_UNITS_BUDGET] SET  [Deleted] = @Deleted  " +
