...
{
    /// <summary>
    /// ProjectCostingSheetOtherCategoryGateway
    /// </summary>
    public class ProjectCostingSheetOtherCategoryGateway : DataTableGateway
    {
        ///////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ProjectCostingSheetOtherCategoryGateway()
        ...
        public ProjectCostingSheetOtherCategoryGateway(DataSet data)
        ...
        public void Insert(int costingSheetId, string category, int refId, decimal rate, bool deleted, int companyId, DateTime startDate, DateTime endDate, string comment)
        {
            ...
            string command = "INSERT INTO [dbo].[LFS_PROJECT_COSTING_SHEET_OTHER_CATEGORY] ([CostingSheetID], [Category], [RefID], " +
                             " [Rate], [Deleted], [COMPANY_ID], [StartDate], [EndDate], [Comment]) VALUES (@CostingSheetID, @Category, @RefID, " +
                             " @Rate, @Deleted, @COMPANY_ID, @StartDate, @EndDate, @Comment)";

            ExecuteScalar(command, costingSheetIdParameter, categoryParameter, refIdParameter, rateParameter, deletedParameter, companyIdParameter, startDateParameter, endDateParameter, commentParameter);
        }
