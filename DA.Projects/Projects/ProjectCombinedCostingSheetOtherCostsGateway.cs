...
{
    /// <summary>
    /// ProjectCombinedCostingSheetOtherCostsGateway
    /// </summary>
    public class ProjectCombinedCostingSheetOtherCostsGateway : DataTableGateway
    {
        ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ProjectCombinedCostingSheetOtherCostsGateway()
        ...
        public ProjectCombinedCostingSheetOtherCostsGateway(DataSet data)
...
SELECT CostingSheetID, RefID, Work_, Function_, Description, UnitOfMeasurement, Quantity, CostCad, TotalCostCad, CostUsd, TotalCostUsd, Deleted, COMPANY_ID, StartDate, EndDate FROM LFS_PROJECT_COMBINED_COSTING_SHEET_OTHER_COSTS WHERE (CostingSheetID = @CostingSheetID) AND (RefID = @RefID)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[LFS_PROJECT_COMBINED_COSTING_SHEET_OTHER_COSTS] SET [CostingSheetID] = @Cost" +
                ...
                "ndDate FROM LFS_PROJECT_COMBINED_COSTING_SHEET_OTHER_COSTS WHERE (CostingSheetID = @Costi" +
        ...
        public void Insert(int costingSheetId, int refId, string work_, string function_, string description, string unitOfMeasurement, double quantity, decimal costCad, decimal totalCostCad, decimal costUsd, decimal totalCostUsd, bool deleted, int companyId, DateTime startDate, DateTime endDate, int projectId)
        {
            ...
            string command = "INSERT INTO [dbo].[LFS_PROJECT_COMBINED_COSTING_SHEET_OTHER_COSTS] ([CostingSheetID], [RefID], [Work_], [Function_], [Description], [UnitOfMeasurement], "+
                             " [Quantity], [CostCad], [TotalCostCad], [CostUsd], [TotalCostUsd], [Deleted], [COMPANY_ID], [StartDate], [EndDate], [ProjectID]) "+
                             " VALUES (@CostingSheetID, @RefID, @Work_, @Function_, @Description, @UnitOfMeasurement, @Quantity, @CostCad, @TotalCostCad, @CostUsd, @TotalCostUsd, @Deleted, @COMPANY_ID, @StartDate, @EndDate, @ProjectID)";
            
            ExecuteScalar(command, costingSheetIdParameter, refIdParameter, work_Parameter, function_Parameter, descriptionParameter, unitOfMeasurementParameter, quantityParameter, costCadParameter, totalCostCadParameter, costUsdParameter, totalCostUsdParameter, deletedParameter, companyIdParameter, startDateParameter, endDateParameter, projectIdParameter);
        }
        ...
        public void Update(int costingSheetId, int refId, string originalWork_, string originalFunction_, string originalDescription, string originalUnitOfMeasurement, double originalQuantity, decimal originalCostCad, decimal originalTotalCostCad, decimal originalCostUsd, decimal originalTotalCostUsd, bool originalDeleted, int originalCompanyId, DateTime originalStartDate, DateTime originalEndDate, string newWork_, string newFunction_, string newDescription, string newUnitOfMeasurement, double newQuantity, decimal newCostCad, decimal newTotalCostCad, decimal newCostUsd, decimal newTotalCostUsd, bool newDeleted, int newCompanyId, DateTime newStartDate, DateTime newEndDate)
        {
            ...
            string command = "UPDATE [dbo].[LFS_PROJECT_COMBINED_COSTING_SHEET_OTHER_COSTS] SET [CostingSheetID] = @CostingSheetID, [RefID] = @RefID, [Work_] = @Work_, [Function_] = @Function_, "+
        ...
        public int DeleteAll(int originalCostingSheetId, int originalCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_PROJECT_COMBINED_COSTING_SHEET_OTHER_COSTS] SET  [Deleted] = @Deleted  " +
