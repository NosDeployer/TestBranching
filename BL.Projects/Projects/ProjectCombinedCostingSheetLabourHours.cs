...
{
    /// <summary>
    /// ProjectCombinedCostingSheetLabourHours
    /// </summary>
    public class ProjectCombinedCostingSheetLabourHours : TableModule
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ProjectCombinedCostingSheetLabourHours()
        ...
        public ProjectCombinedCostingSheetLabourHours(DataSet data)
        ...
        public void InsertDirect(int costingSheetId, string work_, int employeeId, int refId, double lHQuantity, string lHUnitOfMeasurement, string mealsUnitOfMeasurement, int? mealsQuantity, string motelUnitOfMeasurement, int? motelQuantity, decimal lHCostCad, decimal? mealsCostCad, decimal? motelCostCad, decimal totalCostCad, decimal lHCostUsd, decimal? mealsCostUsd, decimal? motelCostUsd, decimal totalCostUsd, bool deleted, int companyId, DateTime startDate, DateTime endDate, string function_, int projectId)
        {
            ...
            ProjectCombinedCostingSheetLabourHoursGateway projectCostingSheetLabourHoursGateway = new ProjectCombinedCostingSheetLabourHoursGateway(null);
            projectCostingSheetLabourHoursGateway.Insert(costingSheetId, work_, employeeId, refId, lHQuantity, lHUnitOfMeasurement, mealsUnitOfMeasurement, mealsQuantity, motelUnitOfMeasurement, motelQuantity, lHCostCad, mealsCostCad, motelCostCad, totalCostCad, lHCostUsd, mealsCostUsd, motelCostUsd, totalCostUsd, deleted, companyId, startDate, endDate, function_, projectId);
        }
