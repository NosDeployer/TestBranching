...
{
    /// <summary>
    /// ProjectCostingSheetMaterials
    /// </summary>
    public class ProjectCostingSheetMaterials : TableModule
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ProjectCostingSheetMaterials()
        ...
        public ProjectCostingSheetMaterials(DataSet data)
        ...
        public void InsertDirect(int costingSheetId, int materialId, int refId, string unitOfMeasurement, double quantity, decimal costCad, decimal totalCostCad, decimal costUsd, decimal totalCostUsd, bool deleted, int companyId, DateTime startDate, DateTime endDate, string function_)
        {
            ProjectCostingSheetMaterialsGateway projectCostingSheetMaterialsGateway = new ProjectCostingSheetMaterialsGateway(null);
            projectCostingSheetMaterialsGateway.Insert(costingSheetId, materialId, refId, unitOfMeasurement, quantity, costCad, totalCostCad, costUsd, totalCostUsd, deleted, companyId, startDate, endDate, function_);
        }
