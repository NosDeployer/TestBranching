...
namespace LiquiForce.LFSLive.BL.Projects.Projects
{
    ...
    /// </summary>
    public class ProjectCombinedCostingSheetAddLabourHoursInformation : TableModule
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ProjectCombinedCostingSheetAddLabourHoursInformation()
        ...
        public ProjectCombinedCostingSheetAddLabourHoursInformation(DataSet data)
        ...
        public void Load(ArrayList works, int projectId, DateTime startDate, DateTime endDate, int companyId, int clientId)
        {
            // General vars
                        ...
                        if (projectCostingSheetAddEmployeePayPeriodGateway.Table.Rows.Count > 0)
                        {
                            foreach (ProjectCostingSheetAddTDS.EmployeePayPeriodRow employeePayPeriodRow in (ProjectCostingSheetAddTDS.EmployeePayPeriodDataTable)projectCostingSheetAddEmployeePayPeriodGateway.Table)
                            {
                                ...
                                if (projectCostingSheetAddOriginalLabourHourGateway.Table.Rows.Count > 0)
                                {
                                    ...
                                    if (lhQuantity > 0)
                                    {
                                        ProjectCostingSheetAddTDS.CombinedLabourHoursInformationRow newRow = ((ProjectCostingSheetAddTDS.CombinedLabourHoursInformationDataTable)Table).NewCombinedLabourHoursInformationRow();
                                        ...
                                        ((ProjectCostingSheetAddTDS.CombinedLabourHoursInformationDataTable)Table).AddCombinedLabourHoursInformationRow(newRow);
                                    }

                                    if (overtime > 0)
                                    {
                                        refId++;
                                        ProjectCostingSheetAddTDS.CombinedLabourHoursInformationRow newRowOt = ((ProjectCostingSheetAddTDS.CombinedLabourHoursInformationDataTable)Table).NewCombinedLabourHoursInformationRow();
                                        ...
                                        newRowOt.ClientID = clientId;
                                        newRowOt.ProjectID = projectId;
                                        newRowOt.Project = project;
                                        ((ProjectCostingSheetAddTDS.CombinedLabourHoursInformationDataTable)Table).AddCombinedLabourHoursInformationRow(newRowOt);
                                    }
                                }
        ...
        /// <param name="endDate">endDate</param>
        /// <param name="companyId">companyId</param>
        public void LoadFairWageProject(ArrayList works, ArrayList jobClassType, int projectId, DateTime startDate, DateTime endDate, int companyId, int clientId)
        {
            // General vars
            int overtimeByCountry = 40; //Default for USA Projects
            int refId = 0;
        ...
        public void Insert(int costingSheetId, string work_, int employeeId, double lHQuantity, string lHUnitOfMeasurement, string mealsUnitOfMeasurement, int? mealsQuantity, string motelUnitOfMeasurement, int? motelQuantity, decimal lHCostCad, decimal? mealsCostCad, decimal? motelCostCad, decimal totalCostCad, decimal lHCostUsd, decimal? mealsCostUsd, decimal? motelCostUsd, decimal totalCostUsd, bool deleted, int companyId, string name, DateTime startDate, DateTime endDate, string workFunction, string function_, int clientId, int projectId)
        {
            ProjectCostingSheetAddTDS.CombinedLabourHoursInformationRow row = ((ProjectCostingSheetAddTDS.CombinedLabourHoursInformationDataTable)Table).NewCombinedLabourHoursInformationRow();
            ...
            //newR\\ow.Project = project;
            ((ProjectCostingSheetAddTDS.CombinedLabourHoursInformationDataTable)Table).AddCombinedLabourHoursInformationRow(row);
        }
        ...
        {
            ProjectCostingSheetAddTDS.CombinedLabourHoursInformationRow row = GetRow(costingSheetId, work_, employeeId, refId);
        ...
        public void Save(int companyId, int costingSheetId)
        {
            ...
            if (labourHourInformationChanges.CombinedLabourHoursInformation.Rows.Count > 0)
            {
                foreach (ProjectCostingSheetAddTDS.CombinedLabourHoursInformationRow row in (ProjectCostingSheetAddTDS.CombinedLabourHoursInformationDataTable)labourHourInformationChanges.CombinedLabourHoursInformation)
                {
        ...
        /// <param name="refId">refId</param>
        /// <returns>row</returns>
        private ProjectCostingSheetAddTDS.CombinedLabourHoursInformationRow GetRow(int costingSheetId, string work_, int employeeId, int refId)
        {
            ProjectCostingSheetAddTDS.CombinedLabourHoursInformationRow row = ((ProjectCostingSheetAddTDS.CombinedLabourHoursInformationDataTable)Table).FindByRefIDEmployeeIDWork_CostingSheetID(refId, employeeId, work_, costingSheetId);
        ...
        private int GetNewRefId()
        {
            ...
            foreach (ProjectCostingSheetAddTDS.CombinedLabourHoursInformationRow row in (ProjectCostingSheetAddTDS.CombinedLabourHoursInformationDataTable)Table)
            {
        ...
        private void GetEmployeeDataFairWage(DateTime startDate, DateTime endDate, int employeeId, string work_, ProjectCostingSheetAddTDS.CombinedLabourHoursInformationRow newRow, int contryId, decimal fringeRate, decimal fairWageRate)
        {
            // Load data
        ...
        /// <param name="fringeRate">fringeRate</param>
        /// <param name="fairWageRate">fairWageRate</param>
        private void GetEmployeeDataFairWageOvertime(DateTime startDate, DateTime endDate, int employeeId, string work_, ProjectCostingSheetAddTDS.CombinedLabourHoursInformationRow newRow, int contryId, decimal fringeRate, decimal fairWageRate)
        {
            ProjectCostingSheetAddEmployeeListGateway projectCostingSheetAddEmployeeListGateway = new ProjectCostingSheetAddEmployeeListGateway();
            projectCostingSheetAddEmployeeListGateway.LoadByStartDateEndDateEmployeeIdWork_FairWage(startDate, endDate, employeeId, work_);
        ...
        /// <param name="work_">work_</param>
        /// <param name="newRow">newRow</param>
        private void GetEmployeeData(DateTime startDate, DateTime endDate, int employeeId, string work_, ProjectCostingSheetAddTDS.CombinedLabourHoursInformationRow newRow)
        {
            ProjectCostingSheetAddEmployeeListGateway projectCostingSheetAddEmployeeListGateway = new ProjectCostingSheetAddEmployeeListGateway();
        ...
        /// <param name="work_">work_</param>
        /// <param name="newRow">newRow</param>
        private void GetEmployeeDataOvertime(DateTime startDate, DateTime endDate, int employeeId, string work_, ProjectCostingSheetAddTDS.CombinedLabourHoursInformationRow newRow)
        {
            ProjectCostingSheetAddEmployeeListGateway projectCostingSheetAddEmployeeListGateway = new ProjectCostingSheetAddEmployeeListGateway();
            projectCostingSheetAddEmployeeListGateway.LoadByStartDateEndDateEmployeeIdWork_(startDate, endDate, employeeId, work_);
