...
{
    /// <summary>
    /// ProjectCombinedCostingSheetUnits
    /// </summary>
    public class ProjectCombinedCostingSheetUnits : TableModule
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ProjectCombinedCostingSheetUnits()
        ...
        public ProjectCombinedCostingSheetUnits(DataSet data)
        ...
        public void InsertDirect(int costingSheetId, string work_, int unitId, int refId, string unitOfMeasurement, double quantity, decimal costCad, decimal totalCostCad, decimal costUsd, decimal totalCostUsd, bool deleted, int companyId, DateTime startDate, DateTime endDate, string function_, int projectId)
        {
            // Insert costing sheet Units
            ProjectCombinedCostingSheetUnitsGateway projectCostingSheetUnitsGateway = new ProjectCombinedCostingSheetUnitsGateway(null);
            projectCostingSheetUnitsGateway.Insert(costingSheetId, work_, unitId, refId, unitOfMeasurement, quantity, costCad, totalCostCad, costUsd, totalCostUsd, deleted, companyId, startDate, endDate, function_, projectId);
        }
