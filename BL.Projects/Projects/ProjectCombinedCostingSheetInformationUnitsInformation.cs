...
{
    /// <summary>
    /// ProjectCombinedCostingSheetInformationUnitsInformation
    /// </summary>
    public class ProjectCombinedCostingSheetInformationUnitsInformation : TableModule
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ProjectCombinedCostingSheetInformationUnitsInformation()
        ...
        public ProjectCombinedCostingSheetInformationUnitsInformation(DataSet data)
        ...
        {
            ProjectCostingSheetInformationTDS.CombinedUnitsInformationRow row = ((ProjectCostingSheetInformationTDS.CombinedUnitsInformationDataTable)Table).NewCombinedUnitsInformationRow();
            ...
            ((ProjectCostingSheetInformationTDS.CombinedUnitsInformationDataTable)Table).AddCombinedUnitsInformationRow(row);
        }
        ...
        {
            ProjectCostingSheetInformationTDS.CombinedUnitsInformationRow row = GetRow(costingSheetId, work_, unitId, refId);
        ...
        public void Save(int companyId, int costingSheetId)
        {
            ...
            {
                ProjectCombinedCostingSheetInformationUnitsInformationGateway projectCostingSheetInformationUnitsInformationGateway = new ProjectCombinedCostingSheetInformationUnitsInformationGateway(unitsInformationChanges);

                foreach (ProjectCostingSheetInformationTDS.CombinedUnitsInformationRow row in (ProjectCostingSheetInformationTDS.CombinedUnitsInformationDataTable)unitsInformationChanges.CombinedUnitsInformation)
                {
        ...
        private ProjectCostingSheetInformationTDS.CombinedUnitsInformationRow GetRow(int costingSheetId, string work_, int unitId, int refId)
        {
            ProjectCostingSheetInformationTDS.CombinedUnitsInformationRow row = ((ProjectCostingSheetInformationTDS.CombinedUnitsInformationDataTable)Table).FindByRefIDUnitIDWork_CostingSheetID(refId, unitId, work_, costingSheetId);

            if (row == null)
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.BL.Projects.Projects.ProjectCombinedCostingSheetInformationUnitsInformation.GetRow");
            }
        ...
        private int GetNewRefId()
        {
            ...
            foreach (ProjectCostingSheetInformationTDS.CombinedUnitsInformationRow row in (ProjectCostingSheetInformationTDS.CombinedUnitsInformationDataTable)Table)
            {
