...
{
    /// <summary>
    /// ProjectCostingSheetOtherCosts
    /// </summary>
    public class ProjectCostingSheetOtherCosts : TableModule
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ProjectCostingSheetOtherCosts()
        ...
        public ProjectCostingSheetOtherCosts(DataSet data)
        ...
        public void InsertDirect(int costingSheetId, int refId, string work_, string function_, string description, string unitOfMeasurement, double quantity, decimal costCad, decimal totalCostCad, decimal costUsd, decimal totalCostUsd, bool deleted, int companyId, DateTime startDate, DateTime endDate)
        {
            // Insert costing sheet Other Costs
            ProjectCostingSheetOtherCostsGateway projectCostingSheetOtherCostsGateway = new ProjectCostingSheetOtherCostsGateway(null);
            projectCostingSheetOtherCostsGateway.Insert(costingSheetId, refId, work_, function_, description, unitOfMeasurement, quantity, costCad, totalCostCad, costUsd, totalCostUsd, deleted, companyId, startDate, endDate);
        }
