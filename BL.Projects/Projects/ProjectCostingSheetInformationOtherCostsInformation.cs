...
{
    /// <summary>
    /// ProjectCostingSheetInformationOtherCostsInformation
    /// </summary>
    public class ProjectCostingSheetInformationOtherCostsInformation : TableModule
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ProjectCostingSheetInformationOtherCostsInformation()
        ...
        public ProjectCostingSheetInformationOtherCostsInformation(DataSet data)
        ...
        {
            ProjectCostingSheetInformationTDS.OtherCostsInformationRow row = ((ProjectCostingSheetInformationTDS.OtherCostsInformationDataTable)Table).NewOtherCostsInformationRow();
            ...
            ((ProjectCostingSheetInformationTDS.OtherCostsInformationDataTable)Table).AddOtherCostsInformationRow(row);
        }
        ...
        {
            ProjectCostingSheetInformationTDS.OtherCostsInformationRow row = GetRow(costingSheetId, refId);
        ...
        private ProjectCostingSheetInformationTDS.OtherCostsInformationRow GetRow(int costingSheetId, int refId)
        {
            ProjectCostingSheetInformationTDS.OtherCostsInformationRow row = ((ProjectCostingSheetInformationTDS.OtherCostsInformationDataTable)Table).FindByCostingSheetIDRefID(costingSheetId, refId);

            if (row == null)
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.BL.Projects.Projects.ProjectCostingSheetInformationOtherCostsInformation.GetRow");
            }
        ...
        private int GetNewRefId()
        {
            ...
            foreach (ProjectCostingSheetInformationTDS.OtherCostsInformationRow row in (ProjectCostingSheetInformationTDS.OtherCostsInformationDataTable)Table)
            {
