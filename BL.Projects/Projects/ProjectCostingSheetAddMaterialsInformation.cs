...
{
    /// <summary>
    /// ProjectCostingSheetAddMaterialsInformation
    /// </summary>
    public class ProjectCostingSheetAddMaterialsInformation : TableModule
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ProjectCostingSheetAddMaterialsInformation()
        ...
        public ProjectCostingSheetAddMaterialsInformation(DataSet data)
        ...
        public void Insert(int costingSheetId, int materialId, string unitOfMeasurement, double quantity, decimal costCad, decimal totalCostCad, decimal costUsd, decimal totalCostUsd, bool deleted, int companyId, string process, string description, DateTime startDate, DateTime endDate, string function_, string workFunction)
        {
            ProjectCostingSheetAddTDS.MaterialsInformationRow row = ((ProjectCostingSheetAddTDS.MaterialsInformationDataTable)Table).NewMaterialsInformationRow();
            ...
            ((ProjectCostingSheetAddTDS.MaterialsInformationDataTable)Table).AddMaterialsInformationRow(row);
        }
        ...
        {
            ProjectCostingSheetAddTDS.MaterialsInformationRow row = GetRow(costingSheetId, materialId, refId);
        ...
        public void Save(int companyId, int costingSheetId)
        {
            ...
            {
                foreach (ProjectCostingSheetAddTDS.MaterialsInformationRow row in (ProjectCostingSheetAddTDS.MaterialsInformationDataTable)materialsInformationChanges.MaterialsInformation)
                {
        ...
        /// <param name="refId">refId</param>
        /// <returns>row</returns>
        private ProjectCostingSheetAddTDS.MaterialsInformationRow GetRow(int costingSheetId, int materialId, int refId)
        {
            ProjectCostingSheetAddTDS.MaterialsInformationRow row = ((ProjectCostingSheetAddTDS.MaterialsInformationDataTable)Table).FindByCostingSheetIDMaterialIDRefID(costingSheetId, materialId, refId);

            if (row == null)
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.BL.Projects.Projects.ProjectCostingSheetAddMaterialsInformation.GetRow");
            }
        ...
        private int GetNewRefId()
        {
            ...
            foreach (ProjectCostingSheetAddTDS.MaterialsInformationRow row in (ProjectCostingSheetAddTDS.MaterialsInformationDataTable)Table)
            {
