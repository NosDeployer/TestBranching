...
{
    /// <summary>
    /// ProjectCombinedCostingSheetInformationLabourHoursInformation
    /// </summary>
    public class ProjectCombinedCostingSheetInformationLabourHoursInformation : TableModule
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ProjectCombinedCostingSheetInformationLabourHoursInformation()
        ...
        public ProjectCombinedCostingSheetInformationLabourHoursInformation(DataSet data)
        ...
        {
            ProjectCostingSheetInformationTDS.CombinedLabourHoursInformationRow row = ((ProjectCostingSheetInformationTDS.CombinedLabourHoursInformationDataTable)Table).NewCombinedLabourHoursInformationRow();
            ...
            ((ProjectCostingSheetInformationTDS.CombinedLabourHoursInformationDataTable)Table).AddCombinedLabourHoursInformationRow(row);
        }
        ...
        {
            ProjectCostingSheetInformationTDS.CombinedLabourHoursInformationRow row = GetRow(costingSheetId, work_, employeeId, refId);
        ...
        public void Save(int companyId, int costingSheetId)
        {
            ...
            {
                ProjectCombinedCostingSheetInformationLabourHoursInformationGateway projectCostingSheetInformationLabourHoursInformationGateway = new ProjectCombinedCostingSheetInformationLabourHoursInformationGateway(labourHourInformationChanges);

                foreach (ProjectCostingSheetInformationTDS.CombinedLabourHoursInformationRow row in (ProjectCostingSheetInformationTDS.CombinedLabourHoursInformationDataTable)labourHourInformationChanges.CombinedLabourHoursInformation)
                {
                    ...
                    if ((!row.Deleted) && (!row.InDatabase))
                    {
                        ...
                        ProjectCombinedCostingSheetLabourHours labourHours = new ProjectCombinedCostingSheetLabourHours(null);
        ...
        /// <param name="refId">refId</param>
        /// <returns>row</returns>
        private ProjectCostingSheetInformationTDS.CombinedLabourHoursInformationRow GetRow(int costingSheetId, string work_, int employeeId, int refId)
        {
            ProjectCostingSheetInformationTDS.CombinedLabourHoursInformationRow row = ((ProjectCostingSheetInformationTDS.CombinedLabourHoursInformationDataTable)Table).FindByRefIDEmployeeIDWork_CostingSheetID(refId, employeeId, work_, costingSheetId);

            if (row == null)
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.BL.Projects.Projects.ProjectCombinedCostingSheetInformationLabourHoursInformation.GetRow");
            }
        ...
        private int GetNewRefId()
        {
            ...
            foreach (ProjectCostingSheetInformationTDS.CombinedLabourHoursInformationRow row in (ProjectCostingSheetInformationTDS.CombinedLabourHoursInformationDataTable)Table)
            {
