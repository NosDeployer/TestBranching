...
namespace LiquiForce.LFSLive.BL.CWP.Common
{
    ...
    /// WincanBulkUpload
    /// </summary>
    public class WincanBulkUpload : TableModule
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public WincanBulkUpload() : base("WincanBulkUpload")
        {
        }
        ...
        public WincanBulkUpload(DataSet data)
        ...
        {
            WincanBulkUploadTDS.WincanBulkUploadRow row = ((WincanBulkUploadTDS.WincanBulkUploadDataTable)Table).NewWincanBulkUploadRow();
            ...
            ((WincanBulkUploadTDS.WincanBulkUploadDataTable)Table).AddWincanBulkUploadRow(row);
        }
        ...
        public string GetSectionsSummary(string header)
        {
            ...
            foreach (WincanBulkUploadTDS.WincanBulkUploadRow row in (WincanBulkUploadTDS.WincanBulkUploadDataTable)Table)
            {
