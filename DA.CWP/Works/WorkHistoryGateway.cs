...
namespace LiquiForce.LFSLive.DA.CWP.Works
{
    ...
    /// WorkHistoryGateway
    /// </summary>
    public class WorkHistoryGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        public WorkHistoryGateway(DataSet data)
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "LFS_WORK_HISTORY";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[LFS_WORK_HISTORY] ([WorkID], [RefID], [Type], [Subject], [UserID], [DateTime_], [History], [LIBRARY_FILES_ID], [Deleted], [COMPANY_ID], [WorkType]) VALUES (@WorkID, @RefID, @Type, @Subject, @UserID, @DateTime_, @History, @LIBRARY_FILES_ID, @Deleted, @COMPANY_ID, @WorkType);
SELECT WorkID, RefID, Type, Subject, UserID, DateTime_, History, LIBRARY_FILES_ID, Deleted, COMPANY_ID, WorkType FROM LFS_WORK_HISTORY WHERE (RefID = @RefID) AND (WorkID = @WorkID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[LFS_WORK_HISTORY] SET [WorkID] = @WorkID, [RefID] = @RefID, [Type] = @Type, [Subject] = @Subject, [UserID] = @UserID, [DateTime_] = @DateTime_, [History] = @History, [LIBRARY_FILES_ID] = @LIBRARY_FILES_ID, [Deleted] = @Deleted, [COMPANY_ID] = @COMPANY_ID, [WorkType] = @WorkType WHERE (([WorkID] = @Original_WorkID) AND ([RefID] = @Original_RefID) AND ((@IsNull_Type = 1 AND [Type] IS NULL) OR ([Type] = @Original_Type)) AND ([Subject] = @Original_Subject) AND ([UserID] = @Original_UserID) AND ((@IsNull_DateTime_ = 1 AND [DateTime_] IS NULL) OR ([DateTime_] = @Original_DateTime_)) AND ((@IsNull_LIBRARY_FILES_ID = 1 AND [LIBRARY_FILES_ID] IS NULL) OR ([LIBRARY_FILES_ID] = @Original_LIBRARY_FILES_ID)) AND ([Deleted] = @Original_Deleted) AND ([COMPANY_ID] = @Original_COMPANY_ID) AND ((@IsNull_WorkType = 1 AND [WorkType] IS NULL) OR ([WorkType] = @Original_WorkType)));
SELECT WorkID, RefID, Type, Subject, UserID, DateTime_, History, LIBRARY_FILES_ID, Deleted, COMPANY_ID, WorkType FROM LFS_WORK_HISTORY WHERE (RefID = @RefID) AND (WorkID = @WorkID)";
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_WORKHISTORYGATEWAY_LOADALLBYWORKIDWORKTYPE", new SqlParameter("@workId", workId), new SqlParameter("@companyId", companyId), new SqlParameter("@workType", workType));
            return Data;
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_WORKHISTORYGATEWAY_LOADBYWORKIDWORKTYPE", new SqlParameter("@workId", workId), new SqlParameter("@companyId", companyId), new SqlParameter("@workType", workType));
            return Data;
        }
        ...
        /// <param name="workType">workType</param>
        /// <returns></returns>
        public int Insert(int workId, int refId, string type, string subject, int userId, DateTime? dateTime_, string history, int? libraryFilesId, bool deleted, int companyId, string workType)
        {
            ...
            SqlParameter libraryFilesIdParameter = (libraryFilesId.HasValue) ? new SqlParameter("LIBRARY_FILES_ID", libraryFilesId.HasValue) : new SqlParameter("LIBRARY_FILES_ID", DBNull.Value);
            ...
            string command = "INSERT INTO [dbo].[LFS_WORK_HISTORY] ([WorkID], [RefID], [Type], [Subject], [UserID], [DateTime_], [History], [LIBRARY_FILES_ID], [Deleted], [COMPANY_ID], [WorkType]) VALUES (@WorkID, @RefID, @Type, @Subject, @UserID, @DateTime_, @History, @LIBRARY_FILES_ID, @Deleted, @COMPANY_ID, @WorkType)";

            int rowsAffected = (int)ExecuteNonQuery(command, workIdParameter, refIdParameter, typeParameter, subjectParameter, userIdParameter, dateTimeParameter, historyParameter, libraryFilesIdParameter, deletedParameter, companyIdParameter, workTypeParameter);
        ...
        public int Update(int originalWorkId, int originalRefId, string originalType, string originalSubject, int originalUserId, DateTime? originalDateTime, string originalHistory, int? originalLibraryFilesId, bool originalDeleted, int originalCompanyId, string originalWorkType, int newWorkId, int newRefId, string newType, string newSubject, int newUserId, DateTime? newDateTime, string newHistory, int? newLibraryFilesId, bool newDeleted, int newCompanyId, string newWorkType)
        {
            ...
            string command = "UPDATE [dbo].[LFS_WORK_HISTORY] " +
                " SET [Subject] = @Subject,  [Type] = @Type, " +
                " [History] = @History, [LIBRARY_FILES_ID] = @LIBRARY_FILES_ID, [WorkType] = @WorkType " +
                " WHERE (([WorkID] = @Original_WorkID) AND ([RefID] = @Original_RefID) AND " +
                " ([COMPANY_ID] = @Original_COMPANY_ID))";

            int rowsAffected = (int)ExecuteNonQuery(command, originalWorkIdParameter, originalRefIdParameter, originalTypeParameter, originalSubjectParameter, originalUserIdParameter, originalDateTimeParameter, originalHistoryParameter, originalLibraryFilesIdParameter, originalDeletedParameter, originalCompanyIdParameter, originalWorkTypeParameter, newWorkIdParameter, newRefIdParameter, newTypeParameter, newSubjectParameter, newUserIdParameter, newDateTimeParameter, newHistoryParameter, newLibraryFilesIdParameter, newDeletedParameter, newCompanyIdParameter, newWorkTypeParameter);
        ...
        public int Delete(int originalWorkId, int originalRefId, int originalCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_WORK_HISTORY] SET  [Deleted] = @Deleted  " +
        ...
        public int DeleteAll(int originalWorkId, int originalCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_WORK_HISTORY] SET  [Deleted] = @Deleted  WHERE (([WorkID] = @Original_WorkID) AND " +
            " ([COMPANY_ID] = @Original_COMPANY_ID))";
