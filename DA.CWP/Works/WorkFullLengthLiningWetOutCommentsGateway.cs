...
{
    /// <summary>
    /// WorkFullLengthLiningWetOutCommentsGateway
    /// </summary>
    public class WorkFullLengthLiningWetOutCommentsGateway: DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public WorkFullLengthLiningWetOutCommentsGateway()
        ...
        public WorkFullLengthLiningWetOutCommentsGateway(DataSet data)
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "LFS_WORK_FULLLENGTHLINING_WETOUT_COMMENTS";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[LFS_WORK_FULLLENGTHLINING_WETOUT_COMMENTS] ([WorkID], [RefID], [Type], [Subject], [UserID], [DateTime_], [Comment], [LIBRARY_FILES_ID], [Deleted], [COMPANY_ID], [WorkType]) VALUES (@WorkID, @RefID, @Type, @Subject, @UserID, @DateTime_, @Comment, @LIBRARY_FILES_ID, @Deleted, @COMPANY_ID, @WorkType);
SELECT WorkID, RefID, Type, Subject, UserID, DateTime_, Comment, LIBRARY_FILES_ID, Deleted, COMPANY_ID, WorkType FROM LFS_WORK_FULLLENGTHLINING_WETOUT_COMMENTS WHERE (RefID = @RefID) AND (WorkID = @WorkID)";
...
SELECT WorkID, RefID, Type, Subject, UserID, DateTime_, Comment, LIBRARY_FILES_ID, Deleted, COMPANY_ID, WorkType FROM LFS_WORK_FULLLENGTHLINING_WETOUT_COMMENTS WHERE (RefID = @RefID) AND (WorkID = @WorkID)";
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_WORKFULLLENGTHLININGWETOUTCOMMENTSGATEWAY_LOADALLBYWORKIDWORKTYPE", new SqlParameter("@workId", workId), new SqlParameter("@companyId", companyId), new SqlParameter("@workType", workType));
            return Data;
        }
        ...
        public int Insert(int workId, int refId, string type, string subject, int userId, DateTime? dateTime_, string comment, int? libraryFilesId, bool deleted, int companyId, string workType)
        {
            ...
            string command = "INSERT INTO [dbo].[LFS_WORK_FULLLENGTHLINING_WETOUT_COMMENTS] ([WorkID], [RefID], [Type], [Subject], [UserID], [DateTime_], [Comment], [LIBRARY_FILES_ID], [Deleted], [COMPANY_ID], [WorkType]) VALUES (@WorkID, @RefID, @Type, @Subject, @UserID, @DateTime_, @Comment, @LIBRARY_FILES_ID, @Deleted, @COMPANY_ID, @WorkType)";
        ...
        public int Update(int originalWorkId, int originalRefId, string originalType, string originalSubject, int originalUserId, DateTime? originalDateTime, string originalComment, int? originalLibraryFilesId, bool originalDeleted, int originalCompanyId, string originalWorkType, int newWorkId, int newRefId, string newType, string newSubject, int newUserId, DateTime? newDateTime, string newComment, int? newLibraryFilesId, bool newDeleted, int newCompanyId, string newWorkType)
        {
            ...
            string command = "UPDATE [dbo].[LFS_WORK_FULLLENGTHLINING_WETOUT_COMMENTS] " +
        ...
        public int Delete(int originalWorkId, int originalRefId, int originalCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_WORK_FULLLENGTHLINING_WETOUT_COMMENTS] SET  [Deleted] = @Deleted  " +
        ...
        public int DeleteAll(int originalWorkId, int originalCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_WORK_FULLLENGTHLINING_WETOUT_COMMENTS] SET  [Deleted] = @Deleted  WHERE (([WorkID] = @Original_WorkID) AND " +
            " ([COMPANY_ID] = @Original_COMPANY_ID))";
