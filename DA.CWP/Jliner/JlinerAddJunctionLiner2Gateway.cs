...
{
    /// <summary>
    /// JlinerAddJunctionLiner2Gateway
    /// </summary>
    public class JlinerAddJunctionLiner2Gateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public JlinerAddJunctionLiner2Gateway()
            : base("JunctionLiner2")
        {
        }
        ...
        public JlinerAddJunctionLiner2Gateway(DataSet data)
        ...
        public DataSet LoadAllById(Guid id, int companyId)
        {
            FillDataWithStoredProcedure("LFS_CWP_JLINERADDJUNCTIONLINER2GATEWAY_LOADALLBYID", new SqlParameter("@id", id), new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        public DataRow GetRow(Guid id, int refId, int companyId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.CWP.Jliner.JlinerAddJunctionLiner2Gateway.GetRow");
            }
        }
        ...
        public float? GetDistanceFromUSMH(Guid id, int refId, int companyId)
        {
            ...
            {
                return (float)GetRow(id, refId, companyId)["DistanceFromUSMH"];
            }
        }
        ...
        public float? GetDistanceFromUSMHOriginal(Guid id, int refId, int companyId)
        {
            ...
            {
                return (float)GetRow(id, refId, companyId)["DistanceFromUSMH", DataRowVersion.Original];
            }
        }
        ...
        public float? GetDistanceFromDSMH(Guid id, int refId, int companyId)
        {
            ...
            {
                return (float)GetRow(id, refId, companyId)["DistanceFromDSMH"];
            }
        }
        ...
        public float? GetDistanceFromDSMHOriginal(Guid id, int refId, int companyId)
        {
            ...
            {
                return (float)GetRow(id, refId, companyId)["DistanceFromDSMH", DataRowVersion.Original];
            }
        }
