...
{
    /// <summary>
    /// FullLengthLiningCommentDetailsGateway
    /// </summary>
    public class FullLengthLiningCommentDetailsGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public FullLengthLiningCommentDetailsGateway()
            : base("CommentDetails")
        {
        }
        ...
        public FullLengthLiningCommentDetailsGateway(DataSet data)
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_FULLLENGTHLININGCOMMENTDETAILSGATEWAY_LOADALLBYWORKIDWORKTYPE", new SqlParameter("@workId", workId), new SqlParameter("@companyId", companyId), new SqlParameter("@workType", workType));
            return Data;
        }
        ...
        /// <param name="companyId">companyId</param>
        /// <returns>data set</returns>
        public DataSet LoadAllByFlWorkIdRaWorkId(int flWorkId, int raWorkId, int companyId)
        {
            FillDataWithStoredProcedure("LFS_CWP_FULLLENGTHLININGCOMMENTDETAILSGATEWAY_LOADALLBYFLWORKIDRAWORKID", new SqlParameter("@flWorkId", flWorkId), new SqlParameter("@raWorkId", raWorkId), new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        public DataRow GetRow(int workId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.CWP.FullLenthLining.FullLengthLiningCommentDetailsGateway.GetRow");
            }
        }
