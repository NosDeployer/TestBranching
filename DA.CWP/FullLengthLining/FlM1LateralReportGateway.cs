...
{
    /// <summary>
    /// FlM1LateralReportGateway
    /// </summary>
    public class FlM1LateralReportGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public FlM1LateralReportGateway()
            : base("M1_LATERAL")
        {
        }
        ...
        public FlM1LateralReportGateway(DataSet data)
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_FLM1LATERALREPORTGATEWAY_LOADBYASSETID", new SqlParameter("@assetId", assetId), new SqlParameter("@companyId", companyId));//Note: COMPANY_ID
            return Data;
        }      
