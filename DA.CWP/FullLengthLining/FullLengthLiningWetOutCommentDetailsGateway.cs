...
namespace LiquiForce.LFSLive.DA.CWP.FullLengthLining
{
    ...
    /// </summary>
    public class FullLengthLiningWetOutCommentsDetailsGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public FullLengthLiningWetOutCommentsDetailsGateway()
        ...
        public FullLengthLiningWetOutCommentsDetailsGateway(DataSet data)
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "WetOutCommentsDetails";
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_FULLLENGTHLININGWETOUTCOMMENTSDETAILSGATEWAY_LOADALLBYWORKIDWORKTYPE", new SqlParameter("@workId", workId), new SqlParameter("@companyId", companyId), new SqlParameter("@workType", workType));
            return Data;
        }
        ...
        public DataRow GetRow(int workId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.CWP.FullLenthLining.FullLengthLiningWetOutCommentsDetailsGateway.GetRow");
            }
        }
