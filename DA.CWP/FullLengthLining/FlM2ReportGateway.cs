...
namespace LiquiForce.LFSLive.DA.CWP.FullLengthLining
{
    ...
    /// FlM2ReportGateway
    /// </summary>
    public class FlM2ReportGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        public FlM2ReportGateway(DataSet data)
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_FLM2REPORTGATEWAY_LOADBYCOMPANIESIDPROJECTID", new SqlParameter("@companyId", companyId), new SqlParameter("@companiesId", companiesId), new SqlParameter("@projectId", projectId));//Note: COMPANY_ID
            return Data;           
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_FLM2REPORTGATEWAY_LOADBYCOMPANIESID", new SqlParameter("@companyId", companyId), new SqlParameter("@companiesId", companiesId));//Note: COMPANY_ID
            return Data;
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_FLM2REPORTGATEWAY_LOAD", new SqlParameter("@companyId", companyId));//Note: COMPANY_ID
            return Data;
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_FLM2REPORTGATEWAY_LOADBYDATE", new SqlParameter("@companyId", companyId), new SqlParameter("@date", date));//Note: COMPANY_ID
            return Data;
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_FLM2REPORTGATEWAY_LOADBYSTREET", new SqlParameter("@companyId", companyId), new SqlParameter("@street", street));//Note: COMPANY_ID
            return Data;
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_FLM2REPORTGATEWAY_LOADBYSUBAREA", new SqlParameter("@companyId", companyId), new SqlParameter("@subArea", subArea));//Note: COMPANY_ID
            return Data;
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_FLM2REPORTGATEWAY_LOADBYSECTIONID", new SqlParameter("@companyId", companyId), new SqlParameter("@sectionId", sectionId));//Note: COMPANY_ID
            return Data;
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_FLM2REPORTGATEWAY_LOADBYCOMPANIESIDSECTIONID", new SqlParameter("@companyId", companyId), new SqlParameter("@companiesId", companiesId), new SqlParameter("@sectionId", sectionId));//Note: COMPANY_ID
            return Data;
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_FLM2REPORTGATEWAY_LOADBYCOMPANIESIDDATE", new SqlParameter("@companyId", companyId), new SqlParameter("@companiesId", companiesId), new SqlParameter("@date", date));//Note: COMPANY_ID
            return Data;
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_FLM2REPORTGATEWAY_LOADBYCOMPANIESIDSTREET", new SqlParameter("@companyId", companyId), new SqlParameter("@companiesId", companiesId), new SqlParameter("@street", street));//Note: COMPANY_ID
            return Data;
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_FLM2REPORTGATEWAY_LOADBYCOMPANIESIDSUBAREA", new SqlParameter("@companyId", companyId), new SqlParameter("@companiesId", companiesId), new SqlParameter("@subArea", subArea));//Note: COMPANY_ID
            return Data;
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_FLM2REPORTGATEWAY_LOADBYCOMPANIESIDPROJECTIDSECTIONID", new SqlParameter("@companyId", companyId), new SqlParameter("@companiesId", companiesId), new SqlParameter("@projectId", projectId), new SqlParameter("@sectionId", sectionId));//Note: COMPANY_ID
            return Data;
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_FLM2REPORTGATEWAY_LOADBYCOMPANIESIDPROJECTIDDATE", new SqlParameter("@companyId", companyId), new SqlParameter("@companiesId", companiesId), new SqlParameter("@projectId", projectId), new SqlParameter("@date", date));//Note: COMPANY_ID
            return Data;
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_FLM2REPORTGATEWAY_LOADBYCOMPANIESIDPROJECTIDSTREET", new SqlParameter("@companyId", companyId), new SqlParameter("@companiesId", companiesId), new SqlParameter("@projectId", projectId), new SqlParameter("@street", street));//Note: COMPANY_ID
            return Data;
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_FLM2REPORTGATEWAY_LOADBYCOMPANIESIDPROJECTIDSUBAREA", new SqlParameter("@companyId", companyId), new SqlParameter("@companiesId", companiesId), new SqlParameter("@projectId", projectId), new SqlParameter("@subArea", subArea));//Note: COMPANY_ID
            return Data;
        }
