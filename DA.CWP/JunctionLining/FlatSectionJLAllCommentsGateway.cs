...
{
    /// <summary>
    /// FlatSectionJLAllCommentsGateway
    /// </summary>
    public class FlatSectionJLAllCommentsGateway: DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public FlatSectionJLAllCommentsGateway()
            : base("AllComments")
        {
        }
        ...
        public FlatSectionJLAllCommentsGateway(DataSet data)
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_FLATSECTIONJLALLCOMMENTSGATEWAY_LOADALLBYJLWORKIDFLWORKIDRAWORKID", new SqlParameter("@jlWorkId", jlWorkId), new SqlParameter("@flWorkId", flWorkId), new SqlParameter("@raWorkId", raWorkId), new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        public DataRow GetRow(int workId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.CWP.JunctionLining.FlatSectionJlALLCommentsGateway.GetRow");
            }
        }
