...
{
    /// <summary>
    /// FlatSectionJLAllHistoryGateway
    /// </summary>
    public class FlatSectionJLAllHistoryGateway: DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public FlatSectionJLAllHistoryGateway()
            : base("AllHistory")
        {
        }
        ...
        public FlatSectionJLAllHistoryGateway(DataSet data)
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "AllHistory";
        ...
        public DataSet LoadAllByJlWorkIdFlWorkIdRaWorkId(int jlWorkId, int flWorkId, int raWorkId, int companyId)
        {
            FillDataWithStoredProcedure("LFS_CWP_FLATSECTIONJLALLHISTORYGATEWAY_LOADALLBYJLWORKIDFLWORKIDRAWORKID", new SqlParameter("@jlWorkId", jlWorkId), new SqlParameter("@flWorkId", flWorkId), new SqlParameter("@raWorkId", raWorkId), new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        public DataRow GetRow(int workId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.CWP.JunctionLining.FlatSectionJlALLHistoryGateway.GetRow");
            }
        }
        ...
        public string GetHistory(int workId, int refId)
        {
        ...
        public string GetHistoryOriginal(int workId, int refId)
        {
