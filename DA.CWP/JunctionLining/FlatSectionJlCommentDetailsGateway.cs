...
namespace LiquiForce.LFSLive.DA.CWP.JunctionLining
{
    ...
    /// </summary>
    public class FlatSectionJlCommentDetailsGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public FlatSectionJlCommentDetailsGateway()
        ...
        public FlatSectionJlCommentDetailsGateway(DataSet data)
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "FlatSectionJlCommentDetails";
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_FLATSECTIONJLCOMMENTDETAILSGATEWAY_LOADALLBYWORKIDWORKTYPE", new SqlParameter("@workId", workId), new SqlParameter("@companyId", companyId), new SqlParameter("@workType", workType));
            return Data;
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_FLATSECTIONJLCOMMENTDETAILSGATEWAY_LOADALLBYJLWORKIDRAWORKIDFLWORKID", new SqlParameter("@jlWorkId", jlWorkId), new SqlParameter("@raWorkId", raWorkId), new SqlParameter("@flWorkId", flWorkId), new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        public DataRow GetRow(int workId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.CWP.JunctionLining.FlatSectionJlCommentDetailsGateway.GetRow");
            }
        }
