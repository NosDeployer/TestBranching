...
{
    /// <summary>
    /// RehabAssessmentSectionDetailsGateway
    /// </summary>
    public class RehabAssessmentSectionDetailsGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public RehabAssessmentSectionDetailsGateway()
            : base("SectionDetails")
        {
        }
        ...
        public RehabAssessmentSectionDetailsGateway(DataSet data)
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_REHABASSESSMENTSECTIONDETAILSGATEWAY_LOADBYWORKID", new SqlParameter("@workId", workId), new SqlParameter("@companyId", companyId));
            return Data;            
        }
        ...
        public DataRow GetRow(int workId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.CWP.RehabAssessment.RehabAssessmentSectionDetailsGateway.GetRow");
            }
        }
