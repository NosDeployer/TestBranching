...
namespace LiquiForce.LFSLive.DA.CWP.RehabAssessment
{
    ...
    /// </summary>
    public class RehabAssessmentCommentDetailsGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public RehabAssessmentCommentDetailsGateway()
            : base("CommentDetails")
        {
        }
        ...
        public RehabAssessmentCommentDetailsGateway(DataSet data)
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_REHABASSESSMENTCOMMENTDETAILSGATEWAY_LOADALLBYWORKIDWORKTYPE", new SqlParameter("@workId", workId), new SqlParameter("@companyId", companyId), new SqlParameter("@workType", workType));
            return Data;
        }
        ...
        public DataRow GetRow(int workId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.CWP.RehabAssessment.RehabAssessmentCommentDetailsGateway.GetRow");
            }
        }
        ...
        /// <param name="refId">refId</param>
        /// <returns>Type or EMPTY</returns>
        public bool GetToHistory(int workId, int refId)
        {
            return (bool)GetRow(workId, refId)["ToHistory"];
        }



        /// <summary>
        /// GetToHistory Original
        /// </summary>
        /// <param name="workId">workId</param>
        /// <param name="refId">refId</param>
        /// <returns>Original to history or EMPTY</returns>
        public bool GetToHistoryOriginal(int workId, int refId)
        {
            return (bool)GetRow(workId, refId)["ToHistory", DataRowVersion.Original];
        }
