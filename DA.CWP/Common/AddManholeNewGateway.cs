...
{
    /// <summary>
    /// AddManholeNewGateway
    /// </summary>
    public class AddManholeNewGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        public AddManholeNewGateway(DataSet data)
        ...
        public DataRow GetRow(int assetId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.CWP.Common.AddManholeGateway.GetRow");
            }
        }
