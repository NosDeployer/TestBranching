...
{
    /// <summary>
    /// ManholeRehabilitationCommentDetailsGateway
    /// </summary>
    public class ManholeRehabilitationCommentDetailsGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ManholeRehabilitationCommentDetailsGateway()
            : base("CommentDetails")
        {
        }
        ...
        public ManholeRehabilitationCommentDetailsGateway(DataSet data)
        ...
        {
            FillDataWithStoredProcedure("LFS_CWP_MANHOLEREHABILITATIONCOMMENTDETAILSGATEWAY_LOADALLBYWORKIDWORKTYPE", new SqlParameter("@workId", workId), new SqlParameter("@companyId", companyId), new SqlParameter("@workType", workType));
            return Data;
        }
        ...
        public DataRow GetRow(int workId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.CWP.ManholeRehabilitation.ManholeRehabilitationCommentDetailsGateway.GetRow");
            }
        }
