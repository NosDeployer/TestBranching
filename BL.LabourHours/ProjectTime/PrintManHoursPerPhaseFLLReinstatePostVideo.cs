...
namespace LiquiForce.LFSLive.BL.LabourHours.ProjectTime
{
    ...
    /// </summary>
    public class PrintManHoursPerPhaseFLLReinstatePostVideo : TableModule
    {
        // ////////////////////////////////////////////////////////////////////////     
        // CONSTRUCTORS
        //
        ...
        /// Default constructor
        /// </summary>
        public PrintManHoursPerPhaseFLLReinstatePostVideo()
        ...
        public PrintManHoursPerPhaseFLLReinstatePostVideo(DataSet data)
        ...
        {
            PrintManHoursPerPhaseFLLReinstatePostVideoGateway printManhoursPerPhaseGateway = new PrintManHoursPerPhaseFLLReinstatePostVideoGateway(Data);
        ...
        public void LoadAllByStartDateEndDateProjectTimeStateWorkFunction(int? countryId, DateTime startDate, DateTime endDate, string projectTimeState, string work, string function, int companyId, string confirmedSize1, string confirmedSize2, string accessType)
        {
            ...
            printManhoursPerPhaseGateway.LoadByStartDateEndDateProjectTimeStateWorkFunction(countryId, startDate, endDate, projectTimeState, work, "Reinstate & Post Video", confirmedSize1, confirmedSize2, accessType);
        ...
        public void LoadAllByCompaniesIdStartDateEndDateProjectTimeStateWorkFunction(int companiesId, DateTime startDate, DateTime endDate, string projectTimeState, string work, string function, int companyId, string confirmedSize1, string confirmedSize2, string accessType)
        {
            PrintManHoursPerPhaseFLLReinstatePostVideoGateway printManhoursPerPhaseGateway = new PrintManHoursPerPhaseFLLReinstatePostVideoGateway(Data);
            printManhoursPerPhaseGateway.ClearBeforeFill = false;
            printManhoursPerPhaseGateway.LoadByCompaniesIdStartDateEndDateProjectTimeStateWorkFunction(companiesId, startDate, endDate, projectTimeState, work, "Reinstate & Post Video", confirmedSize1, confirmedSize2, accessType);
            printManhoursPerPhaseGateway.ClearBeforeFill = true;
