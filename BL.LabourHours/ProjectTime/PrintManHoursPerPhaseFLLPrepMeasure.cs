...
namespace LiquiForce.LFSLive.BL.LabourHours.ProjectTime
{
    ...
    /// </summary>
    public class PrintManHoursPerPhaseFLLPrepMeasure : TableModule
    {
        // ////////////////////////////////////////////////////////////////////////     
        // CONSTRUCTORS
        //
        ...
        /// Default constructor
        /// </summary>
        public PrintManHoursPerPhaseFLLPrepMeasure()
            : base("PrintManHoursPerPhaseFLLPrepMeasure")
        {
        }
        ...
        public PrintManHoursPerPhaseFLLPrepMeasure(DataSet data)
            : base(data, "PrintManHoursPerPhaseFLLPrepMeasure")
        {
        }
        ...
        {
            PrintManHoursPerPhaseFLLPrepMeasureGateway printManhoursPerPhaseGateway = new PrintManHoursPerPhaseFLLPrepMeasureGateway(Data);
        ...
        public void LoadAllByStartDateEndDateProjectTimeStateWorkFunction(int? countryId, DateTime startDate, DateTime endDate, string projectTimeState, string work, string function, int companyId, string confirmedSize1, string confirmedSize2, string accessType)
        {
            ...
            printManhoursPerPhaseGateway.LoadByStartDateEndDateProjectTimeStateWorkFunction(countryId, startDate, endDate, projectTimeState, work, "Prep & Measure", confirmedSize1, confirmedSize2, accessType);
        ...
        public void LoadAllByCompaniesIdStartDateEndDateProjectTimeStateWorkFunction(int companiesId, DateTime startDate, DateTime endDate, string projectTimeState, string work, string function, int companyId, string confirmedSize1, string confirmedSize2, string accessType)
        {
            PrintManHoursPerPhaseFLLPrepMeasureGateway printManhoursPerPhaseGateway = new PrintManHoursPerPhaseFLLPrepMeasureGateway(Data);
            printManhoursPerPhaseGateway.ClearBeforeFill = false;
            printManhoursPerPhaseGateway.LoadByCompaniesIdStartDateEndDateProjectTimeStateWorkFunction(companiesId, startDate, endDate, projectTimeState, work, "Prep & Measure", confirmedSize1, confirmedSize2, accessType);
            printManhoursPerPhaseGateway.ClearBeforeFill = true;
        ...
        public void ProcessDataForProject(int companyId)
        {
            ...
            foreach (PrintManhoursPerPhaseTDS.PrintManHoursPerPhaseFLLPrepMeasureRow row1 in (PrintManhoursPerPhaseTDS.PrintManHoursPerPhaseFLLPrepMeasureDataTable)Table)
            {
            ...
            foreach (PrintManhoursPerPhaseTDS.PrintManHoursPerPhaseFLLPrepMeasureRow row2 in (PrintManhoursPerPhaseTDS.PrintManHoursPerPhaseFLLPrepMeasureDataTable)Table)
            {
            ...
            foreach (PrintManhoursPerPhaseTDS.PrintManHoursPerPhaseFLLPrepMeasureRow row3 in (PrintManhoursPerPhaseTDS.PrintManHoursPerPhaseFLLPrepMeasureDataTable)Table)
            {
