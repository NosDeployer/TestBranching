...
{
    public class PrintManHoursPerPhaseRAPreVideo : TableModule
    {
        // ////////////////////////////////////////////////////////////////////////     
        // CONSTRUCTORS
        //
        ...
        /// Default constructor
        /// </summary>
        public PrintManHoursPerPhaseRAPreVideo()
        ...
        public PrintManHoursPerPhaseRAPreVideo(DataSet data)
        ...
        {
            PrintManHoursPerPhaseRAPreVideoGateway printManhoursPerPhaseGateway = new PrintManHoursPerPhaseRAPreVideoGateway(Data);
        ...
        public void LoadAllByStartDateEndDateProjectTimeStateWorkFunction(int? countryId, DateTime startDate, DateTime endDate, string projectTimeState, string work, string function, int companyId, string confirmedSize1, string confirmedSize2, string accessType)
        {
            ...
            printManhoursPerPhaseGateway.LoadByStartDateEndDateProjectTimeStateWorkFunction(countryId, startDate, endDate, projectTimeState, work, "Pre-Video", confirmedSize1, confirmedSize2, accessType);
        ...
        public void LoadAllByCompaniesIdStartDateEndDateProjectTimeStateWorkFunction(int companiesId, DateTime startDate, DateTime endDate, string projectTimeState, string work, string function, int companyId, string confirmedSize1, string confirmedSize2, string accessType)
        {
            PrintManHoursPerPhaseRAPreVideoGateway printManhoursPerPhaseGateway = new PrintManHoursPerPhaseRAPreVideoGateway(Data);
            printManhoursPerPhaseGateway.ClearBeforeFill = false;
            printManhoursPerPhaseGateway.LoadByCompaniesIdStartDateEndDateProjectTimeStateWorkFunction(companiesId, startDate, endDate, projectTimeState, work, "Pre-Video", confirmedSize1, confirmedSize2, accessType);
            printManhoursPerPhaseGateway.ClearBeforeFill = true;
        ...
        public void ProcessDataForProject(int companyId)
        {
            ...
            foreach (PrintManhoursPerPhaseTDS.PrintManHoursPerPhaseRAPreVideoRow rowOriginal in (PrintManhoursPerPhaseTDS.PrintManHoursPerPhaseRAPreVideoDataTable)Table)
            {
            ...
            foreach (PrintManhoursPerPhaseTDS.PrintManHoursPerPhaseRAPreVideoRow row3 in (PrintManhoursPerPhaseTDS.PrintManHoursPerPhaseRAPreVideoDataTable)Table)
            {
