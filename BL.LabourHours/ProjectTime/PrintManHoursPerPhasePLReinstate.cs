...
{
    /// <summary>
    /// PrintManHoursPerPhasePLReinstate
    /// </summary>
    public class PrintManHoursPerPhasePLReinstate : TableModule
    {
        // ////////////////////////////////////////////////////////////////////////     
        // CONSTRUCTORS
        //
        ...
        /// Default constructor
        /// </summary>
        public PrintManHoursPerPhasePLReinstate()
        ...
        public PrintManHoursPerPhasePLReinstate(DataSet data)
        ...
        {
            PrintManHoursPerPhasePLReinstateGateway printManhoursPerPhaseGateway = new PrintManHoursPerPhasePLReinstateGateway(Data);
        ...
        private void ProcessDataForProject(int companyId)
        {
            ...
            foreach (PrintManhoursPerPhaseTDS.PrintManHoursPerPhasePLReinstateRow row1 in (PrintManhoursPerPhaseTDS.PrintManHoursPerPhasePLReinstateDataTable)Table)
            {
            ...
            foreach (PrintManhoursPerPhaseTDS.PrintManHoursPerPhasePLReinstateRow row2 in (PrintManhoursPerPhaseTDS.PrintManHoursPerPhasePLReinstateDataTable)Table)
            {
            ...
            foreach (PrintManhoursPerPhaseTDS.PrintManHoursPerPhasePLReinstateRow row3 in (PrintManhoursPerPhaseTDS.PrintManHoursPerPhasePLReinstateDataTable)Table)
            {
