...
{
    /// <summary>
    /// PrintManHoursPerPhasePLInstall
    /// </summary>
    public class PrintManHoursPerPhasePLInstall : TableModule
    {
        // ////////////////////////////////////////////////////////////////////////     
        // CONSTRUCTORS
        //
        ...
        /// Default constructor
        /// </summary>
        public PrintManHoursPerPhasePLInstall()
        ...
        public PrintManHoursPerPhasePLInstall(DataSet data)
        ...
        {
            PrintManHoursPerPhasePLInstallGateway printManhoursPerPhaseGateway = new PrintManHoursPerPhasePLInstallGateway(Data);
        ...
        private void ProcessDataForProject(int companyId)
        {
            ...
            foreach (PrintManhoursPerPhaseTDS.PrintManHoursPerPhasePLInstallRow row1 in (PrintManhoursPerPhaseTDS.PrintManHoursPerPhasePLInstallDataTable)Table)
            {
            ...
            foreach (PrintManhoursPerPhaseTDS.PrintManHoursPerPhasePLInstallRow row2 in (PrintManhoursPerPhaseTDS.PrintManHoursPerPhasePLInstallDataTable)Table)
            {
            ...
            foreach (PrintManhoursPerPhaseTDS.PrintManHoursPerPhasePLInstallRow row3 in (PrintManhoursPerPhaseTDS.PrintManHoursPerPhasePLInstallDataTable)Table)
            {
