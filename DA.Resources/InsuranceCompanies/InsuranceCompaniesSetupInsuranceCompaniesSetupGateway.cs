...
{
    /// <summary>
    /// InsuranceCompaniesSetupInsuranceCompaniesSetupGateway 
    /// </summary>
    public class InsuranceCompaniesSetupInsuranceCompaniesSetupGateway: DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public InsuranceCompaniesSetupInsuranceCompaniesSetupGateway()
        ...
        public InsuranceCompaniesSetupInsuranceCompaniesSetupGateway(DataSet data)
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "InsuranceCompaniesSetup";
        ...
        {
            FillDataWithStoredProcedure("LFS_RESOURCES_INSURANCECOMPANIESSETUPINSURANCECOMPANIESSETUPGATEWAY_LOADALL", new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_RESOURCES_INSURANCECOMPANIESSETUPINSURANCECOMPANIESSETUPGATEWAY_LOAD", new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        public DataRow GetRow(int companiesId, DateTime date)
        {
            ...
            throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.Resources.InsuranceCompanies.InsuranceCompaniesSetupInsuranceCompaniesGateway.GetRow");
        }
