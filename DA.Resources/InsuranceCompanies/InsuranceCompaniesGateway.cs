...
{
    /// <summary>
    /// InsuranceCompaniesGateway
    /// </summary>
    public class InsuranceCompaniesGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public InsuranceCompaniesGateway()
        ...
        public InsuranceCompaniesGateway(DataSet data)
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "LFS_RESOURCES_INSURANCE_COMPANIES";
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[LFS_RESOURCES_INSURANCE_COMPANIES] WHERE (([COMPANIES_ID] = @Original_COMPANIES_ID) AND ([Date] = @Original_Date) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ([Deleted] = @Original_Deleted) AND ([COMPANY_ID] = @Original_COMPANY_ID))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[LFS_RESOURCES_INSURANCE_COMPANIES] ([COMPANIES_ID], [Date], [Name], [Deleted], [COMPANY_ID]) VALUES (@COMPANIES_ID, @Date, @Name, @Deleted, @COMPANY_ID);
SELECT COMPANIES_ID, Date, Name, Deleted, COMPANY_ID FROM LFS_RESOURCES_INSURANCE_COMPANIES WHERE (COMPANIES_ID = @COMPANIES_ID) AND (Date = @Date)";
...
SELECT COMPANIES_ID, Date, Name, Deleted, COMPANY_ID FROM LFS_RESOURCES_INSURANCE_COMPANIES WHERE (COMPANIES_ID = @COMPANIES_ID) AND (Date = @Date)";
        ...
        public int Insert(int companiesId, DateTime date, string name, bool deleted, int companyId)
        {
            ...
            string command = "INSERT INTO [dbo].[LFS_RESOURCES_INSURANCE_COMPANIES] ([COMPANIES_ID], [Date], [Name], [Deleted], [COMPANY_ID]) VALUES (@COMPANIES_ID, @Date, @Name, @Deleted, @COMPANY_ID)";
        ...
        public void Delete(int originalCompaniesId, DateTime originalDate)
        {
            ...
            string command = "UPDATE [dbo].[LFS_RESOURCES_INSURANCE_COMPANIES] SET  [Deleted] = @Deleted  " +
