...
{
    /// <summary>
    /// EmployeeNotesGateway
    /// </summary>
    public class EmployeeNotesGateway: DataTableGateway
    {
        ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        public EmployeeNotesGateway(DataSet data)
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "LFS_RESOURCES_EMPLOYEE_NOTES";
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[LFS_RESOURCES_EMPLOYEE_NOTES] WHERE (([EmployeeID] = @Original_EmployeeID) AND ([RefID] = @Original_RefID) AND ([Subject] = @Original_Subject) AND ([UserID] = @Original_UserID) AND ([DateTime_] = @Original_DateTime_) AND ([Deleted] = @Original_Deleted) AND ([COMPANY_ID] = @Original_COMPANY_ID))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[LFS_RESOURCES_EMPLOYEE_NOTES] ([EmployeeID], [RefID], [Subject], [UserID], [DateTime_], [Note], [Deleted], [COMPANY_ID]) VALUES (@EmployeeID, @RefID, @Subject, @UserID, @DateTime_, @Note, @Deleted, @COMPANY_ID);
SELECT EmployeeID, RefID, Subject, UserID, DateTime_, Note, Deleted, COMPANY_ID FROM LFS_RESOURCES_EMPLOYEE_NOTES WHERE (EmployeeID = @EmployeeID) AND (RefID = @RefID)";
...
SELECT EmployeeID, RefID, Subject, UserID, DateTime_, Note, Deleted, COMPANY_ID FROM LFS_RESOURCES_EMPLOYEE_NOTES WHERE (EmployeeID = @EmployeeID) AND (RefID = @RefID)";
        ...
        /// <summary>
        /// Insert a employee note (direct to DB)
        /// </summary>
        ...
        public int Insert(int employeeId, int refId, string subject, int userId, DateTime dateTime_, string note,  bool deleted, int companyId)
        {
            ...
            string command = "INSERT INTO [dbo].[LFS_RESOURCES_EMPLOYEE_NOTES] ([EmployeeID], [RefID], [Subject], [UserID], [DateTime_], [Note], [Deleted], [COMPANY_ID]) VALUES (@EmployeeID, @RefID, @Subject, @UserID, @DateTime_, @Note, @Deleted, @COMPANY_ID)";

            int rowsAffected = (int)ExecuteNonQuery(command, employeeIdParameter, refIdParameter, subjectParameter, userIdParameter, dateTime_Parameter, noteParameter, deletedParameter, companyIdParameter);
        ...
        /// <summary>
        /// Update employee note (direct to DB)
        /// </summary>
        ...
        public int Update(int originalEmployeeId, int originalRefId, string originalSubject, int originalUserId, DateTime originalDateTime_, string originalNote, bool originalDeleted, int originalCompanyId, int newEmployeeId, int newRefId, string newSubject, int newUserId,  DateTime newDateTime_, string newNote, bool newDeleted, int newCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_RESOURCES_EMPLOYEE_NOTES] SET [EmployeeID] = @EmployeeID, [RefID] = @RefID, " +
                " [Subject] = @Subject, [UserID] = @UserID, [DateTime_] = @DateTime_, [Note] = @Note, "+
                " [Deleted] = @Deleted, [COMPANY_ID] = @COMPANY_ID "+
                " WHERE (([EmployeeID] = @Original_EmployeeID) AND ([RefID] = @Original_RefID) "+
                " AND ([COMPANY_ID] = @Original_COMPANY_ID))";

            int rowsAffected = (int)ExecuteNonQuery(command, originalEmployeeIdParameter, originalRefIdParameter, originalSubjectParameter, originalUserIdParameter, originalDateTime_Parameter, originalNoteParameter, originalDeletedParameter, originalCompanyIdParameter, newEmployeeIdParameter, newRefIdParameter, newSubjectParameter, newUserIdParameter, newDateTime_Parameter, newNoteParameter, newDeletedParameter, newCompanyIdParameter); 
        ...
        /// <summary>
        /// Delete a employee note (direct to DB)
        /// </summary>
        /// <param name="originalEmployeeId">originalEmployeeId</param>
        /// <param name="originalRefId">originalRefId</param>
        /// <param name="originalCompanyId">originalCompanyId</param>
        ...
        public int Delete(int originalEmployeeId, int originalRefId, int originalCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_RESOURCES_EMPLOYEE_NOTES] SET  [Deleted] = @Deleted  " +
                             " WHERE (([EmployeeID] = @Original_EmployeeID) AND ([RefID] = @Original_RefID) AND " +
                             "  ([COMPANY_ID] = @Original_COMPANY_ID))";

            int rowsAffected = (int)ExecuteNonQuery( command, originalEmployeeIdParameter, originalRefIdParameter, originalCompanyIdParameter, deletedParameter);
        ...
        /// <summary>
        /// Delete all employee notes (direct to DB)
        /// </summary>
        /// <param name="originalEmployeeId">originalEmployeeId</param>
        /// <param name="originalCompanyId">originalCompanyId</param>
        /// <returns>int</returns>
