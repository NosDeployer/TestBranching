...
namespace LiquiForce.LFSLive.DA.Resources.Companies
{
    ...
    public class CompaniesListGateway : DataTableGateway
    {
        ...
        {
            FillDataWithStoredProcedure("LFS_RESOURCES_COMPANIESLISTGATEWAY_LOAD", new SqlParameter("@companyId", companyId)); 
            return Data;
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_RESOURCES_COMPANIESLISTGATEWAY_LOADBYCOUNTRYID", new SqlParameter("@companyId", companyId), new SqlParameter("countryId", countryId)); 
            return Data;
        }
