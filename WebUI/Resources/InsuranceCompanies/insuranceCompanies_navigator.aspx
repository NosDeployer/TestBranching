<%@ Page Language="C#" Title="LFS Live" MasterPageFile="../../mForm8.Master" AutoEventWireup="true" CodeBehind="insuranceCompanies_navigator.aspx.cs" Inherits="LiquiForce.LFSLive.WebUI.Resources.InsuranceCompanies.insuranceCompanies_navigator" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="TitlePlaceHolder" runat="server">
    <div style="width: 750px">
        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
            <tr>
                <td colspan="3">
                    <asp:Label ID="lblTitle" runat="server" Text="Insurance Companies Setup" SkinID="LabelPageTitle1"></asp:Label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <telerik:RadPanelBar ID="tkrpbLeftMenu" runat="server" SkinID="RadPanelBar" Width="180px" OnClientItemClicking="tkrpbLeftMenuItemClick">
                        <Items>
                            <telerik:RadPanelItem Expanded="True" Text="Insurance Companies" PostBack="false">
                                <Items>
                                    <telerik:RadPanelItem runat="server" Value="mAddInsuranceCompanies" Text="Add Insurance Companies"></telerik:RadPanelItem>                                    
                                </Items>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div style="width: 750px">
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%" class="Background_SearchAndSort">
            <tr>
                <td>
                    <asp:Label ID="lblTitleGeneral" runat="server" SkinID="LabelTitle1" Text="Insurance Companies"
        ...
        <table id="tdNoResults" runat="server" cellpadding="0" cellspacing="0" border="0" style="width: 100%" class="Background_NavigatorsNoResults">
            <tr>
                <td>
                    <asp:Label ID="lblNoResults" runat="server" Text="No insurance companies registered."></asp:Label>
                </td>
            </tr>
        </table>
                                                ...
                                                <table style="width: 100%" cellspacing="0" cellpadding="0" border="0">                                                                                                       
                                                    <td style="width: 50%">
                                                        <asp:ImageButton ID="ibtnDelete" runat="server" SkinID="GridView_Delete" ImageUrl="./../../App_Themes/LFS2/images/gridview/delete.png"
                                                            CommandName="Delete" OnClientClick='return confirm("Are you sure you want to delete this insurance company?");'>
                                                        </asp:ImageButton>
                                                    </td>                                                    
                                                </table>
                                            </ItemTemplate>
            ...
            <tr>
                <td>
                    <asp:ObjectDataSource ID="odsCompaniesSetup" runat="server"
                        ...
                        TypeName="LiquiForce.LFSLive.WebUI.Resources.InsuranceCompanies.insuranceCompanies_navigator"
