<%@ Page Language="C#" Title="LFS Live" MasterPageFile="./../../mWizard2.Master" AutoEventWireup="true" CodeBehind="bondingCompanies_add.aspx.cs" Inherits="LiquiForce.LFSLive.WebUI.Resources.BondingCompanies.bondingCompanies_add" %>
                            ...
                            <asp:WizardStep ID="StepBegin" runat="server" Title="Begin">
                                <asp:UpdatePanel ID="upnlUserErrorMessage" runat="server">
                                    ...
                                    <table cellpadding="0" cellspacing="0"  style="width: 100%">
                                        ...
                                        <tr>
                                            <td>                                            
                                                <asp:Label ID="lblUserErrorMessage" runat="server" SkinID="LabelError" Text="The bonding company is already registered in LFS Live."></asp:Label>                                                                                                
                                            </td>
                                        </tr>
                                    </table>
                                    </ContentTemplate>
