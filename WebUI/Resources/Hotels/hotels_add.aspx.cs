...
namespace LiquiForce.LFSLive.WebUI.Resources.Hotels
{
    ...
    /// hotels_add
    /// </summary>
    public partial class hotels_add : System.Web.UI.Page
    {
        // ////////////////////////////////////////////////////////////////////////
        // FIELDS
        //
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                // Security check
                if (!(Convert.ToBoolean(Session["sgLFS_RESOURCES_HOTELS_ADD"])))
                {
                ...
                {
                    Response.Redirect("./../../error_page.aspx?error=" + "Invalid query string in hotels_add.aspx");
                }
        ...
        protected void Wizard_ActiveStepChanged(object sender, EventArgs e)
        {
            if (ViewState["StepFrom"] != null)
            {
                switch (wzTeamMember.ActiveStep.Name)
                {
                    ...
                    default:
                        throw new Exception("The option for " + wzTeamMember.ActiveStep.Name + " step in hotels_add.Wizard_ActiveStepChanged function does not exist");
                }
            }
        }
        ...
        protected void Wizard_NextButtonClick(object sender, WizardNavigationEventArgs e)
        {
            switch (wzTeamMember.ActiveStep.Name)
            {
                ...
                default:
                    throw new Exception("The option for " + wzTeamMember.ActiveStep.Name + " step in hotels_add.Wizard_NextButtonClick function does not exist");
            }
        }
        ...
        protected void Wizard_PreviousButtonClick(object sender, WizardNavigationEventArgs e)
        {
            ...
            {                                
                ...
                default:
                    throw new Exception("The option for " + wzTeamMember.ActiveStep.Name + " step in hotels_add.Wizard_PreviousButtonClick function does not exist");
            }
            if (!e.Cancel)
            {
        ...
        private void StepBeginIn()
        {
            ...
            instruction.Text = "Please select a Hotel";
        }
        ...
        private void RegisterClientScripts()
        {
            ...
            this.ClientScript.RegisterClientScriptInclude("clientSideCode", "./hotels_add.js");
        }
