<%@ Page Title="LFS Live" Language="C#" MasterPageFile="../../mForm6.master" AutoEventWireup="true" CodeBehind="vacations_add.aspx.cs" Inherits="LiquiForce.LFSLive.WebUI.LabourHours.Vacations.vacations_add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="TitlePlaceHolder" runat="server">
    <div style="width: 750px">
        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
            <tr>
                <td colspan="3">
                    <asp:Label ID="lblTitle" runat="server" SkinID="LabelPageTitle1" Text="Add Vacations"></asp:Label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    ...
                    <asp:UpdatePanel ID="upnlMissingData" runat="server">
                        <ContentTemplate>
                            <asp:Label ID="lblMissingData" Visible="false" runat="server" SkinID="LabelError" Text=""></asp:Label>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
            </tr>
    ...
    <div style="width: 750px">
            ...
            <tr>
                <td>
                    <asp:UpdatePanel ID="upnlEmployee" runat="server">
                        <ContentTemplate>
                            <asp:TextBox ID="tbxEmployee" runat="server" SkinID="TextBoxReadOnly" Width="240px"
                                ReadOnly="true" EnableViewState="true"></asp:TextBox>
                            <asp:DropDownList ID="ddlEmployee" AutoPostBack="true" runat="server" SkinID="DropDownList"
                                Width="240px" OnSelectedIndexChanged="ddlEmployee_SelectedIndexChanged">
                            </asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
                <td>
                    <asp:UpdatePanel ID="upnlMax" runat="server">
                        <ContentTemplate>
                            <asp:TextBox ID="tbxMax" runat="server" SkinID="TextBoxReadOnly" Width="240px" ReadOnly="true" EnableViewState="true"></asp:TextBox>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
                <td>
                    <asp:UpdatePanel ID="upnlRemaining" runat="server">
                        <ContentTemplate>
                            <asp:TextBox ID="tbxRemaining" runat="server" SkinID="TextBoxReadOnly" Width="240px" EnableViewState="true"
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
            ...
            <tr>
                <td colspan="6">
                    <asp:UpdatePanel ID="upnlComments" runat="server">
                        <ContentTemplate>
                            <asp:TextBox ID="tbxComments" runat="server" SkinID="TextBoxMemo" Width="740px" TextMode="MultiLine"
                                Rows="2"></asp:TextBox>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
            ...
            <tr>
                ...
                <td colspan="6">
                    <table id="tdLegendVacations" runat="server" cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                        <tr>
                            <%--gray--%>
                            <td style="width: 15px; height: 15px; background-color: #BCBFC2">
                            </td>
                            <td style="width: 10px;">
                            </td>
                            <td style="width: 200px">
                                <asp:Label ID="lblNonWorkingDays" runat="server" Text="Non Working Days" SkinID="LabelSmall"></asp:Label>
                            </td>     
                            <%--green--%>
                            ...
                            <td style="width: 200px">
                                <asp:Label ID="lblOldPaidColor" runat="server" Text="Paid Days" SkinID="LabelSmall"></asp:Label>
                            </td>                      
                             <%--red--%>  
                            ...
                            <td style="width: 200px">
                                <asp:Label ID="lblOldUnpaidColor" runat="server" Text="Unpaid Days" SkinID="LabelSmall"></asp:Label>
                            </td>
                             <%--Blue--%>
                            <td style="width: 15px; height: 15px; background-color: #3a94cc">
                            </td>
                            <td style="width: 10px;">
                            </td>
                            <td style="width: 200px">
                                <asp:Label ID="lblPaidColor" runat="server" Text="New Paid Days" SkinID="LabelSmall"></asp:Label>
                            </td>
                            <%--skyblue--%>
                            <td style="width: 15px; height: 15px; background-color: #dfe7ec">
                            </td>
                            <td style="width: 10px;">
                            </td>
                            <td style="width: 200px">
                                <asp:Label ID="lblUnpaidColor" runat="server" Text="New Unpaid Days" SkinID="LabelSmall"></asp:Label>
                            </td>
                        </tr>
                    </table>    
                </td>
            ...
            <tr>
                <td>
                    <asp:ObjectDataSource ID="odsVacations" runat="server" 
                        FilterExpression="(Deleted = 0)" SelectMethod="GetVacationsNew" TypeName="LiquiForce.LFSLive.WebUI.LabourHours.Vacations.vacations_add" 
