<%@ Page Title="LFS Live" Language="C#" MasterPageFile="./../../mForm6.master" AutoEventWireup="true" CodeBehind="vacations_approve_vacation_request.aspx.cs" Inherits="LiquiForce.LFSLive.WebUI.LabourHours.Vacations.vacations_approve_vacation_request" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="TitlePlaceHolder" runat="server">
    <div style="width: 750px">
        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
            <tr>
                <td colspan="3">
                    <asp:Label ID="lblTitle" runat="server" SkinID="LabelPageTitle1" Text="Vacations For Approval"></asp:Label>
                </td>
            </tr>
            <tr>
        ...
        <table id="tdNoResults" runat="server" cellpadding="0" cellspacing="0" border="0" style="width: 100%">
            <tr>
                ...
                <td style="width: 730px" class="Background_NavigatorsNoResults">
                    <asp:Label ID="lblNoResults" runat="server" Text="No vacations for approval."></asp:Label>
                </td>
                <td style="width: 10px">
                </td>
            </tr>
                         ...
                         DataKeyNames="RequestID" SkinID="GridView" >
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Detail">
                                    <ItemTemplate>
                                        <asp:Label ID="lblDetails" runat="server" Width="175px" Text='<%# Bind("Details") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Comment">
                                    <ItemTemplate>
                                        <asp:TextBox ID="tbxRejectReason" runat="server" SkinID="TextBoxMemo" TextMode="MultiLine" Rows="3" Width="190px"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
