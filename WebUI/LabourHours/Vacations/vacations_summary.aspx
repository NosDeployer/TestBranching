<%@ Page Title="LFS Live" Language="C#" MasterPageFile="../../mForm6.master" AutoEventWireup="true" CodeBehind="vacations_summary.aspx.cs" Inherits="LiquiForce.LFSLive.WebUI.LabourHours.Vacations.vacations_summary" %>
                ...
                <td>
                    <telerik:RadMenu ID="tkrmTop" SkinID="RadMenu" runat="server" OnItemClick="tkrmTop_ItemClick">                        
                        <Items>
                            ...
                            <telerik:RadMenuItem Value="mAllVacations" Text="VIEW VACATIONS" />
                        </Items>
                    </telerik:RadMenu>
                </td>
            </tr>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <div style="width: 750px">
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
            ...
            <tr>
                <td>
                    <asp:TextBox ID="tbxEmployee" runat="server" SkinID="TextBoxReadOnly" Width="177px" ReadOnly="true"></asp:TextBox>
                </td>
                <td>
                ...
                <td>
                    <asp:UpdatePanel ID="upnlRemaining" runat="server">
                        <ContentTemplate>
                            <asp:TextBox ID="tbxRemaining" runat="server" SkinID="TextBoxReadOnly" Width="177px" ReadOnly="true"></asp:TextBox>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
                <td>
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
            ...
            <tr>
                <td colspan="6">
                    <asp:TextBox ID="tbxComments" runat="server" ReadOnly="true" SkinID="TextBoxReadOnly" Width="740px" TextMode="MultiLine" Rows="2"></asp:TextBox>
                </td>
            </tr>
            <tr>
                    ...
                    <asp:UpdatePanel ID="upnlVacations" runat="server">
                        <ContentTemplate>
                            <telerik:RadScheduler runat="server" ID="tkrsVacations" SkinID="RadScheduler" HoursPanelTimeFormat="htt"
                                Height="570px" AllowDelete="false" AllowEdit="false" AllowInsert="false" Width="740px"
                                ShowViewTabs="True" SelectedView="MonthView"                             
                                ...
                                OnNavigationComplete="tkrsVacations_NavigationComplete" onappointmentdatabound="tkrsVacations_AppointmentDataBound"                                                                 
                             >
            ...
            <tr>
                <td>
                    <asp:ObjectDataSource ID="odsVacations" runat="server" 
                        FilterExpression="(Deleted = 0)" SelectMethod="GetVacationsNew" TypeName="LiquiForce.LFSLive.WebUI.LabourHours.Vacations.vacations_summary" 
                    >
