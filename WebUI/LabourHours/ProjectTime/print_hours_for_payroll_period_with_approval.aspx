<%@ Page Title="LFS Live" Language="C#" MasterPageFile="./../../mReport1.Master" AutoEventWireup="true" CodeBehind="print_hours_for_payroll_period_with_approval.aspx.cs" Inherits="LiquiForce.LFSLive.WebUI.LabourHours.ProjectTime.print_hours_for_payroll_period_with_approval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
                                    ...
                                    <tr>
                                        <td style="width: 160px">
                                            <asp:Panel ID="pnlEmployee" Width="156px" Height="88px" runat="server" SkinID="Panel">
                                                <asp:CheckBoxList ID="cbxlEmployee" runat="server" DataSourceID="odsEmployee" DataTextField="FullName"
                                                    DataValueField="EmployeeID" SkinID="CheckBoxListWithoutBorder" onclick="return cbxSelectedClick(event);">
                                                </asp:CheckBoxList>
                                            </asp:Panel>
                                        </td>
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                        ...
                        <ContentTemplate>
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tbody>
                                    <tr>
                                        <td style="width: 160px">
                                            <asp:DropDownList ID="ddlProject" runat="server" SkinID="DropDownListLookup" DataValueField="ProjectID"
                                                DataTextField="NAME" DataSourceID="odsProject" Width="160px" DataMember="DefaultView"
            ...
            <tr>
                <td>
                    <asp:UpdatePanel ID="upnlIncludeAllHoursLabel" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:Label ID="lblIncludeAllHours" runat="server" SkinID="Label" Text="Include All Hours" Visible="false"></asp:Label>                            
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:UpdatePanel ID="upnlIncludeAllHours" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:CheckBox ID="cbxIncludeAllHours" runat="server" SkinID="CheckBox" Visible="false" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
            </tr>
