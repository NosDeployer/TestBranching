...
{
    /// <summary>
    /// print_hours_for_payroll_period
    /// </summary>
    public partial class print_hours_for_payroll_period : System.Web.UI.Page
    {
        // ////////////////////////////////////////////////////////////////////////
        // EVENTS
        //
        ...
        protected void Page_PreRender(object sender, EventArgs e)
        {
            ...
            master.Title = "Print Hours For Payroll Period Report (New Version)";
            ...
            if (Page.IsValid)
            {
                ...
                if (printHoursForPayrollPeriodGateway.Table.Rows.Count > 0)
                {
                    if (master.Format == "pdf")
                    {
                        if (ddlCountry.SelectedValue == "1")
                        {
                            master.Report = new LiquiForce.LFSLive.WebUI.LabourHours.ProjectTime.PrintHoursForPayrollPeriodReport();
                        }
                        else
                        {
                            master.Report = new LiquiForce.LFSLive.WebUI.LabourHours.ProjectTime.PrintHoursForPayrollPeriodUSAReport();
                        }
                    }
                    else
                    {
                        if (ddlCountry.SelectedValue == "1")
                        {
                            master.Report = new LiquiForce.LFSLive.WebUI.LabourHours.ProjectTime.PrintHoursForPayrollPeriodReportExport();
                        }
                        else
                        {
                            master.Report = new LiquiForce.LFSLive.WebUI.LabourHours.ProjectTime.PrintHoursForPayrollPeriodUSAReportExport();
                        }
                    }
