<%@ Page Title="LFS Live" Language="C#" MasterPageFile="./../../mReport1.Master" AutoEventWireup="true" CodeBehind="print_hours_for_payroll_period_old.aspx.cs" Inherits="LiquiForce.LFSLive.WebUI.LabourHours.ProjectTime.print_hours_for_payroll_period_old" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
            ...
            <tr>
                <td>
                    <asp:DropDownList ID="ddlCountry" runat="server" SkinID="DropDownList" Width="160px" DataSourceID="odsCountry" DataTextField="Name" DataValueField="CountryID" EnableViewState="False">
                    </asp:DropDownList>
                </td>
            </tr>
            <%--<tr>
