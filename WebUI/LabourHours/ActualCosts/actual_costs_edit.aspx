...
AutoEventWireup="true" Codebehind="actual_costs_edit.aspx.cs" Inherits="LiquiForce.LFSLive.WebUI.LabourHours.ActualCosts.actual_costs_edit" Title="LFS Live"  %>
            ...
            <tr>
                <td colspan="3">
                    <asp:UpdatePanel id="upnlTitleCategory" runat="server">
                        <contenttemplate>
                            <asp:Label ID="lblTitle" runat="server" SkinID="LabelPageTitle1" Text="Edit Subcontractor Costs" EnableViewState="False"></asp:Label>                            
                        </contenttemplate>
                    </asp:UpdatePanel>    
                </td>
            </tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
   ...
   <div style="width: 750px">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td colspan="2">
                    <asp:TextBox ID="tbxCategory" runat="server" ReadOnly="True" SkinID="TextBoxReadOnly" Width="365px"></asp:TextBox>
                </td>
                <td>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                     <asp:UpdatePanel id="upnlQuantityLabel" runat="server" UpdateMode="Always">
                        <contenttemplate> 
                ...
                <td>
                   <asp:UpdatePanel id="upnlTotalLabel" runat="server" UpdateMode="Always">
                        <contenttemplate> 
