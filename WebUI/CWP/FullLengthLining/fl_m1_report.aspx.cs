...
namespace LiquiForce.LFSLive.WebUI.CWP.FullLengthLining
{
    ...
    /// fl_m1_report
    /// </summary>
    public partial class fl_m1_report : System.Web.UI.Page
    {
        // ////////////////////////////////////////////////////////////////////////
        // EVENTS
        //
        ...
        protected void Page_PreRender(object sender, EventArgs e)
        {
            ...
            mReportForM1 master = (mReportForM1)this.Master;
        ...
        {
            mReportForM1 master = (mReportForM1)this.Master;
            master.GenerateMethod1 = new mReportForM1.ReportMethod1(Generate);
            master.GenerateMethod2 = new mReportForM1.ReportMethod2(Generate2);
        }
            ...
            if (flM1Report.Table.Rows.Count > 0)
            {
                ...
                if (master.Format1 == "pdf")
                {
                    if (ddlClient.SelectedValue != "-1")
                    {
                        ...
                        master.SetParameter1("Client", companiesGateway.GetName(currentCompanyId));
                    }
                    else
                    {
            ...
            if (flM2Report.Table.Rows.Count > 0)
            {
                ...
                if (master.Format2 == "pdf")
                {
                    if (ddlClient.SelectedValue != "-1")
                    {
                        ...
                        master.SetParameter2("Client", companiesGateway.GetName(currentClientId));
                    }
                    else
                    {
