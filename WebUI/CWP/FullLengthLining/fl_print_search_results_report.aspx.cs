...
{
    /// <summary>
    /// fl_print_search_results_report
    /// </summary>
    public partial class fl_print_search_results_report : System.Web.UI.Page
    {
        // ////////////////////////////////////////////////////////////////////////
        // EVENTS
        //
        ...
        private void Generate()
        {
            ...
            FlNavigatorTDS flNavigatorTDS = (FlNavigatorTDS)Session["flNavigatorTDS"];
            LiquiForce.LFSLive.BL.CWP.FullLengthLining.FlNavigator flNavigator = new LiquiForce.LFSLive.BL.CWP.FullLengthLining.FlNavigator(flNavigatorTDS);

            // set properties to master page
            master.Data = flNavigator.Data;
            master.Table = flNavigator.TableName;

            if (flNavigator.Table.Rows.Count > 0)
            {
                if (master.Format == "pdf")
                {
                    master.Report = new LiquiForce.LFSLive.WebUI.CWP.FullLengthLining.FlPrintSearchResultsReport();
                ...
                {
                    master.Report = new LiquiForce.LFSLive.WebUI.CWP.FullLengthLining.FlPrintSearchResultsReportExport();
