<%@ Page Language="C#" MasterPageFile="./../../mDialog2.master" AutoEventWireup="true"
    Codebehind="mr_comments.aspx.cs" Inherits="LiquiForce.LFSLive.WebUI.CWP.ManholeRehabilitation.mr_comments"
    Title="LFS Live" %>
                                                    ...
                                                    <asp:UpdatePanel ID="upTypeEdit" runat="server">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlTypeEdit" runat="server" SkinID="DropDownListLookup" Width="125px"
                                                                DataSourceID="odsCommentType" ValidationGroup="commentsDataEdit" AutoPostBack="True"
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="1">
                                                    <asp:DropDownList ID="ddlTypeNew" runat="server" SkinID="DropDownListLookup" Width="125px"
                                                        DataSourceID="odsCommentType" ValidationGroup="commentsDataAdd" AutoPostBack="True"
                                                        DataTextField="Type" DataValueField="Type">
                                                    </asp:DropDownList></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <table style="width: 100%" cellspacing="0" cellpadding="0" border="0">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox Style="width: 125px" ID="tbxType" runat="server" SkinID="TextBoxSmallReadOnly"
            ...
            <tr>
                <td>
                    <asp:ObjectDataSource ID="odsComments" runat="server" FilterExpression="(Deleted = 0)"
                        SelectMethod="GetCommentsNew" TypeName="LiquiForce.LFSLive.WebUI.CWP.ManholeRehabilitation.mr_comments"
