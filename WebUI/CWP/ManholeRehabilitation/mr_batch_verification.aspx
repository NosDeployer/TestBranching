<%@ Page Title="LFS Live" Language="C#" AutoEventWireup="true" MasterPageFile="../../mWizard2.Master"
  CodeBehind="mr_batch_verification.aspx.cs"
  Inherits="LiquiForce.LFSLive.WebUI.CWP.ManholeRehabilitation.mr_batch_verification" %>
                    ...
                    <asp:Wizard ID="wizardBatch" runat="server" Width="440px" Height="340px" ActiveStepIndex="0"
                        ...
                        <WizardSteps>
                            ...
                            <asp:WizardStep ID="StepBegin" runat="server" Title="Begin" StepType="Start">
                                ...
                                <table cellpadding="0" cellspacing="0" width="0" style="width: 330px">
                                    <tr>
                                        <td colspan="2">
                                            <asp:RadioButton ID="rbtnUseLastBatch" runat="server" Checked="True" GroupName="Begin" SkinID="RadioButton" Text="Use last batch date" OnCheckedChanged="StartBatch_OnCheckedChanged" AutoPostBack="true"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:30px">
                                        ...
                                        <td style="width:300px">
                                            <asp:UpdatePanel ID="upnlExistLast" runat="server">
                                                <ContentTemplate>
                                                    <asp:Label ID="lblBatchIdWarning" runat="server" SkinID="LabelError" Text="There are no records, please register some batches" ></asp:Label>
                                                    <asp:Label ID="lblBatchLast" runat="server" SkinID="Label"></asp:Label>
                                                </ContentTemplate>                                            
                                            </asp:UpdatePanel>     
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <asp:RadioButton ID="rbtnUseNewBatch" runat="server" GroupName="Begin" SkinID="RadioButton" Text="Use a new batch date" OnCheckedChanged="StartBatch_OnCheckedChanged" AutoPostBack="true" />
                                        </td>
                                    </tr>
                                </table>
                            </asp:WizardStep>
                            
                            <asp:WizardStep ID="StepNewBatch" runat="server" Title="New Batch" StepType="Step">                                
