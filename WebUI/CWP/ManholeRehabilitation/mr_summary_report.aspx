<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="./../../mReport1.Master" CodeBehind="mr_summary_report.aspx.cs" Inherits="LiquiForce.LFSLive.WebUI.CWP.ManholeRehabilitation.mr_summary_report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function cbxSelectedClick(evt){
            ...
            if (src.id != "ctl00_ContentPlaceHolder1_cbxlMhId_0") {
    ...
    <div>
        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">            
            ...
            <tr>
                <td>
                    <asp:CheckBox ID="cbxMhId" runat="server" SkinID="CheckBox" Enabled="false" Text="MH ID" />
                </td>
            </tr>
            <tr>
                <td>
                    <asp:UpdatePanel ID="upnlMhId" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tbody>
                                    <tr>
                                        <td style="width: 156px">
                                            <asp:Panel ID="pnlMhId" Width="156px" Height="88px" runat="server" SkinID="Panel">
                                                <asp:CheckBoxList ID="cbxlMhId" runat="server" SkinID="CheckBoxListWithoutBorder" onclick="return cbxSelectedClick(event);">
                                                </asp:CheckBoxList>
                                            </asp:Panel>
                                        </td>
                                        <td style="vertical-align: middle">
                                            <asp:UpdateProgress ID="upMhId" runat="server" AssociatedUpdatePanelID="upnlProject">
                                                <ProgressTemplate>
                                                    <asp:Image ID="imAjaxMhId" runat="server" SkinID="Ajax_Grey"></asp:Image>
                                                </ProgressTemplate>
                                            </asp:UpdateProgress>
                                        </td>
                                    </tr>
