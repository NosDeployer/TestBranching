...
CodeBehind="pr_overview_report.aspx.cs" Inherits="LiquiForce.LFSLive.WebUI.CWP.PointRepairs.pr_overview_report" Title="LFS Live" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
            ...
            <tr>
                <td>
                    <asp:Label ID="lblRepairType" runat="server" SkinID="Label" Text="Repair Type"></asp:Label></td>
            </tr>
            <tr>
                <td>
                    <asp:DropDownList ID="ddlPrType" runat="server"
                        ...
                        <asp:ListItem Text="Robotic Reaming" Value="Robotic Reaming"></asp:ListItem>
                        <asp:ListItem Text="Point Lining" Value="Point Lining"></asp:ListItem>
                        <asp:ListItem Text="Grouting" Value="Grouting"></asp:ListItem>
                    </asp:DropDownList></td>
            </tr>
            <tr>
                <td style="height: 7px">
