<%@ Page language="c#" Codebehind="print_for_jltobuild.aspx.cs" AutoEventWireup="True" Inherits="LiquiForce.LFSLive.WebUI.CWP.print_for_jltobuild" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD runat="server">
		<title>print_for_jltobuild</title>
								...
								<td>
									<DIV style="WIDTH: 100%; POSITION: relative; HEIGHT: 171px"><asp:button id="btnPreview" style="Z-INDEX: 102; LEFT: 0px; POSITION: absolute; TOP: 88px" tabIndex="2"
										...
										<asp:button id="btnExport" style="Z-INDEX: 103; LEFT: 88px; POSITION: absolute; TOP: 88px" tabIndex="3"
											runat="server" CssClass="tButtonOkCancel" Width="80px" Height="22px" Text="Export" onclick="btnExport_Click"></asp:button>
										<asp:CheckBox id="cbxAutoFillLinerOrdered" style="Z-INDEX: 104; LEFT: 8px; POSITION: absolute; TOP: 16px"
											runat="server" CssClass="tLabel" Text="Autofill Liner Ordered?"></asp:CheckBox></DIV>
								</td>
							</tr>
						</table>
					</td>
