<%@ Page Language="C#" MasterPageFile="./../../mDialog2.master" AutoEventWireup="true"
    Codebehind="ra_comments.aspx.cs" Inherits="LiquiForce.LFSLive.WebUI.CWP.RehabAssessment.ra_comments"
    Title="LFS Live" %>
                    ...
                    <asp:UpdatePanel id="upnlComments" runat="server">
                        <contenttemplate>
                            <asp:GridView ID="grdComments" runat="server" SkinID="GridViewInTabs" Width="725px"
                                DataSourceID="odsComments" AutoGenerateColumns="False" PageSize="5" ShowFooter="True"
                                AllowPaging="True" DataKeyNames="WorkID, RefID" OnRowDataBound="grdComments_RowDataBound"
                                OnDataBound="grdComments_DataBound" OnRowCommand="grdComments_RowCommand" OnRowDeleting="grdComments_RowDeleting"
                                OnRowUpdating="grdComments_RowUpdating" OnRowEditing="grdComments_RowEditing">
                                <Columns>
                                    ...
                                    <asp:TemplateField SortExpression="WorkType" Visible="False" HeaderText="WorkType">
                                        <EditItemTemplate>
                                        ...
                                        <EditItemTemplate>
                                            ...
                                            <table style="width: 100%" cellspacing="0" cellpadding="0" border="0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="lblSubjectEdit" runat="server" SkinID="Label" Text="Subject" EnableViewState="False"></asp:Label></td>
                                                        <td>
                                                        </td>
                                                        <td>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td colspan="3">
                                                            <asp:RequiredFieldValidator ID="rfvSubjectEdit" runat="server" SkinID="Validator"
                                                                ...
                                                                ErrorMessage="Please provide a subject" ValidationGroup="commentsDataEdit"></asp:RequiredFieldValidator>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="height: 7px">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:TextBox Style="width: 125px" ID="tbxDateEdit" runat="server" SkinID="TextBoxReadOnly"
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlTypeEdit" runat="server" SkinID="DropDownListLookup" Width="125px"
                                                                DataSourceID="odsCommentType" ValidationGroup="commentsDataEdit" DataValueField="Type"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td >
                                                            <asp:DropDownList ID="ddlTypeNew" runat="server" SkinID="DropDownListLookup" Width="125px"
                                                                DataSourceID="odsCommentType" ValidationGroup="commentsDataAdd" DataValueField="Type"
                                                                DataTextField="Type" AutoPostBack="True">
                                                            </asp:DropDownList></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:RequiredFieldValidator ID="rfvSubjectNew" runat="server" SkinID="Validator"
                                                                ...
                                                                ValidationGroup="commentsDataAdd"></asp:RequiredFieldValidator>
                                                        </td>
                                                        <td colspan="1">
                                                        </td>
                                                    </tr>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <table style="width: 100%" cellspacing="0" cellpadding="0" border="0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:TextBox Style="width: 125px" ID="tbxDate" runat="server" SkinID="TextBoxReadOnly"
                                                                Text='<%# Eval("DateTime_") %>' ReadOnly="True"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:TextBox Style="width: 260px" ID="tbxCommentsEdit" runat="server" SkinID="TextBox"
                                                                Text='<%# Eval("Comment") %>' Rows="4" TextMode="MultiLine"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:RequiredFieldValidator ID="rfvCommentsEdit" runat="server" SkinID="Validator"
                                                                EnableViewState="False" ControlToValidate="tbxCommentsEdit" Display="Dynamic"
                                                                ErrorMessage="Please provide a comment" ValidationGroup="commentsDataEdit"></asp:RequiredFieldValidator>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="height: 10px">
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:RequiredFieldValidator ID="rfvCommentsNew" runat="server" SkinID="Validator"
                                                                EnableViewState="False" ControlToValidate="tbxCommentsNew" Display="Dynamic"
                                                                ErrorMessage="Please provide a comment" ValidationGroup="commentsDataAdd"></asp:RequiredFieldValidator>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="height: 12px">
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:TextBox Style="width: 260px" ID="tbxComments" runat="server" SkinID="TextBoxReadOnly"
                                                                Text='<%# Eval("Comment") %>' ReadOnly="True" Rows="4"
            ...
            <tr>
                <td>
                    <asp:ObjectDataSource ID="odsComments" runat="server" FilterExpression="(Deleted = 0)"
                        SelectMethod="GetCommentsNew" TypeName="LiquiForce.LFSLive.WebUI.CWP.RehabAssessment.ra_comments"
                        DeleteMethod="DummyCommentNew" InsertMethod="DummyCommentNew" UpdateMethod="DummyCommentNew">
                    </asp:ObjectDataSource>                    
                    <asp:ObjectDataSource ID="odsCommentType" runat="server" CacheDuration="120" EnableCaching="True"
                        ...
                        <SelectParameters>
                            <asp:Parameter DefaultValue="Rehab Assessment" Name="commentType" Type="String" />
