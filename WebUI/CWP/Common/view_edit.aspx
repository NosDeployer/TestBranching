<%@ Page Language="C#" MasterPageFile="./../../mWizard2.Master" AutoEventWireup="true"
    Codebehind="view_edit.aspx.cs" Inherits="LiquiForce.LFSLive.WebUI.CWP.Common.view_edit" Title="LFS Live" %>  
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div style="width: 600px">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <asp:RequiredFieldValidator ID="rfvName" runat="server" ControlToValidate="tbxName"
                                                ...
                                                SkinID="Validator" ValidationGroup="StepBegin"></asp:RequiredFieldValidator></td>
                                        <td>
                                            <asp:RequiredFieldValidator ID="rfvType" runat="server" ControlToValidate="ddlType"
                                                Display="Dynamic" EnableViewState="False" ErrorMessage="Please select a type"
                                                InitialValue="(Select a type)" SkinID="Validator" ValidationGroup="StepBegin"></asp:RequiredFieldValidator></td>
                                        <td>
                                        </td>
                                    </tr>
                                </table>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:ObjectDataSource ID="odsColumnsToDisplay" runat="server" SelectMethod="GetColumnsToDisplay"
                                                            TypeName="LiquiForce.LFSLive.WebUI.CWP.Common.view_edit"></asp:ObjectDataSource>
                                                    </td>
                                                </tr>
                                            </table>    
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            ...
                                            <asp:GridView ID="grdConditions" runat="server" SkinID="GridView" Width="590px"
                                                ...
                                                OnRowDataBound="grdConditions_RowDataBound" OnRowDeleting="grdConditions_RowDeleting" 
                                                OnRowEditing="grdConditions_RowEditing" OnRowUpdating="grdConditions_RowUpdating">
                                                <Columns>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td>
                    <asp:ObjectDataSource ID="odsConditionsNew" runat="server" SelectMethod="GetConditionsNew" TypeName="LiquiForce.LFSLive.WebUI.CWP.Common.view_edit" DeleteMethod="DummyConditionsNew" FilterExpression="(Deleted = 0)" UpdateMethod="DummyConditionsNew">
                        <DeleteParameters>
