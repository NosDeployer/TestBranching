...
namespace LiquiForce.LFSLive.WebUI.CWP.Common
{
    ...
    { 
        ...
        protected void cvValueDataUpdate_ServerValidate(object source, ServerValidateEventArgs args)
        {
            // Initialize 
            CustomValidator cvConditionsUpdate = (CustomValidator)source;
            args.IsValid = true;
            string type = "Date";
            int conditionId = int.Parse(((DropDownList)grdConditions.Rows[grdConditions.EditIndex].Cells[3].FindControl("ddlName")).SelectedValue);
            ...
            if (type == "Date")
            {
                ...
                {
                    args.IsValid = false;
                    cvConditionsUpdate.Text = "Invalid date (use mm/dd/yyyy, yyyy, %, or leave the field empty)";
                    cvConditionsUpdate.ErrorMessage = "Invalid date (use mm/dd/yyyy, yyyy, %, or leave the field empty)";
                    cvConditionsUpdate.IsValid = false;  
                }
                ...
                if (args.IsValid)
                {
                    ...
                    else
                    {
                        args.IsValid = false;
                        cvConditionsUpdate.IsValid = false;
                        cvConditionsUpdate.Text = "Invalid date (use a date over 1900)";
                        cvConditionsUpdate.ErrorMessage = "Invalid date (use a date over 1900)";                        
                    }
                }
            }
            ...
            if (type == "Int")
            {
                ...
                else
                {
                    args.IsValid = false;
                    cvConditionsUpdate.IsValid = false;
                    cvConditionsUpdate.ErrorMessage = "Invalid data (use an integer number, % or leave the field empty)";
                    cvConditionsUpdate.Text = "Invalid data (use an integer number, % or leave the field empty)";
                }
            }
            ...
            if (type == "Decimal")
            {
                ...
                else
                {
                    args.IsValid = false;
                    cvConditionsUpdate.IsValid = false;
                    cvConditionsUpdate.ErrorMessage = "Invalid data (use a decimal number, % or leave the field empty)";
                    cvConditionsUpdate.Text = "Invalid data (use a decimal number, % or leave the field empty)";
                }
            }
        }
