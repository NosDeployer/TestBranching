<%@ Page Language="C#"  Title="LFS Live" MasterPageFile="../../mWizard2.Master" AutoEventWireup="true" 
CodeBehind="supportTicket_add.aspx.cs" Inherits="LiquiForce.LFSLive.WebUI.ITTechSupportTicket.SupportTicket.supportTicket_add" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div style="width: 350px">
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
            <tr>
                <td>
                    <asp:Wizard ID="wzSupportTicket" runat="server" Width="450px" Height="450px" ActiveStepIndex="0"
                        ...
                        <WizardSteps>
                                ...
                                <table cellpadding="0" cellspacing="0" width="0" style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:300px">
                                            <asp:Label ID="lblCategoryId" runat="server" EnableViewState="False" SkinID="Label" 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Panel ID="pnlCategories" runat="server" Height="200px" SkinID="Panel" 
                                                Width="290px">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:CustomValidator ID="cvCategories" runat="server" Display="Dynamic" 
                                                ErrorMessage="You must select at least one category." 
                                                OnServerValidate="cvCategories_ServerValidate" SkinID="Validator" 
                                    ...
                                    <tr>
                                        <td>                                            
                                            <asp:TextBox ID="tbxAssignedToDanAnzovino" runat="server" 
                                                SkinID="TextBox" Style="width: 140px;" Text="Anzovino Dan"></asp:TextBox>
                                        </td>
                                    </tr>
                                   <%-- <tr>
                                        <td colspan="2">
                            ...
                            <asp:WizardStep ID="StepFinalStep" runat="server" Title="Final Step" StepType="Complete">
                                ...
                                <table cellpadding="0" cellspacing="0" width="0" style="width: 100%">
                                    <tr>
                                        <td>
                                            <asp:LinkButton ID="lkbtnOpenTicketSupport" runat="server" SkinID="LinkButton" EnableViewState="False">Open the support ticket you just created</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="height: 7px">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:LinkButton ID="lkbtnEditTicketSupport" runat="server" SkinID="LinkButton">Edit the support ticket you just created</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="height: 7px">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td>                    
                    ...
                    <asp:HiddenField ID="hdfCategoriesSelected" runat="server" />                    
                </td>
            </tr>
        </table>
    </div>
