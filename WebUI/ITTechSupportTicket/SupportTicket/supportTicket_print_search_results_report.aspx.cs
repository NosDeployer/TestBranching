...
{
    /// <summary>
    /// supportTicket_print_search_results_report
    /// </summary>
    public partial class supportTicket_print_search_results_report : System.Web.UI.Page
    {
        // ////////////////////////////////////////////////////////////////////////
        // EVENTS
        //
        ...
        private void Generate()
        {
            ...
            SupportTicketNavigatorTDS supportTicketNavigatorTDS = (SupportTicketNavigatorTDS)Session["supportTicketNavigatorTDS"];
            LiquiForce.LFSLive.BL.ITTechSupportTicket.SupportTicket.SupportTicketNavigator supportTicketNavigator = new LiquiForce.LFSLive.BL.ITTechSupportTicket.SupportTicket.SupportTicketNavigator(supportTicketNavigatorTDS);

            // ... Set properties to master page
            master.Data = supportTicketNavigator.Data;
            master.Table = supportTicketNavigator.TableName;

            if (supportTicketNavigator.Table.Rows.Count > 0)
            {
                if (master.Format == "pdf")
                {
                    master.Report = new LiquiForce.LFSLive.WebUI.ITTechSupportTicket.SupportTicket.SupportTicketPrintSearchResultsReport();
                ...
                {
                    master.Report = new LiquiForce.LFSLive.WebUI.ITTechSupportTicket.SupportTicket.SupportTicketPrintSearchResultsReportExport();
