<%@ Page Language="C#"  Title="LFS Live" MasterPageFile="../../mForm7.Master" AutoEventWireup="true" CodeBehind="toDoList_navigator2.aspx.cs" Inherits="LiquiForce.LFSLive.WebUI.FleetManagement.ToDoList.toDoList_navigator2" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td style="width: 625px">
                    <asp:CustomValidator ID="cvSelection" runat="server" ErrorMessage="Please select a to do."
            ...
            <tr>
                <td style="vertical-align: top">
                    ...
                    <asp:GridView ID="grdToDoListNavigator" runat="server" AutoGenerateColumns="False" DataKeyNames="ToDoID"
                        SkinID="GridView">
                        <Columns>
                            ...
                            <%--Column 1--%>
                            <asp:TemplateField HeaderText="ToDoID" Visible="False">
                                <ItemTemplate>
                                    <asp:Label ID="lblToDoID" runat="server" Style="width: 100px" Text='<%# Bind("ToDoID") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>                            
                            ...
                            <asp:TemplateField HeaderText="Unit">
                                <ItemTemplate>
                                    <asp:Label ID="lblUnit" runat="server" Style="width: 80px" Text='<%# Bind("UnitCode") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
