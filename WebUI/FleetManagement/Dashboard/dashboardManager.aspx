<%@ Page Language="C#" MasterPageFile="./../../mForm4.Master" AutoEventWireup="true" CodeBehind="dashboardManager.aspx.cs" 
Inherits="LiquiForce.LFSLive.WebUI.FleetManagement.Dashboard.dashboardManager" Title="LFS Live" %>
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="width: 844px">
            <tr>
                ...
                <%--<td style="width: 250px; vertical-align: top;">
                    <asp:WebPartZone ID="wpzAlarms"  runat="server" Width="240px" SkinID="Dashboard" >
                        <ZoneTemplate>
                            <uc1:wucAlarms id="wucAlarms" title="Alarms In Units Checklist" runat="server" >
                            </uc1:wucAlarms>
                        </ZoneTemplate>
                    </asp:WebPartZone>
                </td>--%>
                ...
                <td style="width: 250px; vertical-align: top;">
                    <asp:WebPartZone ID="wpzSRUnassigned"  runat="server" SkinID="Dashboard" Width="240px">
                        <ZoneTemplate>
                            <uc3:wucSRUnassigned id="wucSRUnassigned" title="Unassigned SR" runat="server">
                            </uc3:wucSRUnassigned>
                        </ZoneTemplate>
                    </asp:WebPartZone>
                </td>                
