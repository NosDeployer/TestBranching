<%@ Page Language="C#" MasterPageFile="./../../mWizard2.Master" AutoEventWireup="true" CodeBehind="categories_edit.aspx.cs" Inherits="LiquiForce.LFSLive.WebUI.FleetManagement.Categories.categories_edit" Title="LFS Live" %>
                ...
                <td>
                    <asp:Wizard ID="wzCategoriesAdd" runat="server" Width="550px" Height="390px" ActiveStepIndex="0" DisplayCancelButton="True" DisplaySideBar="False" SkinID="Wizard" 
                        ...
                        <WizardSteps>
                             ...
                             <asp:WizardStep ID="StepType" runat="server" Title="Type">
                            ...
                            <asp:WizardStep ID="StepWarning" runat="server" Title="Warning">
                                <table cellpadding="0" cellspacing="0" width="0" style="width: 100%">                                    
                                    ...
                                    <tr>
                                        <td style="width: 100%">
                                            <asp:Label ID="lblWarning" runat="server" SkinID="Label" Text="If you are sure about deleting you can reassign this items to another category in the next step">
                                            </asp:Label>
                                        </td>
                                    </tr>
                                </table>
