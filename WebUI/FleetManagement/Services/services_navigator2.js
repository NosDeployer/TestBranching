...
function tkrpbLeftMenuItemClick(sender, eventArgs) {
    ...
    switch (item) {
        case "mAddServiceRequest":
            window.open("./../Services/services_add_request.aspx?source_page=services_navigator2.aspx&dashboard=False&unit_id=none", "_blank", "toolbar=no, location=no, directories=no, status=yes, menubar=no, scrollbars=yes, resizable=yes, copyhistory=no, width=525, height=650");
