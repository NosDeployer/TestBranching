<%@ Page Language="C#" MasterPageFile="./../../mForm7.Master" AutoEventWireup="true" CodeBehind="services_navigator.aspx.cs" Inherits="LiquiForce.LFSLive.WebUI.FleetManagement.Services.services_navigator" Title="LFS Live" %>
            ...
            <tr>
                <td>
                    <asp:ObjectDataSource ID="odsViewForDisplayList" runat="server" CacheDuration="120"
                        ...
                        EnableCaching="True" OldValuesParameterFormatString="original_{0}" SelectMethod="LoadAndAddItem"
                        TypeName="LiquiForce.LFSLive.BL.FleetManagement.Services.ServiceStateList">
                        <SelectParameters>
