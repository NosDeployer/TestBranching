...
{
    /// <summary>
    /// project_costing_sheets_delete
    /// </summary>
    public partial class project_costing_sheets_delete : System.Web.UI.Page
    {
        // ////////////////////////////////////////////////////////////////////////
        // FIELDS
        //
        ...
        protected void tkrmTop_ItemClick(object sender, RadMenuEventArgs e)
        {
            switch (e.Item.Value)
            {
                ...
                case "mCancel":
                    ...
                    if (Request.QueryString["source_page"] == "project_costing_sheets_navigator.aspx")
                    {
                        url = "./project_costing_sheets_navigator.aspx?source_page=project_costing_sheets_delete.aspx&costing_sheet_id=" + hdfCostingSheetId.Value + "&project_id=" + hdfProjectId.Value + "&active_tab=" + (string)ViewState["active_tab"] + GetNavigatorState() + "&origin=" + (string)ViewState["origin"] + "&update=" + (string)ViewState["update"] + "&data_changed=" + hdfDataChanged.Value + "&state=" + (string)ViewState["state"];
                    }
        ...
        private void RegisterClientScripts()
        {
            ...
            this.ClientScript.RegisterClientScriptInclude("clientSideCode", "./project_costing_sheets_delete.js");
        }
