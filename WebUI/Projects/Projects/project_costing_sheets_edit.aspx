<%@ Page Title="LFS Live" Language="C#" MasterPageFile="./../../mForm6.master" AutoEventWireup="true" CodeBehind="project_costing_sheets_edit.aspx.cs" Inherits="LiquiForce.LFSLive.WebUI.Projects.Projects.project_costing_sheets_edit" %>
    ...
    <div style="width: 750px">
        ...
        <div runat="server" id="dvSubcontractors" style="overflow-x: auto; overflow-y: hidden; width: 710px">
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblSubcontractors" runat="server" SkinID="Label" Text="Other/Category/Subcontractors Costs"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="height: 7px">
        ...
        <div runat="server" id="dvHotels" style="overflow-x: auto; overflow-y: hidden; width: 710px">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td style="height: 10px">
                    </td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblHotels" runat="server" SkinID="Label" Text="Other/Category/Hotels Costs"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="height: 7px">
                        ...
                        <asp:UpdatePanel ID="upnlHotels" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="grdHotels" runat="server" SkinID="GridView" Width="710px" AllowPaging="True"
                                    ShowFooter="true" AutoGenerateColumns="False" DataKeyNames="CostingSheetID,HotelID,RefID"
                                    DataSourceID="odsHotels" OnDataBound="grdHotels_DataBound" OnRowDataBound="grdHotels_RowDataBound"
                                    PageSize="10" OnRowUpdating="grdHotels_RowUpdating" OnRowDeleting="grdHotels_RowDeleting" OnRowEditing="grdHotels_RowEditing"
                                    OnRowCommand="grdHotels_RowCommand">
                                    <Columns>
                                        <%--0--%>
                                        <asp:TemplateField HeaderText="CostingSheetID" Visible="False">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="HotelID" Visible="False">
                                            ...
                                            <EditItemTemplate>
                                                <asp:Label ID="lblHotelIDEdit" runat="server" SkinID="Label" Text='<%# Eval("HotelID") %>'></asp:Label>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                            ...
                                            <EditItemTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox ID="tbxHotelEdit" Width="210px" runat="server" ReadOnly="true" SkinID="TextBoxReadOnly"
                                            ...
                                            <FooterTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownList Width="210px" ID="ddlHotelNew" runat="server" SkinID="DropDownListLookup"
                                                                    DataTextField="Name" DataMember="DefaultView" DataValueField="COMPANIES_ID"
                                                                    DataSourceID="odsHotelsList" EnableViewState="True">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                            ...
                                            <EditItemTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <telerik:RadDatePicker ID="tkrdpStartDateEdit" runat="server" Width="132px" SkinID="RadDatePicker"
                                                                    DbSelectedDate='<%# DataBinder.Eval(Container.DataItem, "StartDate") %>' Calendar-ShowRowHeaders="false"
                                                                    Calendar-DayNameFormat="Short">
                                                                </telerik:RadDatePicker>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:RequiredFieldValidator ID="rfvStartDateEdit" runat="server" ControlToValidate="tkrdpStartDateEdit" ValidationGroup="hotelsEdit"
                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator">
                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                <asp:CompareValidator ID="cvStartDateEdit" runat="server" Type="Date" ControlToValidate="tkrdpStartDateEdit" ValidationGroup="hotelsEdit" SkinID="Validator"
                                                                    Display="Dynamic" ControlToCompare="hdfFrom" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval.">
                                                                </asp:CompareValidator>
                                                            </td>
                                                        </tr>
                                            ...
                                            <FooterTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <telerik:RadDatePicker ID="tkrdpStartDateNew" runat="server" Width="132px" SkinID="RadDatePicker"
                                                                    DbSelectedDate='<%# DataBinder.Eval(Container.DataItem, "StartDate") %>' Calendar-ShowRowHeaders="false"
                                                                    Calendar-DayNameFormat="Short">
                                                                </telerik:RadDatePicker>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:RequiredFieldValidator ID="rfvStartDateNew" runat="server" ControlToValidate="tkrdpStartDateNew" ValidationGroup="hotelsNew"
                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator" >
                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                <asp:CompareValidator ID="cvStartDateNew" runat="server" Type="Date" ControlToValidate="tkrdpStartDateNew" ValidationGroup="hotelsNew" SkinID="Validator"
                                                                    Display="Dynamic" ControlToCompare="hdfFrom" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval.">
                                                                </asp:CompareValidator>
                                                            </td>
                                                        </tr>
                                            ...
                                            <EditItemTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:RequiredFieldValidator ID="rfvEndDateEdit" runat="server" ControlToValidate="tkrdpEndDateEdit" ValidationGroup="hotelsEdit"
                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator">
                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                <asp:CompareValidator ID="cvEndDateEdit" runat="server" Type="Date" ControlToValidate="tkrdpEndDateEdit" ValidationGroup="hotelsEdit" 
                                                                    Display="Dynamic" ControlToCompare="hdfTo" Operator="LessThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                </asp:CompareValidator>
                                                                <asp:CompareValidator ID="cvEndDate2Edit" runat="server" Type="Date" ControlToValidate="tkrdpEndDateEdit" ValidationGroup="hotelsEdit" 
                                                                    Display="Dynamic" ControlToCompare="tkrdpStartDateEdit" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                </asp:CompareValidator>
                                                            </td>
                                                        </tr>
                                            ...
                                            <FooterTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:RequiredFieldValidator ID="rfvEndDateNew" runat="server" ControlToValidate="tkrdpEndDateNew" ValidationGroup="hotelsNew"
                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator">
                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                <asp:CompareValidator ID="cvEndDateNew" runat="server" Type="Date" ControlToValidate="tkrdpEndDateNew" ValidationGroup="hotelsNew" 
                                                                    Display="Dynamic" ControlToCompare="hdfTo" Operator="LessThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                </asp:CompareValidator>
                                                                <asp:CompareValidator ID="cvEndDate2New" runat="server" Type="Date" ControlToValidate="tkrdpEndDateNew" ValidationGroup="hotelsNew" 
                                                                    Display="Dynamic" ControlToCompare="tkrdpStartDateNew" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                </asp:CompareValidator>
                                                            </td>
                                                        </tr>
                                            ...
                                            <ItemTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td align="right">
                                                                <asp:Label ID="lblRate" Width="100px" runat="server" SkinID="Label" Text='<%# Eval("Rate", "{0:n2}") %>'></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            <EditItemTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td align="right">
                                                                <asp:TextBox ID="tbxRateEdit" Width="100px" runat="server" SkinID="TextBoxReadOnly"
                                                                    ReadOnly="true" Text='<%# Eval("Rate", "{0:n2}") %>'></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            <FooterTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td align="right">
                                                                <asp:TextBox ID="tbxRateNew" Width="100px" runat="server" SkinID="TextBoxReadOnly"
                                                                    ReadOnly="true"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                    ...
                    <td>
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                ...
                                <td style="width: 117px; text-align: right;">
                                    <asp:Label ID="lblHotelsTotalCosts" Width="117px" runat="server" SkinID="Label"
                                        Text="(USD) : "></asp:Label>
                                </td>
                                <td style="width: 105px; text-align: right;">
                ...
                <tr>
                    <td>
                        ...
                        <asp:ObjectDataSource ID="odsHotels" runat="server" FilterExpression="(Deleted = 0)"
                            ...
                            TypeName="LiquiForce.LFSLive.WebUI.Projects.Projects.project_costing_sheets_edit"
        ...
        <div runat="server" id="dvBondings" style="overflow-x: auto; overflow-y: hidden; width: 710px">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td style="height: 10px">
                    </td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblBondings" runat="server" SkinID="Label" Text="Other/Category/Bondings Costs"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="height: 7px">
                        ...
                        <asp:UpdatePanel ID="upnlBondings" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="grdBondings" runat="server" SkinID="GridView" Width="710px" AllowPaging="True"
                                    ShowFooter="true" AutoGenerateColumns="False" DataKeyNames="CostingSheetID,BondingCompanyID,RefID"
                                    DataSourceID="odsBondings" OnDataBound="grdBondings_DataBound" OnRowDataBound="grdBondings_RowDataBound"
                                    PageSize="10" OnRowUpdating="grdBondings_RowUpdating" OnRowDeleting="grdBondings_RowDeleting" OnRowEditing="grdBondings_RowEditing"
                                    OnRowCommand="grdBondings_RowCommand">
                                    <Columns>
                                        <%--0--%>
                                        <asp:TemplateField HeaderText="CostingSheetID" Visible="False">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="BondingCompanyID" Visible="False">
                                            <ItemTemplate>
                                                <asp:Label ID="lblBondingID" runat="server" SkinID="Label" Text='<%# Eval("BondingCompanyID") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:Label ID="lblBondingIDEdit" runat="server" SkinID="Label" Text='<%# Eval("BondingCompanyID") %>'></asp:Label>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                            ...
                                            <EditItemTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox ID="tbxBondingEdit" Width="210px" runat="server" ReadOnly="true" SkinID="TextBoxReadOnly"
                                                                    Text='<%# Eval("Bonding") %>'></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            <FooterTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownList Width="210px" ID="ddlBondingNew" runat="server" SkinID="DropDownListLookup"
                                                                    DataTextField="Name" DataMember="DefaultView" DataValueField="COMPANIES_ID"
                                                                    DataSourceID="odsBondingsList" EnableViewState="True">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                            ...
                                            <EditItemTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:RequiredFieldValidator ID="rfvStartDateEdit" runat="server" ControlToValidate="tkrdpStartDateEdit" ValidationGroup="bondingsEdit"
                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator">
                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                <asp:CompareValidator ID="cvStartDateEdit" runat="server" Type="Date" ControlToValidate="tkrdpStartDateEdit" ValidationGroup="bondingsEdit" SkinID="Validator"
                                                                    Display="Dynamic" ControlToCompare="hdfFrom" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval.">
                                                                </asp:CompareValidator>
                                                            </td>
                                                        </tr>
                                            ...
                                            <FooterTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:RequiredFieldValidator ID="rfvStartDateNew" runat="server" ControlToValidate="tkrdpStartDateNew" ValidationGroup="bondingsNew"
                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator" >
                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                <asp:CompareValidator ID="cvStartDateNew" runat="server" Type="Date" ControlToValidate="tkrdpStartDateNew" ValidationGroup="bondingsNew" SkinID="Validator"
                                                                    Display="Dynamic" ControlToCompare="hdfFrom" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval.">
                                                                </asp:CompareValidator>
                                                            </td>
                                                        </tr>
                                            ...
                                            <EditItemTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:RequiredFieldValidator ID="rfvEndDateEdit" runat="server" ControlToValidate="tkrdpEndDateEdit" ValidationGroup="bondingsEdit"
                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator">
                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                <asp:CompareValidator ID="cvEndDateEdit" runat="server" Type="Date" ControlToValidate="tkrdpEndDateEdit" ValidationGroup="bondingsEdit" 
                                                                    Display="Dynamic" ControlToCompare="hdfTo" Operator="LessThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                </asp:CompareValidator>
                                                                <asp:CompareValidator ID="cvEndDate2Edit" runat="server" Type="Date" ControlToValidate="tkrdpEndDateEdit" ValidationGroup="bondingsEdit" 
                                                                    Display="Dynamic" ControlToCompare="tkrdpStartDateEdit" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                </asp:CompareValidator>
                                                            </td>
                                                        </tr>
                                            ...
                                            <FooterTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:RequiredFieldValidator ID="rfvEndDateNew" runat="server" ControlToValidate="tkrdpEndDateNew" ValidationGroup="bondingsNew"
                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator">
                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                <asp:CompareValidator ID="cvEndDateNew" runat="server" Type="Date" ControlToValidate="tkrdpEndDateNew" ValidationGroup="bondingsNew" 
                                                                    Display="Dynamic" ControlToCompare="hdfTo" Operator="LessThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                </asp:CompareValidator>
                                                                <asp:CompareValidator ID="cvEndDate2New" runat="server" Type="Date" ControlToValidate="tkrdpEndDateNew" ValidationGroup="bondingsNew" 
                                                                    Display="Dynamic" ControlToCompare="tkrdpStartDateNew" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                </asp:CompareValidator>
                                                            </td>
                                                        </tr>
                    ...
                    <td>
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                ...
                                <td style="width: 117px; text-align: right;">
                                    <asp:Label ID="lblBondingsTotalCosts" Width="117px" runat="server" SkinID="Label"
                                        Text="(USD) : "></asp:Label>
                                </td>
                                <td style="width: 105px; text-align: right;">
        ...
        <div runat="server" id="dvInsurances" style="overflow-x: auto; overflow-y: hidden; width: 710px">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td style="height: 10px">
                    </td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblInsurances" runat="server" SkinID="Label" Text="Other/Category/Insurances Costs"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="height: 7px">
                        ...
                        <asp:UpdatePanel ID="upnlInsurances" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="grdInsurances" runat="server" SkinID="GridView" Width="710px" AllowPaging="True"
                                    ShowFooter="true" AutoGenerateColumns="False" DataKeyNames="CostingSheetID,InsuranceCompanyID,RefID"
                                    DataSourceID="odsInsurances" OnDataBound="grdInsurances_DataBound" OnRowDataBound="grdInsurances_RowDataBound"
                                    PageSize="10" OnRowUpdating="grdInsurances_RowUpdating" OnRowDeleting="grdInsurances_RowDeleting" OnRowEditing="grdInsurances_RowEditing"
                                    OnRowCommand="grdInsurances_RowCommand">
                                    <Columns>
                                        <%--0--%>
                                        <asp:TemplateField HeaderText="CostingSheetID" Visible="False">
                                            <ItemTemplate>
                                            ...
                                            <EditItemTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox ID="tbxInsuranceEdit" Width="210px" runat="server" ReadOnly="true" SkinID="TextBoxReadOnly"
                                            ...
                                            <FooterTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownList Width="210px" ID="ddlInsuranceNew" runat="server" SkinID="DropDownListLookup"
                                                                    DataTextField="Name" DataMember="DefaultView" DataValueField="COMPANIES_ID"
                                                                    DataSourceID="odsInsurancesList" EnableViewState="True">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                            ...
                                            <EditItemTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:RequiredFieldValidator ID="rfvStartDateEdit" runat="server" ControlToValidate="tkrdpStartDateEdit" ValidationGroup="insurancesEdit"
                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator">
                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                <asp:CompareValidator ID="cvStartDateEdit" runat="server" Type="Date" ControlToValidate="tkrdpStartDateEdit" ValidationGroup="insurancesEdit" SkinID="Validator"
                                                                    Display="Dynamic" ControlToCompare="hdfFrom" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval.">
                                                                </asp:CompareValidator>
                                                            </td>
                                                        </tr>
                                            ...
                                            <FooterTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:RequiredFieldValidator ID="rfvStartDateNew" runat="server" ControlToValidate="tkrdpStartDateNew" ValidationGroup="insurancesNew"
                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator" >
                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                <asp:CompareValidator ID="cvStartDateNew" runat="server" Type="Date" ControlToValidate="tkrdpStartDateNew" ValidationGroup="insurancesNew" SkinID="Validator"
                                                                    Display="Dynamic" ControlToCompare="hdfFrom" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval.">
                                                                </asp:CompareValidator>
                                                            </td>
                                                        </tr>
                                            ...
                                            <EditItemTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:RequiredFieldValidator ID="rfvEndDateEdit" runat="server" ControlToValidate="tkrdpEndDateEdit" ValidationGroup="insurancesEdit"
                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator">
                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                <asp:CompareValidator ID="cvEndDateEdit" runat="server" Type="Date" ControlToValidate="tkrdpEndDateEdit" ValidationGroup="insurancesEdit" 
                                                                    Display="Dynamic" ControlToCompare="hdfTo" Operator="LessThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                </asp:CompareValidator>
                                                                <asp:CompareValidator ID="cvEndDate2Edit" runat="server" Type="Date" ControlToValidate="tkrdpEndDateEdit" ValidationGroup="insurancesEdit" 
                                                                    Display="Dynamic" ControlToCompare="tkrdpStartDateEdit" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                </asp:CompareValidator>
                                                            </td>
                                                        </tr>
                                            ...
                                            <FooterTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:RequiredFieldValidator ID="rfvEndDateNew" runat="server" ControlToValidate="tkrdpEndDateNew" ValidationGroup="insurancesNew"
                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator">
                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                <asp:CompareValidator ID="cvEndDateNew" runat="server" Type="Date" ControlToValidate="tkrdpEndDateNew" ValidationGroup="insurancesNew" 
                                                                    Display="Dynamic" ControlToCompare="hdfTo" Operator="LessThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                </asp:CompareValidator>
                                                                <asp:CompareValidator ID="cvEndDate2New" runat="server" Type="Date" ControlToValidate="tkrdpEndDateNew" ValidationGroup="insurancesNew" 
                                                                    Display="Dynamic" ControlToCompare="tkrdpStartDateNew" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                </asp:CompareValidator>
                                                            </td>
                                                        </tr>
                    ...
                    <td>
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                ...
                                <td style="width: 117px; text-align: right;">
                                    <asp:Label ID="lblInsurancesTotalCosts" Width="117px" runat="server" SkinID="Label"
                                        Text="(USD) : "></asp:Label>
                                </td>
                                <td style="width: 105px; text-align: right;">
        ...
        <!-- Page element: 1 column - grid OtherCategory-->
        <div runat="server" id="dvOtherCategory" style="overflow-x: auto; overflow-y: hidden; width: 710px">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td style="height: 10px">
                    </td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblOtherCategory" runat="server" SkinID="Label" Text="Other/Category/Other Category Costs"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="height: 7px">
                        ...
                        <asp:UpdatePanel ID="upnlOtherCategory" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="grdOtherCategory" runat="server" SkinID="GridView" Width="710px" AllowPaging="True"
                                    ShowFooter="true" AutoGenerateColumns="False" DataKeyNames="CostingSheetID,Category,RefID"
                                    DataSourceID="odsOtherCategory" OnDataBound="grdOtherCategory_DataBound" OnRowDataBound="grdOtherCategory_RowDataBound"
                                    PageSize="10" OnRowUpdating="grdOtherCategory_RowUpdating" OnRowDeleting="grdOtherCategory_RowDeleting" OnRowEditing="grdOtherCategory_RowEditing"
                                    OnRowCommand="grdOtherCategory_RowCommand">
                                    <Columns>
                                        <%--0--%>
                                        <asp:TemplateField HeaderText="CostingSheetID" Visible="False">
                                            <ItemTemplate>
                                            ...
                                            <ItemTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lblCategory" Width="210px" runat="server" SkinID="Label" Text='<%# Eval("Category") %>'></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            <EditItemTemplate>
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox ID="tbxCategoryEdit" Width="210px" runat="server" ReadOnly="true" SkinID="TextBoxReadOnly"
                    ...
                    <td>
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                ...
                                <td style="width: 117px; text-align: right;">
                                    <asp:Label ID="lblOtherCategoryTotalCosts" Width="117px" runat="server" SkinID="Label"
                                        Text="(USD) : "></asp:Label>
                                </td>
                                <td style="width: 105px; text-align: right;">
                    ...
                    <asp:UpdatePanel ID="upnlTotalCostCad" runat="server">
                        <ContentTemplate>
                            <asp:TextBox ID="tbxTotalCostCad" runat="server" SkinID="TextBoxRightReadOnly"
                                Width="115px" ReadOnly="True" CssClass="Background_ViewGrid_TotalFooter">
                            </asp:TextBox>
                        </ContentTemplate>
                    </asp:UpdatePanel>
