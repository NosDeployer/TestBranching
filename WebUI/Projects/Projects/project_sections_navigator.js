...
function OpenTools(s)
{
    ...
    {
        case "AddSections":
            window.open("./../../CWP/Common/project_add_sections.aspx?source_page=project_sections_navigator.aspx&project_id="+ hdfProjectId.value+"&client_id=" + hdfClientId.value + "&work_type=All", "_blank", "toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=830, height=715");
		    break;
		    
		case "BulkUpload":
		    window.open("./../../CWP/Common/bulk_upload.aspx?source_page=lm&project_id="+ hdfProjectId.value+"&client_id=" + hdfClientId.value, "_blank", "toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=590, height=540");
		    break;
