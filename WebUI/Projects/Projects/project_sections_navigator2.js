...
function OpenTools(s)
{
    ...
    switch (s.value)
    {
		...
		case "BulkUpload":
		    window.open("./../../CWP/Common/bulk_upload.aspx?source_page=lm&project_id="+ hdfProjectId.value+"&client_id=" + hdfClientId.value, "_blank", "toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=610, height=500");
		    break;
