<%@ Page Title="LFS Live" Language="C#" MasterPageFile="~/mForm6.master" AutoEventWireup="true" CodeBehind="project_combined_costing_sheets_summary.aspx.cs" Inherits="LiquiForce.LFSLive.WebUI.Projects.Projects.project_combined_costing_sheets_summary" %>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td style="width: 160px; text-align: right;">
                                    <asp:Label ID="lblRevenueTotal" Width="160px" runat="server" SkinID="Label" Text="Total Revenue : "></asp:Label>
                                </td>
                                <td style="width: 110px; text-align: right;">
            ...
            <tr>
                <td>
                    <asp:ObjectDataSource ID="odsTeamMembers" runat="server" FilterExpression="(Deleted = 0)"
                        ...
                        TypeName="LiquiForce.LFSLive.WebUI.Projects.Projects.project_combined_costing_sheets_summary">
