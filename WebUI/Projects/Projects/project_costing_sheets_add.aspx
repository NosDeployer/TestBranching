<%@ Page Title="LFS Live" Language="C#" MasterPageFile="./../../mWizard2.Master" AutoEventWireup="true" 
    CodeBehind="project_costing_sheets_add.aspx.cs" Inherits="LiquiForce.LFSLive.WebUI.Projects.Projects.project_costing_sheets_add" %>
                                        ...
                                        <td>
                                            <asp:Wizard ID="wzProjectCostinsSheetsAdd" runat="server" Width="910px" Height="450px"
                                                ...
                                                <WizardSteps>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:ObjectDataSource ID="odsCostingSheetTemplate" runat="server" FilterExpression="(Deleted = 0)"
                                                                        ...
                                                                        TypeName="LiquiForce.LFSLive.WebUI.Projects.Projects.project_costing_sheets_add"
                                                    ...
                                                    <asp:WizardStep ID="StepGeneralInformation" runat="server" Title="GeneralInformation">
                                                        <table cellpadding="0" cellspacing="0" width="0" style="width: 925px">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:CheckBox ID="cbxHotel" runat="server" SkinID="CheckBox" Text="Hotels" Checked="true">
                                                                    </asp:CheckBox>
                                                                </td>                                                               
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>                                                                
                                                                <td>
                                                                    <asp:CheckBox ID="cbxBonding" runat="server" SkinID="CheckBox" Text="Bonding" Checked="true">
                                                                    </asp:CheckBox>
                                                                </td>
                                                                <td>
                                                                    <asp:CheckBox ID="cbxInsurance" runat="server" SkinID="CheckBox" Text="Insurance" Checked="true">
                                                                    </asp:CheckBox>
                                                                </td>
                                                                <td>
                                                                    <asp:CheckBox ID="cbxOtherCategory" runat="server" SkinID="CheckBox" Text="Other Costs" Checked="true">
                                                                    </asp:CheckBox>
                                                                </td>
                                                                <td>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="0" style="width: 100%">
                                                        <td colspan="5">
                                                                <asp:Label ID="lblWhatDoYouWantToDo" EnableViewState="false" runat="server" SkinID="LabelTitle2" Text="What do you want to do?">
                                                                </asp:Label>
                                                            </td>
                                                        <tr>
                                                                        ...
                                                                        <asp:UpdatePanel ID="upnlSubcontractors" runat="server">
                                                                            <ContentTemplate>
                                                                                <asp:GridView ID="grdSubcontractors" runat="server" SkinID="GridView" Width="930px" AllowPaging="True"
                                                                                    ...
                                                                                    DataSourceID="odsSubcontractors" OnDataBound="grdSubcontractors_DataBound" OnPageIndexChanging="grdSubcontractors_PageIndexChanging"
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <telerik:RadDatePicker ID="tkrdpStartDateNew" runat="server" Width="135px" SkinID="RadDatePicker"
                                                                                                                    DbSelectedDate='<%# DataBinder.Eval(Container.DataItem, "StartDate") %>' Calendar-ShowRowHeaders="false"
                                                                                                                    Calendar-DayNameFormat="Short">
                                                                                                                </telerik:RadDatePicker>
                                                                                                            </td>
                                                                                            ...
                                                                                            <ItemTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblSubcontractor" Width="130px" runat="server" SkinID="Label" Text='<%# Eval("Subcontractor") %>'></asp:Label>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </tbody>
                                                                                                </table>
                                                                                            ...
                                                                                            <EditItemTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:TextBox ID="tbxSubcontractorEdit" Width="130px" runat="server" ReadOnly="true" SkinID="TextBoxReadOnly"
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:DropDownList Width="130px" ID="ddlSubcontractorNew" runat="server" SkinID="DropDownList" DataTextField="Name" DataMember="DefaultView" DataValueField="SubcontractorID"
                                                                                            ...
                                                                                            <ItemTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblUnitOfMeasurement" Width="120px" runat="server" SkinID="Label" Text='<%# Eval("UnitOfMeasurement") %>'></asp:Label>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </tbody>
                                                                                                </table>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:DropDownList ID="ddlUnitOfMeasurementSubcontractorsEdit" runat="server" DataSourceID="odsUnitsOfMeasurementSubcontractor"
                                                                                                                    DataTextField="Description" DataValueField="Description" EnableViewState="True"
                                                                                                                    SkinID="DropDownListLookup" Width="120px">
                                                                                                                </asp:DropDownList>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        <tr>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Quantity">
                                                                                            <ItemTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0">
                                                                                                    <tr>
                                                                                                        <td align="center">
                                                                                                            <asp:Label ID="lblQuantity" Width="80px" runat="server" Text='<%# Eval("Quantity", "{0:n2}") %>'
                                                                                                                SkinID="Label"></asp:Label>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            ...
                                                                                            <EditItemTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0">
                                                                                                    <tr>
                                                                                                        <td align="center">
                                                                                                            <asp:TextBox ID="tbxQuantityEdit" Width="80px" runat="server" Text='<%# Eval("Quantity", "{0:n2}") %>'
                                                                                                                SkinID="TextBox"></asp:TextBox>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0">
                                                                                                    <tr>
                                                                                                        <td align="center">
                                                                                                            <asp:TextBox ID="tbxQuantityNew" Width="80px" runat="server" SkinID="TextBox"></asp:TextBox>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                            ...
                                                                                            <ItemTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td align="right">
                                                                                                                <asp:Label ID="lblCostCAD" Width="100px" runat="server" SkinID="Label" Text='<%# Eval("CostCad", "{0:n2}") %>'></asp:Label>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </tbody>
                                                                                                </table>
                                                                                            ...
                                                                                            <EditItemTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td align="right">
                                                                                                                <asp:TextBox ID="tbxCostCADEdit" Width="100px" runat="server" SkinID="TextBox" Text='<%# Eval("CostCad", "{0:n2}") %>'></asp:TextBox>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        <tr>
                                                                                                            <td>
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td align="right">
                                                                                                                <asp:TextBox ID="tbxCostCADNew" Width="100px" runat="server" SkinID="TextBox" Text='<%# Eval("CostCad", "{0:n2}") %>'></asp:TextBox>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        <tr>
                                                                                                            <td>
                                                                                            ...
                                                                                            <ItemTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td align="right">
                                                                                                                <asp:Label ID="lblCostUSD" Width="100px" runat="server" SkinID="Label" Text='<%# Eval("CostUsd", "{0:n2}") %>'></asp:Label>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </tbody>
                                                                                                </table>
                                                                                            ...
                                                                                            <EditItemTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td align="right">
                                                                                                                <asp:TextBox ID="tbxCostUSDEdit" Width="100px" runat="server" SkinID="TextBox" Text='<%# Eval("CostUsd", "{0:n2}") %>'></asp:TextBox>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        <tr>
                                                                                                            <td>
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td align="right">
                                                                                                                <asp:TextBox ID="tbxCostUSDNew" Width="100px" runat="server" SkinID="TextBox"></asp:TextBox>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        <tr>
                                                                                                            <td>
                                                                                            ...
                                                                                            <ItemTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td align="right">
                                                                                                                <asp:Label ID="lblTotalCostUSD" Width="140px" runat="server" SkinID="Label" Text='<%# Eval("TotalCostUsd", "{0:n2}") %>'></asp:Label>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </tbody>
                                                                                                </table>
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td align="right">
                                                                                                                <asp:TextBox ID="tbxTotalCostUSDNew" Width="140px" runat="server" ReadOnly="true"
                                                                                                                    SkinID="TextBoxReadOnly"></asp:TextBox>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </tbody>
                                                                                            ...
                                                                                            <ItemTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblComment" Width="120px" runat="server" SkinID="Label" Text='<%# Eval("Comment") %>'></asp:Label>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </tbody>
                                                                                                </table>
                                                                                            ...
                                                                                            <EditItemTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:TextBox ID="tbxCommentEdit" Width="120px" runat="server" SkinID="TextBox"
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:TextBox ID="tbxCommentNew" Width="120px" runat="server" SkinID="TextBox"
                                                                                                                    Text='<%# Eval("Comment") %>'></asp:TextBox>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </tbody>
                                                    ...
                                                    <asp:WizardStep ID="StepHotelInformation" runat="server" Title="HotelInformation">
                                                        <div runat="server" id="dvHotelCostsByClientProject" style="overflow-x: auto; overflow-y: hidden; width: 930px">                                                            
                                                            <!-- Page element: 1 column -->
                                                            <table cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="lblHotelCosts" runat="server" SkinID="Label" Text="Other/Category/Hotel Costs"></asp:Label>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="height: 7px">
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 780px">
                                                            <tr>
                                                                <td>
                                                                    <asp:Panel ID="pnlHotelCostsByClientProject" runat="server" Width="420px">
                                                                        <asp:UpdatePanel ID="upnlHotelCostsByClientProject" runat="server">
                                                                            <ContentTemplate>
                                                                                <!-- Page element: 1 column - Grid Project Time -->
                                                                                <asp:GridView ID="grdHotels" runat="server" SkinID="GridView" Width="420px"
                                                                                    AutoGenerateColumns="False" AllowPaging="True" PageSize="10" ShowFooter="True"
                                                                                    OnDataBound="grdHotels_DataBound" OnRowCommand="grdHotels_RowCommand"
                                                                                    OnRowUpdating="grdHotels_RowUpdating" OnRowEditing="grdHotels_RowEditing"
                                                                                    OnRowDeleting="grdHotels_RowDeleting"  DataKeyNames="CostingSheetID,HotelID,RefID" DataSourceID="odsHotels">
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="HotelID" Visible="False">
                                                                                            ...
                                                                                            <EditItemTemplate>
                                                                                                <asp:Label ID="lblHotelIDEfit" runat="server" SkinID="Label" Text='<%# Eval("HotelID") %>'></asp:Label>
                                                                                            </EditItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                            ...
                                                                                            <EditItemTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:RequiredFieldValidator ID="rfvStartDateEdit" runat="server" ControlToValidate="tkrdpStartDateEdit" ValidationGroup="hotelEdit"
                                                                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator">
                                                                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                                                                <asp:CompareValidator ID="cvStartDateEdit" runat="server" Type="Date" ControlToValidate="tkrdpStartDateEdit" ValidationGroup="hotelEdit" SkinID="Validator"
                                                                                                                    Display="Dynamic" ControlToCompare="hdfFrom" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval.">
                                                                                                                </asp:CompareValidator>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:RequiredFieldValidator ID="rfvStartDateNew" runat="server" ControlToValidate="tkrdpStartDateNew" ValidationGroup="hotelNew"
                                                                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator" >
                                                                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                                                                <asp:CompareValidator ID="cvStartDateNew" runat="server" Type="Date" ControlToValidate="tkrdpStartDateNew" ValidationGroup="hotelNew" SkinID="Validator"
                                                                                                                    Display="Dynamic" ControlToCompare="hdfFrom" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval.">
                                                                                                                </asp:CompareValidator>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                            ...
                                                                                            <EditItemTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:RequiredFieldValidator ID="rfvEndDateEdit" runat="server" ControlToValidate="tkrdpEndDateEdit" ValidationGroup="hotelEdit"
                                                                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator">
                                                                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                                                                <asp:CompareValidator ID="cvEndDateEdit" runat="server" Type="Date" ControlToValidate="tkrdpEndDateEdit" ValidationGroup="hotelEdit" 
                                                                                                                    Display="Dynamic" ControlToCompare="hdfTo" Operator="LessThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                                                                </asp:CompareValidator>
                                                                                                                <asp:CompareValidator ID="cvEndDate2Edit" runat="server" Type="Date" ControlToValidate="tkrdpEndDateEdit" ValidationGroup="hotelEdit" 
                                                                                                                    Display="Dynamic" ControlToCompare="tkrdpStartDateEdit" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                                                                </asp:CompareValidator>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:RequiredFieldValidator ID="rfvEndDateNew" runat="server" ControlToValidate="tkrdpEndDateNew" ValidationGroup="hotelNew"
                                                                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator">
                                                                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                                                                <asp:CompareValidator ID="cvEndDateNew" runat="server" Type="Date" ControlToValidate="tkrdpEndDateNew" ValidationGroup="hotelNew" 
                                                                                                                    Display="Dynamic" ControlToCompare="hdfTo" Operator="LessThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                                                                </asp:CompareValidator>
                                                                                                                <asp:CompareValidator ID="cvEndDate2New" runat="server" Type="Date" ControlToValidate="tkrdpEndDateNew" ValidationGroup="hotelNew" 
                                                                                                                    Display="Dynamic" ControlToCompare="tkrdpStartDateNew" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                                                                </asp:CompareValidator>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Hotel">
                                                                                            <EditItemTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:TextBox ID="tbxHotelEdit" Width="220px" runat="server" ReadOnly="true" SkinID="TextBoxReadOnly"
                                                                                                                    Text='<%# Eval("Hotel") %>'></asp:TextBox>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:DropDownList ID="ddlHotelNew" runat="server" SkinID="DropDownListLookup"
                                                                                                                Width="220px" DataSourceID="odsHotelsList" TabIndex="2"
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:RequiredFieldValidator ID="rfvHotelNew" runat="server" ControlToValidate="ddlHotelNew"
                                                                                                                Display="Dynamic" ErrorMessage="Please select a Hotel." InitialValue="-1"
                                                                                                                SkinID="Validator" ValidationGroup="hotelNew" EnableViewState="False">
                                                                                                            </asp:RequiredFieldValidator>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                            ...
                                                                                            <ItemTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:Label ID="lblHotel" runat="server" Text='<%# Eval("Hotel") %>' SkinID="Label"></asp:Label>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </ItemTemplate>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Rate">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:CompareValidator ID="cvRateEdit" runat="server" Operator="DataTypeCheck"
                                                                                                                Type="Currency" ControlToValidate="tbxRateEdit" ValidationGroup="hotelEdit"
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:TextBox ID="tbxRateNew" runat="server" SkinID="TextBoxRight" Text="0.00" Width="60px"></asp:TextBox>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:CompareValidator ID="cvRateNew" runat="server" Operator="DataTypeCheck"
                                                                                                                Type="Currency" ControlToValidate="tbxRateNew" ValidationGroup="hotelNew"
                                                                                                                SkinID="Validator" Display="Dynamic" ErrorMessage="Invalid data. (use #.## format)">
                                                                                                            </asp:CompareValidator>
                                                                                                        </td>
                                                                                                    </tr>
                                                                ...
                                                                <td>
                                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 110px; text-align: right;">
                                                                                <asp:Label ID="lblHotelsTotalCosts" Width="110px" runat="server" SkinID="Label"
                                                                                    Text="(USD) : "></asp:Label>
                                                                            </td>
                                                                                ...
                                                                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                                    <ContentTemplate>
                                                                                        <asp:TextBox ID="tbxHotelsTotalCostsCAD" runat="server" SkinID="TextBoxRightReadOnly"
                                                                                            Width="70px" ReadOnly="True" CssClass="Background_ViewGrid_TotalFooter"></asp:TextBox>
                                                                                    </ContentTemplate>
                                                                                </asp:UpdatePanel>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <asp:ObjectDataSource ID="odsHotels" runat="server" FilterExpression="(Deleted = 0)"
                                                                        ...
                                                                        TypeName="LiquiForce.LFSLive.WebUI.Projects.Projects.project_costing_sheets_add"
                                                                        DeleteMethod="DummyHotelsNew" InsertMethod="DummyHotelsNew" UpdateMethod="DummyHotelsNew">
                                                                    </asp:ObjectDataSource>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <asp:WizardStep ID="StepBondingInformation" runat="server" Title="BondingInformation">
                                                        <div runat="server" id="dvBondingCompaniesCostsByClientProject" style="overflow-x: auto; overflow-y: hidden; width: 930px">                                                                                                                        
                                                            <!-- Page element: 1 column -->                                                            
                                                            <table cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="lblBondingCompaniesCosts" runat="server" SkinID="Label" Text="Other/Category/Bonding Companies Costs"></asp:Label>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="height: 7px">
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" style="width: 780px">
                                                                <tr>
                                                                    <td>
                                                                        <asp:Panel ID="pnlBondingCompaniesCostsByClientProject" runat="server" Width="420px">
                                                                            <asp:UpdatePanel ID="upnlBondingCompaniesCostsByClientProject" runat="server">
                                                                                <ContentTemplate>
                                                                                    <!-- Page element: 1 column - Grid Project Time -->
                                                                                    <asp:GridView ID="grdBondings" runat="server" SkinID="GridView" Width="420px"
                                                                                        AutoGenerateColumns="False" AllowPaging="True" PageSize="10" ShowFooter="True"
                                                                                        OnDataBound="grdBondings_DataBound" OnRowCommand="grdBondings_RowCommand"
                                                                                        OnRowUpdating="grdBondings_RowUpdating" OnRowEditing="grdBondings_RowEditing"
                                                                                        OnRowDeleting="grdBondings_RowDeleting" 
                                                                                        DataKeyNames="CostingSheetID,BondingCompanyID,RefID" DataSourceID="odsBondings">
                                                                                        <Columns>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="BondingCompanyID" Visible="False">
                                                                                            <ItemTemplate>
                                                                                                <asp:Label ID="BondingCompanyID" runat="server" SkinID="Label" Text='<%# Eval("BondingCompanyID") %>'></asp:Label>
                                                                                            </ItemTemplate>
                                                                                            <EditItemTemplate>
                                                                                                <asp:Label ID="BondingCompanyID" runat="server" SkinID="Label" Text='<%# Eval("BondingCompanyID") %>'></asp:Label>
                                                                                            </EditItemTemplate>
                                                                                            ...
                                                                                            <EditItemTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:RequiredFieldValidator ID="rfvStartDateEdit" runat="server" ControlToValidate="tkrdpStartDateEdit" ValidationGroup="bondingEdit"
                                                                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator">
                                                                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                                                                <asp:CompareValidator ID="cvStartDateEdit" runat="server" Type="Date" ControlToValidate="tkrdpStartDateEdit" ValidationGroup="bondingEdit" SkinID="Validator"
                                                                                                                    Display="Dynamic" ControlToCompare="hdfFrom" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval.">
                                                                                                                </asp:CompareValidator>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:RequiredFieldValidator ID="rfvStartDateNew" runat="server" ControlToValidate="tkrdpStartDateNew" ValidationGroup="bondingNew"
                                                                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator" >
                                                                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                                                                <asp:CompareValidator ID="cvStartDateNew" runat="server" Type="Date" ControlToValidate="tkrdpStartDateNew" ValidationGroup="bondingNew" SkinID="Validator"
                                                                                                                    Display="Dynamic" ControlToCompare="hdfFrom" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval.">
                                                                                                                </asp:CompareValidator>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                            ...
                                                                                            <EditItemTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:RequiredFieldValidator ID="rfvEndDateEdit" runat="server" ControlToValidate="tkrdpEndDateEdit" ValidationGroup="bondingEdit"
                                                                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator">
                                                                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                                                                <asp:CompareValidator ID="cvEndDateEdit" runat="server" Type="Date" ControlToValidate="tkrdpEndDateEdit" ValidationGroup="bondingEdit" 
                                                                                                                    Display="Dynamic" ControlToCompare="hdfTo" Operator="LessThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                                                                </asp:CompareValidator>
                                                                                                                <asp:CompareValidator ID="cvEndDate2Edit" runat="server" Type="Date" ControlToValidate="tkrdpEndDateEdit" ValidationGroup="bondingEdit" 
                                                                                                                    Display="Dynamic" ControlToCompare="tkrdpStartDateEdit" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                                                                </asp:CompareValidator>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:RequiredFieldValidator ID="rfvEndDateNew" runat="server" ControlToValidate="tkrdpEndDateNew" ValidationGroup="bondingNew"
                                                                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator">
                                                                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                                                                <asp:CompareValidator ID="cvEndDateNew" runat="server" Type="Date" ControlToValidate="tkrdpEndDateNew" ValidationGroup="bondingNew" 
                                                                                                                    Display="Dynamic" ControlToCompare="hdfTo" Operator="LessThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                                                                </asp:CompareValidator>
                                                                                                                <asp:CompareValidator ID="cvEndDate2New" runat="server" Type="Date" ControlToValidate="tkrdpEndDateNew" ValidationGroup="bondingNew" 
                                                                                                                    Display="Dynamic" ControlToCompare="tkrdpStartDateNew" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                                                                </asp:CompareValidator>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Company">
                                                                                            <EditItemTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:TextBox ID="tbxBondingEdit" Width="220px" runat="server" ReadOnly="true" SkinID="TextBoxReadOnly" Text='<%# Eval("Bonding") %>'></asp:TextBox>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:DropDownList ID="ddlBondingNew" runat="server" SkinID="DropDownListLookup"
                                                                                                                Width="220px" DataSourceID="odsBondingsList" TabIndex="2"
                                                                                                                DataValueField="COMPANIES_ID" DataTextField="Name">
                                                                                                            </asp:DropDownList>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:RequiredFieldValidator ID="rfvBondingNew" runat="server" ControlToValidate="ddlBondingNew"
                                                                                                                Display="Dynamic" ErrorMessage="Please select a Bonding." InitialValue="-1"
                                                                                                                SkinID="Validator" ValidationGroup="bondingNew" EnableViewState="False">
                                                                                                            </asp:RequiredFieldValidator>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                            ...
                                                                                            <ItemTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:Label ID="lblBonding" runat="server" Text='<%# Eval("Bonding") %>' SkinID="Label"></asp:Label>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </ItemTemplate>
                                                                                            ...
                                                                                            <EditItemTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:CompareValidator ID="cvRateEdit" runat="server" Operator="DataTypeCheck"
                                                                                                                Type="Currency" ControlToValidate="tbxRateEdit" ValidationGroup="bondingEdit"
                                                                                                                SkinID="Validator" Display="Dynamic" ErrorMessage="Invalid data. (use #.## format)">
                                                                                                            </asp:CompareValidator>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:CompareValidator ID="cvRateNew" runat="server" Operator="DataTypeCheck"
                                                                                                                Type="Currency" ControlToValidate="tbxRateNew" ValidationGroup="bondingNew"
                                                                                                                SkinID="Validator" Display="Dynamic" ErrorMessage="Invalid data. (use #.## format)">
                                                                                                            </asp:CompareValidator>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                ...
                                                                                                <table style="width: 100%" cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td style="width: 50%">
                                                                                                                <asp:ImageButton ID="ibtnDelete" runat="server" SkinID="GridView_Delete" CommandName="Delete"
                                                                                                                    OnClientClick='return confirm("Are you sure you want to delete this bonding costs?");'>
                                                                                                                </asp:ImageButton>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </tbody>
                                                                    ...
                                                                    <td>
                                                                        <table cellpadding="0" cellspacing="0" border="0">
                                                                            <tr>
                                                                                ...
                                                                                <td style="width: 110px; text-align: right;">
                                                                                    <asp:Label ID="lblBondingsTotalCosts" Width="110px" runat="server" SkinID="Label"
                                                                                        Text="(USD) : "></asp:Label>
                                                                                </td>
                                                                                <td style="width: 70px; text-align: right;">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <asp:ObjectDataSource ID="odsBondings" runat="server" FilterExpression="(Deleted = 0)"
                                                                            ...
                                                                            TypeName="LiquiForce.LFSLive.WebUI.Projects.Projects.project_costing_sheets_add"
                                                                            DeleteMethod="DummyBondingsNew" InsertMethod="DummyBondingsNew" UpdateMethod="DummyBondingsNew">
                                                                        </asp:ObjectDataSource>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <asp:WizardStep ID="StepInsuranceInformation" runat="server" Title="InsuranceInformation">
                                                        <div runat="server" id="dvnsuranceCompaniesCostsByClientProject" style="overflow-x: auto; overflow-y: hidden; width: 930px">
                                                            <!-- Page element: 1 column -->                                                            
                                                            <table cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="lblInsuranceCompaniesCosts" runat="server" SkinID="Label" Text="Other/Category/Insurance Companies Costs"></asp:Label>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="height: 7px">
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" style="width: 780px">
                                                                <tr>
                                                                    <td>
                                                                        <asp:Panel ID="pnlInsuranceCompaniesCostsByClientProject" runat="server" Width="420px">
                                                                            <asp:UpdatePanel ID="upnlInsuranceCompaniesCostsByClientProject" runat="server">
                                                                                <ContentTemplate>
                                                                                    <!-- Page element: 1 column - Grid Project Time -->
                                                                                    <asp:GridView ID="grdInsurances" runat="server" SkinID="GridView" Width="420px"
                                                                                        AutoGenerateColumns="False" AllowPaging="True" PageSize="10" ShowFooter="True"
                                                                                        OnDataBound="grdInsurances_DataBound" OnRowCommand="grdInsurances_RowCommand"
                                                                                        OnRowUpdating="grdInsurances_RowUpdating" OnRowEditing="grdInsurances_RowEditing"
                                                                                        OnRowDeleting="grdInsurances_RowDeleting" 
                                                                                        DataKeyNames="CostingSheetID,InsuranceCompanyID,RefID" DataSourceID="odsInsurances">
                                                                                        <Columns>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="InsuranceCompanyID" Visible="False">
                                                                                            <ItemTemplate>
                                                                                                <asp:Label ID="lblInsuranceID" runat="server" SkinID="Label" Text='<%# Eval("InsuranceCompanyID") %>'></asp:Label>
                                                                                            </ItemTemplate>
                                                                                            <EditItemTemplate>
                                                                                                <asp:Label ID="lblInsuranceIDEdit" runat="server" SkinID="Label" Text='<%# Eval("InsuranceCompanyID") %>'></asp:Label>
                                                                                            </EditItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                            ...
                                                                                            <EditItemTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:RequiredFieldValidator ID="rfvStartDateEdit" runat="server" ControlToValidate="tkrdpStartDateEdit" ValidationGroup="insuranceEdit"
                                                                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator">
                                                                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                                                                <asp:CompareValidator ID="cvStartDateEdit" runat="server" Type="Date" ControlToValidate="tkrdpStartDateEdit" ValidationGroup="insuranceEdit" SkinID="Validator"
                                                                                                                    Display="Dynamic" ControlToCompare="hdfFrom" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval.">
                                                                                                                </asp:CompareValidator>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:RequiredFieldValidator ID="rfvStartDateNew" runat="server" ControlToValidate="tkrdpStartDateNew" ValidationGroup="insuranceNew"
                                                                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator" >
                                                                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                                                                <asp:CompareValidator ID="cvStartDateNew" runat="server" Type="Date" ControlToValidate="tkrdpStartDateNew" ValidationGroup="insuranceNew" SkinID="Validator"
                                                                                                                    Display="Dynamic" ControlToCompare="hdfFrom" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval.">
                                                                                                                </asp:CompareValidator>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                            ...
                                                                                            <EditItemTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:RequiredFieldValidator ID="rfvEndDateEdit" runat="server" ControlToValidate="tkrdpEndDateEdit" ValidationGroup="insuranceEdit"
                                                                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator">
                                                                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                                                                <asp:CompareValidator ID="cvEndDateEdit" runat="server" Type="Date" ControlToValidate="tkrdpEndDateEdit" ValidationGroup="insuranceEdit" 
                                                                                                                    Display="Dynamic" ControlToCompare="hdfTo" Operator="LessThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                                                                </asp:CompareValidator>
                                                                                                                <asp:CompareValidator ID="cvEndDate2Edit" runat="server" Type="Date" ControlToValidate="tkrdpEndDateEdit" ValidationGroup="insuranceEdit" 
                                                                                                                    Display="Dynamic" ControlToCompare="tkrdpStartDateEdit" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                                                                </asp:CompareValidator>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:RequiredFieldValidator ID="rfvEndDateNew" runat="server" ControlToValidate="tkrdpEndDateNew" ValidationGroup="insuranceNew"
                                                                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator">
                                                                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                                                                <asp:CompareValidator ID="cvEndDateNew" runat="server" Type="Date" ControlToValidate="tkrdpEndDateNew" ValidationGroup="insuranceNew" 
                                                                                                                    Display="Dynamic" ControlToCompare="hdfTo" Operator="LessThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                                                                </asp:CompareValidator>
                                                                                                                <asp:CompareValidator ID="cvEndDate2New" runat="server" Type="Date" ControlToValidate="tkrdpEndDateNew" ValidationGroup="insuranceNew" 
                                                                                                                    Display="Dynamic" ControlToCompare="tkrdpStartDateNew" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                                                                </asp:CompareValidator>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Company">
                                                                                            <EditItemTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:TextBox ID="tbxInsuranceEdit" Width="220px" runat="server" ReadOnly="true" SkinID="TextBoxReadOnly"
                                                                                                                    Text='<%# Eval("Insurance") %>'></asp:TextBox>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:DropDownList ID="ddlInsuranceNew" runat="server" SkinID="DropDownListLookup"
                                                                                                                Width="220px" DataSourceID="odsInsurancesList" TabIndex="2"
                                                                                                                DataValueField="COMPANIES_ID" DataTextField="Name">
                                                                                                            </asp:DropDownList>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:RequiredFieldValidator ID="rfvInsuranceNew" runat="server" ControlToValidate="ddlInsuranceNew"
                                                                                                                Display="Dynamic" ErrorMessage="Please select a company." InitialValue="-1"
                                                                                                                SkinID="Validator" ValidationGroup="insuranceNew" EnableViewState="False">
                                                                                                            </asp:RequiredFieldValidator>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                            ...
                                                                                            <ItemTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:Label ID="lblInsurance" runat="server" Text='<%# Eval("Insurance") %>' SkinID="Label"></asp:Label>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </ItemTemplate>
                                                                                            ...
                                                                                            <EditItemTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:CompareValidator ID="cvRateEdit" runat="server" Operator="DataTypeCheck"
                                                                                                                Type="Currency" ControlToValidate="tbxRateEdit" ValidationGroup="insuranceEdit"
                                                                                                                SkinID="Validator" Display="Dynamic" ErrorMessage="Invalid data. (use #.## format)">
                                                                                                            </asp:CompareValidator>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:CompareValidator ID="cvRateNew" runat="server" Operator="DataTypeCheck"
                                                                                                                Type="Currency" ControlToValidate="tbxRateNew" ValidationGroup="insuranceNew"
                                                                                                                SkinID="Validator" Display="Dynamic" ErrorMessage="Invalid data. (use #.## format)">
                                                                                                            </asp:CompareValidator>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                ...
                                                                                                <table style="width: 100%" cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td style="width: 50%">
                                                                                                                <asp:ImageButton ID="ibtnDelete" runat="server" SkinID="GridView_Delete" CommandName="Delete"
                                                                                                                    OnClientClick='return confirm("Are you sure you want to delete this insurance costs?");'>
                                                                                                                </asp:ImageButton>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </tbody>
                                                                    ...
                                                                    <td>
                                                                        <table cellpadding="0" cellspacing="0" border="0">
                                                                            <tr>
                                                                                ...
                                                                                <td style="width: 110px; text-align: right;">
                                                                                    <asp:Label ID="lblInsurancesTotalCosts" Width="110px" runat="server" SkinID="Label"
                                                                                        Text="(USD) : "></asp:Label>
                                                                                </td>
                                                                                <td style="width: 70px; text-align: right;">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <asp:ObjectDataSource ID="odsInsurances" runat="server" FilterExpression="(Deleted = 0)"
                                                                            ...
                                                                            TypeName="LiquiForce.LFSLive.WebUI.Projects.Projects.project_costing_sheets_add"
                                                                            DeleteMethod="DummyInsurancesNew" InsertMethod="DummyInsurancesNew" UpdateMethod="DummyInsurancesNew">
                                                                        </asp:ObjectDataSource>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <asp:WizardStep ID="StepOtherCategoryInformation" runat="server" Title="OtherCategoryInformation">
                                                        <div runat="server" id="dvOtherCostsByClientProject" style="overflow-x: auto; overflow-y: hidden; width: 930px">
                                                            <!-- Page element: 1 column --> 
                                                            <table cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label1" runat="server" SkinID="Label" Text="Other/Category/Other Category Costs"></asp:Label>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="height: 7px">
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" style="width: 780px">
                                                                <tr>
                                                                    <td>
                                                                        <asp:Panel ID="pnlOtherCostsByClientProject" runat="server" Width="420px">
                                                                            <asp:UpdatePanel ID="upnlOtherCostsByClientProject" runat="server">
                                                                                <ContentTemplate>
                                                                                    <!-- Page element: 1 column - Grid Project Time -->
                                                                                    <asp:GridView ID="grdOtherCategory" runat="server" SkinID="GridView" Width="420px"
                                                                                        AutoGenerateColumns="False" AllowPaging="True" PageSize="10" ShowFooter="True"
                                                                                        OnDataBound="grdOtherCategory_DataBound" OnRowCommand="grdOtherCategory_RowCommand"
                                                                                        OnRowUpdating="grdOtherCategory_RowUpdating" OnRowEditing="grdOtherCategory_RowEditing"
                                                                                        OnRowDeleting="grdOtherCategory_RowDeleting" 
                                                                                        DataKeyNames="CostingSheetID,Category,RefID" DataSourceID="odsOtherCategory">
                                                                                        <Columns>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Category" Visible="False">
                                                                                            <ItemTemplate>
                                                                                                <asp:Label ID="lblOtherCategoryID" runat="server" SkinID="Label" Text='<%# Eval("Category") %>'></asp:Label>
                                                                                            </ItemTemplate>
                                                                                            <EditItemTemplate>
                                                                                                <asp:Label ID="lblOtherCategoryIDEdit" runat="server" SkinID="Label" Text='<%# Eval("Category") %>'></asp:Label>
                                                                                            </EditItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                            ...
                                                                                            <EditItemTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:RequiredFieldValidator ID="rfvStartDateEdit" runat="server" ControlToValidate="tkrdpStartDateEdit" ValidationGroup="otherCategoryEdit"
                                                                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator">
                                                                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                                                                <asp:CompareValidator ID="cvStartDateEdit" runat="server" Type="Date" ControlToValidate="tkrdpStartDateEdit" ValidationGroup="otherCategoryEdit" SkinID="Validator"
                                                                                                                    Display="Dynamic" ControlToCompare="hdfFrom" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval.">
                                                                                                                </asp:CompareValidator>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:RequiredFieldValidator ID="rfvStartDateNew" runat="server" ControlToValidate="tkrdpStartDateNew" ValidationGroup="otherCategoryNew"
                                                                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator" >
                                                                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                                                                <asp:CompareValidator ID="cvStartDateNew" runat="server" Type="Date" ControlToValidate="tkrdpStartDateNew" ValidationGroup="otherCategoryNew" SkinID="Validator"
                                                                                                                    Display="Dynamic" ControlToCompare="hdfFrom" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval.">
                                                                                                                </asp:CompareValidator>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                            ...
                                                                                            <EditItemTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:RequiredFieldValidator ID="rfvEndDateEdit" runat="server" ControlToValidate="tkrdpEndDateEdit" ValidationGroup="otherCategoryEdit"
                                                                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator">
                                                                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                                                                <asp:CompareValidator ID="cvEndDateEdit" runat="server" Type="Date" ControlToValidate="tkrdpEndDateEdit" ValidationGroup="otherCategoryEdit" 
                                                                                                                    Display="Dynamic" ControlToCompare="hdfTo" Operator="LessThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                                                                </asp:CompareValidator>
                                                                                                                <asp:CompareValidator ID="cvEndDate2Edit" runat="server" Type="Date" ControlToValidate="tkrdpEndDateEdit" ValidationGroup="otherCategoryEdit" 
                                                                                                                    Display="Dynamic" ControlToCompare="tkrdpStartDateEdit" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                                                                </asp:CompareValidator>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <asp:RequiredFieldValidator ID="rfvEndDateNew" runat="server" ControlToValidate="tkrdpEndDateNew" ValidationGroup="otherCategoryNew"
                                                                                                                    Display="Dynamic" ErrorMessage="Please provide a date." SkinID="Validator">
                                                                                                                </asp:RequiredFieldValidator>                                                                                                                
                                                                                                                <asp:CompareValidator ID="cvEndDateNew" runat="server" Type="Date" ControlToValidate="tkrdpEndDateNew" ValidationGroup="otherCategoryNew" 
                                                                                                                    Display="Dynamic" ControlToCompare="hdfTo" Operator="LessThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                                                                </asp:CompareValidator>
                                                                                                                <asp:CompareValidator ID="cvEndDate2New" runat="server" Type="Date" ControlToValidate="tkrdpEndDateNew" ValidationGroup="otherCategoryNew" 
                                                                                                                    Display="Dynamic" ControlToCompare="tkrdpStartDateNew" Operator="GreaterThanEqual" ErrorMessage="You cannot add costing sheet in that interval." SkinID="Validator">
                                                                                                                </asp:CompareValidator>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Category">
                                                                                            <EditItemTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:TextBox ID="tbxCategoryEdit" Width="95px" runat="server" ReadOnly="true" SkinID="TextBoxReadOnly"
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:RequiredFieldValidator ID="rfvOtherCategoryNew" runat="server" ControlToValidate="ddlCategoryNew"
                                                                                                                Display="Dynamic" ErrorMessage="Please select a category." InitialValue="-1"
                                                                                                                SkinID="Validator" ValidationGroup="otherCategoryNew" EnableViewState="False">
                                                                                                            </asp:RequiredFieldValidator>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                            ...
                                                                                            <ItemTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:Label ID="lblOtherCategory" runat="server" Text='<%# Eval("Category") %>' SkinID="Label"></asp:Label>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </ItemTemplate>
                                                                                            ...
                                                                                            <EditItemTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:CompareValidator ID="cvRateEdit" runat="server" Operator="DataTypeCheck"
                                                                                                                Type="Currency" ControlToValidate="tbxRateEdit" ValidationGroup="otherCategoryEdit"
                                                                                                                SkinID="Validator" Display="Dynamic" ErrorMessage="Invalid data. (use #.## format)">
                                                                                                            </asp:CompareValidator>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:CompareValidator ID="cvRateNew" runat="server" Operator="DataTypeCheck"
                                                                                                                Type="Currency" ControlToValidate="tbxRateNew" ValidationGroup="otherCategoryNew"
                                                                                                                SkinID="Validator" Display="Dynamic" ErrorMessage="Invalid data. (use #.## format)">
                                                                                                            </asp:CompareValidator>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                ...
                                                                                                <table style="width: 100%" cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td style="width: 50%">
                                                                                                                <asp:ImageButton ID="ibtnDelete" runat="server" SkinID="GridView_Delete" CommandName="Delete"
                                                                                                                    OnClientClick='return confirm("Are you sure you want to delete this Activity costs?");'>
                                                                                                                </asp:ImageButton>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </tbody>
                                                                    ...
                                                                    <td>
                                                                        <table cellpadding="0" cellspacing="0" border="0">
                                                                            <tr>
                                                                                ...
                                                                                <td style="width: 110px; text-align: right;">
                                                                                    <asp:Label ID="lblOtherCategoryTotalCosts" Width="110px" runat="server" SkinID="Label"
                                                                                        Text="(USD) : "></asp:Label>
                                                                                </td>
                                                                                <td style="width: 70px; text-align: right;">
                                                                ...
                                                                <tr>
                                                                    <td>                                                                                                                                                
                                                                        <asp:ObjectDataSource ID="odsOtherCategory" runat="server" FilterExpression="(Deleted = 0)"
                                                                            ...
                                                                            TypeName="LiquiForce.LFSLive.WebUI.Projects.Projects.project_costing_sheets_add"
                                                                            DeleteMethod="DummyOtherCategoryNew" InsertMethod="DummyOtherCategoryNew" UpdateMethod="DummyOtherCategoryNew">
                                                                        </asp:ObjectDataSource>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:UpdatePanel ID="upnlRevenue" runat="server">
                                                                            <ContentTemplate>
                                                                                <asp:GridView ID="grdRevenue" runat="server" SkinID="GridView" Width="750px" AllowPaging="True"
                                                                                    ShowFooter="true" AutoGenerateColumns="False" DataKeyNames="CostingSheetID,RefIDRevenue"
