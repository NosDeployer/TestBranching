...
namespace LiquiForce.LFSLive.WebUI.Projects.Revenue
{
    ...
    /// revenue_summary
    /// </summary>
    public partial class revenue_summary : System.Web.UI.Page
    {
        // ////////////////////////////////////////////////////////////////////////
        // FIELDS
        //
        ...
        {            
            ...
            {
                case "mEdit":
                    url = "./revenue_edit.aspx?source_page=revenue_summary.aspx&project_id=" + hdfCurrentProjectId.Value + "&ref_id=" + hdfCurrentRefId.Value + GetNavigatorState() + "&update=" + (string)ViewState["update"] ;
                    break;

                case "mDelete":
                    url = "./revenue_delete.aspx?source_page=revenue_summary.aspx&project_id=" + hdfCurrentProjectId.Value + "&ref_id=" + hdfCurrentRefId.Value + GetNavigatorState() + "&update=" + (string)ViewState["update"];
                    break;

                case "mLastSearch":
                    url = "./revenue_navigator2.aspx?source_page=revenue_summary.aspx&project_id=" + hdfCurrentProjectId.Value + "&ref_id=" + hdfCurrentRefId.Value + GetNavigatorState() + "&update=" + (string)ViewState["update"];
                    break;
                ...
                case "mPrevious":
                    ...
                    // Redirect
                    url = "./revenue_summary.aspx?source_page=revenue_navigator2.aspx&project_id=" + previousProjectId.ToString() + "&ref_id=" + previousRefId.ToString() + GetNavigatorState();
                ...
                case "mNext":
                    ...
                    // Redirect
                    url = "./revenue_summary.aspx?source_page=revenue_navigator2.aspx&project_id=" + nextProjectId.ToString() + "&ref_id=" + nextRefId.ToString() + GetNavigatorState();
        ...
        private void RegisterClientScripts()
        {
            ...
            this.ClientScript.RegisterClientScriptInclude("clientSideCode", "./revenue_summary.js");
        }
