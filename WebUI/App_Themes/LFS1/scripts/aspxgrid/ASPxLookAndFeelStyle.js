...
function ASPxLookAndFeelStyleCollection(){
	this.inherit = ASPxClientWebCollection;
	this.inherit();
...
function ASPxLookAndFeelStyle3DKindStdStyles(){
	...
	this.CreateStdButtonStyle = function(){
		this.stdButtonStyle = ASPxStyle.CreateStyle();
		this.stdButtonStyle.attributes["backgroundColor"]=_encodeColor("buttonface");
		this.stdButtonStyle.attributes["borderColor"]=_encodeColor("buttonhighlight");
	...
	this.CreateStdButtonHotTrackStyle = function(){
		...
		this.stdButtonHotTrackStyle.attributes["borderLeftColor"]=_encodeColor("buttonhighlight");
		this.stdButtonHotTrackStyle.attributes["borderTopColor"]=_encodeColor("buttonhighlight");
		this.stdButtonHotTrackStyle.attributes["borderRightColor"]=_encodeColor("threeddarkshadow");
		this.stdButtonHotTrackStyle.attributes["borderBottomColor"]=_encodeColor("threeddarkshadow");
	}
	this.CreateStdButtonPressedStyle = function(){
		this.stdButtonPressedStyle = ASPxStyle.CreateStyle();
		this.stdButtonPressedStyle.attributes["borderColor"]=_encodeColor("buttonhighlight");
		this.stdButtonPressedStyle.attributes["borderStyle"]="Inset";
		this.stdButtonPressedStyle.attributes["borderWidth"]="2px";
	}
	this.CreateStdEditorStyle = function(){
		this.stdEditorStyle = ASPxStyle.CreateStyle();
		this.stdEditorStyle.attributes["backgroundColor"]=_encodeColor("window");
		this.stdButtonStyle.attributes["borderColor"]=_encodeColor("buttonhighlight");
	...
	this.CreateStdDraggedElementStyle = function(){
		this.stdDraggedElementStyle = ASPxStyle.CreateStyle();
		this.stdDraggedElementStyle.attributes["backgroundColor"]=_encodeColor("buttonshadow");
		this.stdDraggedElementStyle.attributes["filter"]="progid:DXImageTransform.Microsoft.Alpha(Style=0, Opacity=60)"; 
	}
	this.CreateStdGroupItemStyle = function(){
		this.stdGroupItemStyle = ASPxStyle.CreateStyle();
		this.stdGroupItemStyle.attributes["backgroundColor"]=_encodeColor("buttonface");
	}
	this.CreateStdPreviewStyle = function(){
		this.stdPreviewStyle = ASPxStyle.CreateStyle();
	...
	this.CreateStdFooterStyle = function(){
		this.stdFooterStyle = ASPxStyle.CreateStyle();
		this.stdFooterStyle.attributes["backgroundColor"]=_encodeColor("buttonface");
	}
	this.CreateStdFooterCellStyle = function(){
		this.stdFooterCellStyle = ASPxStyle.CreateStyle();
		this.stdFooterCellStyle.attributes["backgroundColor"]=_encodeColor("buttonface");
	}
	this.CreateStdSearchItemStyle = function(){
		this.stdSearchItemStyle = ASPxStyle.CreateStyle();
		this.stdSearchItemStyle.attributes["backgroundColor"]=_encodeColor("buttonface");
		this.stdSearchItemStyle.attributes["verticalAlign"]="center";
	}
}
...
function ASPxLookAndFeelFlatKindStdStyles(){
	...
	this.CreateStdButtonStyle = function(){
		this.stdButtonStyle = ASPxStyle.CreateStyle();
		this.stdButtonStyle.attributes["backgroundColor"]=_encodeColor("buttonface");
		this.stdButtonStyle.attributes["borderColor"]=_encodeColor("buttonshadow");
		this.stdButtonStyle.attributes["borderStyle"]="Solid";
		this.stdButtonStyle.attributes["borderWidth"]="1px";
		this.stdButtonStyle.attributes["textAlign"]="Center";		
		this.stdButtonStyle.attributes["borderLeftColor"]=_encodeColor("buttonhighlight");
		this.stdButtonStyle.attributes["borderTopColor"]=_encodeColor("buttonhighlight");
		this.stdButtonStyle.attributes["borderRightColor"]=_encodeColor("buttonshadow");
		this.stdButtonStyle.attributes["borderBottomColor"]=_encodeColor("buttonshadow");
	}
	this.CreateStdButtonHotTrackStyle = function(){
		this.stdButtonHotTrackStyle = ASPxStyle.CreateStyle();
		this.stdButtonHotTrackStyle.attributes["borderStyle"]="Solid";
	...
	this.CreateStdButtonPressedStyle = function(){
		...
		this.stdButtonPressedStyle.attributes["borderLeftColor"]=_encodeColor("threeddarkshadow");
		this.stdButtonPressedStyle.attributes["borderTopColor"]=_encodeColor("threeddarkshadow");
		this.stdButtonPressedStyle.attributes["borderRightColor"]=_encodeColor("buttonhighlight");
		this.stdButtonPressedStyle.attributes["borderBottomColor"]=_encodeColor("buttonhighlight");
	}
	this.CreateStdEditorStyle = function(){
		this.stdEditorStyle = ASPxStyle.CreateStyle();
		this.stdEditorStyle.attributes["backgroundColor"]=_encodeColor("window");
		...
		this.stdEditorStyle.attributes["borderLeftColor"]=_encodeColor("buttonshadow");
		this.stdEditorStyle.attributes["borderTopColor"]=_encodeColor("buttonshadow");
		this.stdEditorStyle.attributes["borderRightColor"]=_encodeColor("buttonface");
		this.stdEditorStyle.attributes["borderBottomColor"]=_encodeColor("buttonface");
	}
	this.CreateStdDraggedElementStyle = function(){
		this.stdDraggedElementStyle = ASPxStyle.CreateStyle();
		this.stdDraggedElementStyle.attributes["backgroundColor"]=_encodeColor("buttonshadow");
	...
	this.CreateStdFooterCellStyle = function(){
		this.stdFooterCellStyle = ASPxStyle.CreateStyle();
		this.stdFooterCellStyle.attributes["backgroundColor"]=_encodeColor("buttonface");
		this.stdFooterCellStyle.attributes["borderLeftColor"]=_encodeColor("buttonshadow");
		this.stdFooterCellStyle.attributes["borderTopColor"]=_encodeColor("buttonshadow");
		this.stdFooterCellStyle.attributes["borderRightColor"]=_encodeColor("buttonhighlight");
		this.stdFooterCellStyle.attributes["borderBottomColor"]=_encodeColor("buttonhighlight");
	}
	this.CreateStdSearchItemStyle = function(){
		this.stdSearchItemStyle = ASPxStyle.CreateStyle();
		this.stdSearchItemStyle.attributes["backgroundColor"]=_encodeColor("buttonface");
	...
	this.CreateStdSearchEditorStyle = function(){
		this.stdSearchEditorStyle = ASPxStyle.CreateStyle();
		this.stdSearchEditorStyle.attributes["borderLeftColor"]=_encodeColor("buttonshadow");
		this.stdSearchEditorStyle.attributes["borderTopColor"]=_encodeColor("buttonshadow");
		this.stdSearchEditorStyle.attributes["borderRightColor"]=_encodeColor("buttonhighlight");
		this.stdSearchEditorStyle.attributes["borderBottomColor"]=_encodeColor("buttonhighlight");
	}
}
...
function ASPxLookAndFeelHotFlatKindStdStyles(){
	...
	this.CreateStdButtonHotTrackStyle = function(){
		...
		this.stdButtonHotTrackStyle.attributes["borderLeftColor"]=_encodeColor("buttonhighlight");
		this.stdButtonHotTrackStyle.attributes["borderTopColor"]=_encodeColor("buttonhighlight");
		this.stdButtonHotTrackStyle.attributes["borderRightColor"]=_encodeColor("buttonshadow");
		this.stdButtonHotTrackStyle.attributes["borderBottomColor"]=_encodeColor("buttonshadow");
	}
	this.CreateStdButtonPressedStyle = function(){
		this.stdButtonPressedStyle = ASPxStyle.CreateStyle();
		this.stdButtonPressedStyle.attributes["borderStyle"]="Solid";
		this.stdButtonPressedStyle.attributes["borderWidth"]="1px";
		this.stdButtonPressedStyle.attributes["borderLeftColor"]=_encodeColor("buttonshadow");
		this.stdButtonPressedStyle.attributes["borderTopColor"]=_encodeColor("buttonshadow");
		this.stdButtonPressedStyle.attributes["borderRightColor"]=_encodeColor("buttonhighlight");
		this.stdButtonPressedStyle.attributes["borderBottomColor"]=_encodeColor("buttonhighlight");
	}
}
...
function ASPxLookAndFeelUltraFlatKindStdStyles(){
	...
	this.CreateStdEditorStyle = function(){
		this.stdEditorStyle = ASPxStyle.CreateStyle();
		this.stdEditorStyle.attributes["backgroundColor"]=_encodeColor("window");
		this.stdEditorStyle.attributes["borderColor"]=_encodeColor("buttonface");
		this.stdEditorStyle.attributes["borderWidth"]="1px";
		this.stdEditorStyle.attributes["borderStyle"]="Solid";
	}
	this.CreateStdStandaloneButtonStyle = function(){
		this.stdStandaloneButtonStyle = this.GetButtonStyle();
		this.stdStandaloneButtonStyle .attributes["borderColor"]=_encodeColor("windowframe");
	}
	this.CreateStdDraggedElementStyle = function(){
		this.stdDraggedElementStyle = ASPxStyle.CreateStyle();
		this.stdDraggedElementStyle.attributes["backgroundColor"]=_encodeColor("buttonshadow");
	...
	this.CreateStdFooterCellStyle = function(){
		this.stdFooterCellStyle = ASPxStyle.CreateStyle();
		this.stdFooterCellStyle.attributes["backgroundColor"]=_encodeColor("buttonface");
		this.stdFooterCellStyle.attributes["borderColor"]=_encodeColor("buttonshadow");
...
function ASPxLookAndFeelOffice11KindStdStyles(){
	...
	this.CreateStdButtonStyle = function(){
		this.stdButtonStyle = ASPxStyle.CreateStyle();
		this.stdButtonStyle.attributes["backgroundColor"]=_encodeColor("buttonface");
		this.stdButtonStyle.attributes["borderColor"]=_encodeColor("window");
		this.stdButtonStyle.attributes["borderStyle"]="Solid";
		this.stdButtonStyle.attributes["borderWidth"]="1px";
		this.stdButtonStyle.attributes["textAlign"]="Center";		
	...
	this.CreateStdButtonHotTrackStyle = function(){
		this.stdButtonHotTrackStyle = ASPxStyle.CreateStyle();
		this.stdButtonHotTrackStyle.attributes["borderColor"]=_encodeColor("highlight");
	...
	this.CreateStdButtonPressedStyle = function(){
		this.stdButtonPressedStyle = ASPxStyle.CreateStyle();
		this.stdButtonPressedStyle.attributes["borderColor"]=_encodeColor("highlight");
