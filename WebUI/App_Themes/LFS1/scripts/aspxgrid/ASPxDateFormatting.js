function DateReplacement() {
	...
	this.parse = function(str, mask) {
		...
		if(this.curNum < this.numArray.length)
			return NaN;
		if(0 > this.mo_num || this.mo_num > 11)			
			return NaN;
		if(1 > this.day_num || this.day_num > 31)			
			return NaN;
		if(0 > this.hr_num || this.hr_num > 23)			
			return NaN;
		if(0 > this.min_num || this.min_num > 59)			
			return NaN;
		if(0 > this.sec_num || this.sec_num > 59)			
			return NaN;
	...
	this.compLex = function(lex) {
		switch(lex) {
			case "M" : 
			case "MM" : {
				this.mo_num = _parseInt(this.getCurNumValue()) - 1;
				break;
			}
			case "MMM" : {
				this.mo_num = _parseInt(this.findAbbrMonth());
				this.curNum--;
				break;
			}
			case "MMMM" : {
				this.mo_num = _parseInt(this.findMonth());
				this.curNum--;
				break;
			}
			case "d" :
			case "dd" : {
				this.day_num = _parseInt(this.getCurNumValue());
			...
			case "yy" :
			case "yyyy" : {
				this.yr_num = _parseInt(this.GetNormalYear());
				break;
			}
			case "h":
			case "hh":
			case "H":
			case "HH": {
				this.hr_num = _parseInt(this.getCurNumValue());
				this.assignNow();
				break;
			}
			case "m": 	
			case "mm": {
				this.min_num = _parseInt(this.getCurNumValue());
				this.assignNow();
				break;
			}
			case "s": 
			case "ss": {
				this.sec_num = _parseInt(this.getCurNumValue());
				this.assignNow();
				break;
			}
			case "f":
			...
			case "ffffff":
			case "fffffff": {
				this.msec_num = _parseInt(this.getCurNumValue());
				break;
			}
			case "t":
