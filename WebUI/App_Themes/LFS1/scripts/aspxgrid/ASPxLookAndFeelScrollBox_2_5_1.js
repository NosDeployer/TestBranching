...
function OnLFSBxTimer(){
	if(pressedLFScrollBoxRootElement != null && pressedLFScrollBoxScrollingDelta != null){
		var LFScrollBarRootElement = _getChildByCssClass(pressedLFScrollBoxRootElement, "LFScrollBar");
		if(LFScrollBarRootElement != null){
			var LFScrollBar = GetLookAndFeelScrollBarCollection().Get(LFScrollBarRootElement.id);
			if(LFScrollBar != null){
