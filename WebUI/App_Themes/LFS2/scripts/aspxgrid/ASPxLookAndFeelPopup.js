function ASPxLookAndFeelPopup(name){
	...
	this.GetFocusElement = function(){
		...
		if(this.focusElement == null && rootElement != null){
			this.focusElement = _getChildByTagName(rootElement, "INPUT", 0);
	...
	this.GetFakeContainerElement = function(){
		if(this.fakeContainerElement == null){ 
			...
			_setElementVisibility(this.fakeContainerElement, false);
		}
...
function LFPDocumentOnSelectStart(e){
	...
	if(_getParentByCssClass(element, "LFPopup") != null && !_checkTagName(element, "INPUT"))
		return false;
