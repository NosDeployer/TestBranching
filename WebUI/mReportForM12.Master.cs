...
{
    public partial class mReportForM12 : System.Web.UI.MasterPage
    {
        // ////////////////////////////////////////////////////////////////////////
        // FIELDS
        //
        ...
        protected ReportDocument _report3;

        ReportMethod1 _generateMethod1;
        ReportMethod2 _generateMethod2;
        ReportMethod3 _generateMethod3;
        ...
        public ReportMethod3 GenerateMethod3
        {
            // Delegate for generate method
            set
            {
                _generateMethod3 = value;
            }
        }
        ...
        protected void Page_Unload(object sender, System.EventArgs e)
        {
            ...
            if ((_report3 != null) && (_report3.IsLoaded))
            {
                _report3.Close();
                _report3.Dispose();
            }
        ...
        protected void tkrmTop_ItemClick(object sender, RadMenuEventArgs e)
        {
            ...
            CheckBox cbxM1Report;
            CheckBox cbxM2Report;
            bool printM1Report = false;
            bool printM2Report = false;
            mpContentPlaceHolder = (ContentPlaceHolder)this.FindControl("ContentPlaceHolder1");

            if(mpContentPlaceHolder != null)
            {
                cbxM1Report = (CheckBox) mpContentPlaceHolder.FindControl("cbxM1Report");
                if(cbxM1Report != null)
                {
                    if (cbxM1Report.Checked)
                    {
                        printM1Report = true;
                    }
                }

                cbxM2Report = (CheckBox) mpContentPlaceHolder.FindControl("cbxM2Report");
                if(cbxM2Report != null)
                {
                    if (cbxM2Report.Checked)
                    {
                        printM2Report = true;
                    }
                }
        ...
        private void RegisterClientScripts()
        {
            ...
            cs.RegisterClientScriptInclude("clientSideCode", "./../../mReportForM12.js");
        }
        ...
        public delegate void ReportMethod3();
        ...
        private void PrintM1M2V2()
        {
            ...
            // Generate report
            if (_generateMethod3 == null)
            {
                throw new Exception("Generate method is not defined");
            }
            _generateMethod3();

            // Configure & export report for M1 and M2
            if (_data3.Tables[_table1].Rows.Count > 0 || _data3.Tables[_table2].Rows.Count > 0)
            {
                // ... Path & file name
                string physicalApplicationPath = Request.PhysicalApplicationPath;
                if (Request.PhysicalApplicationPath.Substring(Request.PhysicalApplicationPath.Length - 1, 1) != "\\")
                ...
                // ... Export options
                _report3.ExportOptions.DestinationOptions = diskOptions;
                _report3.ExportOptions.ExportDestinationType = ExportDestinationType.DiskFile;
                switch (hdfFormat3.Value)
                {
                    case "pdf":
                        _report3.ExportOptions.ExportFormatType = ExportFormatType.PortableDocFormat;
                        break;
                    ...
                    case "excel":
                        ...
                        _report3.ExportOptions.ExportFormatType = ExportFormatType.Excel;
                        _report3.ExportOptions.FormatOptions = excelOptions;
                        break;
                }
                ...
                // ... Preview report
                this.ReportFrame = string.Format("./../../new_viewer3.aspx?file_name={0}&report_name={1}&report_format={2}", fileName, "M1 and M2 Report", hdfFormat3.Value);
            }
            else
            {
                this.ReportFrame = "./../../new_viewer2.aspx";
        ...
        public void SetParameter3(string parameterName, params object[] parameters)
        {
            ParameterValues currentParameterValues = new ParameterValues();
            ...
            ParameterFieldDefinitions parameterFieldDefinitions = _report3.DataDefinition.ParameterFields;
            ParameterFieldDefinition parameterFieldDefinition = parameterFieldDefinitions[parameterName];
            parameterFieldDefinition.ApplyCurrentValues(currentParameterValues);
        }
