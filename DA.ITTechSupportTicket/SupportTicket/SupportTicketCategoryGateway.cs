...
{
    /// <summary>
    /// SupportTicketCategoryGateway
    /// </summary>
    public class SupportTicketCategoryGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public SupportTicketCategoryGateway()
        ...
        public SupportTicketCategoryGateway(DataSet data)
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "LFS_ITTST_CATEGORY";
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[LFS_ITTST_CATEGORY] WHERE (([CategoryID] = @Original_CategoryID) AND ([Name] = @Original_Name) AND ((@IsNull_ParentID = 1 AND [ParentID] IS NULL) OR ([ParentID] = @Original_ParentID)) AND ([Deleted] = @Original_Deleted) AND ([COMPANY_ID] = @Original_COMPANY_ID))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[LFS_ITTST_CATEGORY] ([CategoryID], [Name], [ParentID], [Deleted], [COMPANY_ID]) VALUES (@CategoryID, @Name, @ParentID, @Deleted, @COMPANY_ID);
SELECT CategoryID, Name, ParentID, Deleted, COMPANY_ID FROM LFS_ITTST_CATEGORY WHERE (CategoryID = @CategoryID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[LFS_ITTST_CATEGORY] SET [CategoryID] = @CategoryID, [Name] = @Name, [ParentID] = @ParentID, [Deleted] = @Deleted, [COMPANY_ID] = @COMPANY_ID WHERE (([CategoryID] = @Original_CategoryID) AND ([Name] = @Original_Name) AND ((@IsNull_ParentID = 1 AND [ParentID] IS NULL) OR ([ParentID] = @Original_ParentID)) AND ([Deleted] = @Original_Deleted) AND ([COMPANY_ID] = @Original_COMPANY_ID));
SELECT CategoryID, Name, ParentID, Deleted, COMPANY_ID FROM LFS_ITTST_CATEGORY WHERE (CategoryID = @CategoryID)";
        ...
        {
            FillDataWithStoredProcedure("LFS_ITTST_CATEGORYGATEWAY_LOAD", new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_ITTST_CATEGORYGATEWAY_LOADBYCATEGORYID", new SqlParameter("@categoryId", categoryId), new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        {
            FillDataWithStoredProcedure("LFS_ITTST_CATEGORYGATEWAY_LOADBYPARENTID", new SqlParameter("@parentId", parentId), new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        public DataRow GetRow(int categoryId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.ITTechSupportTicket.SupportTicket.CategoryGateway.GetRow");
            }
        }
        ...
        /// <param name="companyId">companyId</param>
        public void Insert(string name, int? parentId, bool deleted, int companyId)
        {
            ...
            string command = "INSERT INTO [dbo].[LFS_ITTST_CATEGORY] ([Name], [ParentID], [Deleted], [COMPANY_ID]) VALUES (@Name, @ParentID, @Deleted, @COMPANY_ID)";

            ExecuteScalar(command, nameParameter, parentIdParamater, deletedParameter, companyIdParameter);
        }
        ...
        public void Update(int originalCategoryId, string originalName, int? originalParentId, bool originalDeleted, int originalCompanyId, int newCategoryId, string newName, int? newParentId, bool newDeleted, int newCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_ITTST_CATEGORY] SET [Name] = @Name, [ParentID] = @ParentID, [Deleted] = @Deleted, [COMPANY_ID] = @COMPANY_ID "+
                "WHERE (" +
                "([CategoryID] = @Original_CategoryID) AND ([Deleted] = @Original_Deleted) AND " +
                " ([COMPANY_ID] = @Original_COMPANY_ID)" +
                " )";

            int rowsAffected = (int)ExecuteNonQuery(command, originalCategoryIdParameter, originalNameParameter, originalParentIdParameter, originalDeletedParameter, originalCompanyIdParameter, newCategoryIdParameter, newNameParameter, newParentIdParameter, newDeletedParameter, newCompanyIdParameter);
            if (rowsAffected == 0)
            {
        ...
        public void Delete(int categoryId, int companyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_ITTST_CATEGORY] SET [Deleted] = @Deleted WHERE (([CategoryID] = @CategoryID) AND ([COMPANY_ID] = @COMPANY_ID))";
        ...
        {
            string commandText = "SELECT COUNT(*) FROM LFS_ITTST_CATEGORY C WHERE (C.ParentID = @parentId) AND (C.COMPANY_ID = @companyId) AND (C.Deleted = 0)";
        ...
        {
            string commandText = "SELECT CategoryID FROM LFS_ITTST_CATEGORY WHERE (Name = @name) AND (Deleted = 0)";
            SqlCommand command = new SqlCommand(commandText, DB.Connection);
