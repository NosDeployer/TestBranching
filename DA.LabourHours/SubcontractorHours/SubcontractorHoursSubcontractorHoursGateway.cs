...
{
    /// <summary>
    /// SubcontractorHoursSubcontractorHoursGateway
    /// </summary>
    public class SubcontractorHoursSubcontractorHoursGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public SubcontractorHoursSubcontractorHoursGateway()
        ...
        public SubcontractorHoursSubcontractorHoursGateway(DataSet data)
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "LFS_SUBCONTRACTOR_HOURS";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[LFS_SUBCONTRACTOR_HOURS] ([ProjectID], [RefID], [SubcontractorID], [Date], [Quantity], [RateCad], [TotalCad], [RateUsd], [TotalUsd], [Comment], [Deleted], [COMPANY_ID]) VALUES (@ProjectID, @RefID, @SubcontractorID, @Date, @Quantity, @RateCad, @TotalCad, @RateUsd, @TotalUsd, @Comment, @Deleted, @COMPANY_ID);
SELECT ProjectID, RefID, SubcontractorID, Date, Quantity, RateCad, TotalCad, RateUsd, TotalUsd, Comment, Deleted, COMPANY_ID FROM LFS_SUBCONTRACTOR_HOURS WHERE (ProjectID = @ProjectID) AND (RefID = @RefID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[LFS_SUBCONTRACTOR_HOURS] SET [ProjectID] = @ProjectID, [RefID] = @RefID, [SubcontractorID] = @SubcontractorID, [Date] = @Date, [Quantity] = @Quantity, [RateCad] = @RateCad, [TotalCad] = @TotalCad, [RateUsd] = @RateUsd, [TotalUsd] = @TotalUsd, [Comment] = @Comment, [Deleted] = @Deleted, [COMPANY_ID] = @COMPANY_ID WHERE (([ProjectID] = @Original_ProjectID) AND ([RefID] = @Original_RefID) AND ([SubcontractorID] = @Original_SubcontractorID) AND ([Date] = @Original_Date) AND ([Quantity] = @Original_Quantity) AND ([RateCad] = @Original_RateCad) AND ([TotalCad] = @Original_TotalCad) AND ([RateUsd] = @Original_RateUsd) AND ([TotalUsd] = @Original_TotalUsd) AND ([Deleted] = @Original_Deleted) AND ([COMPANY_ID] = @Original_COMPANY_ID));
SELECT ProjectID, RefID, SubcontractorID, Date, Quantity, RateCad, TotalCad, RateUsd, TotalUsd, Comment, Deleted, COMPANY_ID FROM LFS_SUBCONTRACTOR_HOURS WHERE (ProjectID = @ProjectID) AND (RefID = @RefID)";
        ...
        public int Insert(int projectId, int refId, int subcontractorId, DateTime date, double quantity, decimal rateCad, decimal totalCad, decimal rateUsd, decimal totalUsd, string comment, bool deleted, int companyId)
        {
            ...
            string command = "INSERT INTO [dbo].[LFS_SUBCONTRACTOR_HOURS] ([ProjectID], [RefID], [SubcontractorID], [Date], [Quantity], [RateCad], [TotalCad], [RateUsd], [TotalUsd], [Comment], [Deleted], [COMPANY_ID]) VALUES (@ProjectID, @RefID, @SubcontractorID, @Date, @Quantity, @RateCad, @TotalCad, @RateUsd, @TotalUsd, @Comment, @Deleted, @COMPANY_ID)";
        ...
        public int Update(int originalProjectId, int originalRefId, int originalSubcontractorId, DateTime originalDate, double originalQuantity, decimal originalRateCad, decimal originalTotalCad, decimal originalRateUsd, decimal originalTotalUsd, string originalComment, bool originalDeleted, int originalCompanyId, int newProjectId, int newRefId, int newSubcontractorId, DateTime newDate, double newQuantity, decimal newRateCad, decimal newTotalCad, decimal newRateUsd, decimal newTotalUsd, string newComment, bool newDeleted, int newCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_SUBCONTRACTOR_HOURS] SET [SubcontractorID] = @SubcontractorID, [Date] = @Date, [Quantity] = @Quantity, [RateCad] = @RateCad, [TotalCad] = @TotalCad, [RateUsd] = @RateUsd, [TotalUsd] = @TotalUsd, [Comment] = @Comment " +
        ...
        public int Delete(int originalProjectId, int originalRefId, int originalCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_SUBCONTRACTOR_HOURS] SET  [Deleted] = @Deleted  " +
                             " WHERE (([ProjectID] = @Original_ProjectID) AND ([RefID] = @Original_RefID))";
