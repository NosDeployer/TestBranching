...
{
    /// <summary>
    /// VacationsInformationBasicInformationGateway
    /// </summary>
    public class VacationsInformationBasicInformationGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public VacationsInformationBasicInformationGateway()
        ...
        public VacationsInformationBasicInformationGateway(DataSet data)
        ...
        {
            FillDataWithStoredProcedure("LFS_VACATION_VACATIONSINFORMATIONBASICINFORMATIONGATEWAY_LOADBYEMPLOYEEIDYEAR", new SqlParameter("employeeId", employeeId), new SqlParameter("year", year), new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        public DataRow GetRow(int employeeId, int year)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.LabourHours.Vacations.VacationsInformationBasicInformationGateway.GetRow");
            }
        }
        ...
        /// <param name="employeeId">employeeId</param>
        /// <param name="year">year</param>
        /// <returns>TotalVacationDays</returns>
