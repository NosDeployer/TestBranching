...
{
    /// <summary>
    /// PrintManHoursPerPhaseRAPreVideoGateway
    /// </summary>
    public class PrintManHoursPerPhaseRAPreVideoGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Default constructor
        /// </summary>
        public PrintManHoursPerPhaseRAPreVideoGateway()
            : base("PrintManHoursPerPhaseRAPreVideo")
        {
        }
        ...
        public PrintManHoursPerPhaseRAPreVideoGateway(DataSet data)
            : base(data, "PrintManHoursPerPhaseRAPreVideo")
        {
        }
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "PrintManHoursPerPhaseRAPreVideo";
        ...
        public DataSet LoadByStartDateEndDateProjectTimeStateWorkFunction(int? countryId, DateTime startDate, DateTime endDate, string projectTimeState, string work_, string function_, string confirmedSize1, string confirmedSize2, string accessType)
        {
            if (accessType == "%")
            {
                ...
                {
                    FillDataWithStoredProcedure("LFS_LABOURHOURS_PRINTMANHOURSPERPHASERAGATEWAY_LOADBYSTARTDATEENDDATEPROJECTTIMESTATEWORKFUNCTIONCOUNTRYID", new SqlParameter("@startDate", startDate), new SqlParameter("@endDate", endDate), new SqlParameter("@projectTimeState", projectTimeState), new SqlParameter("@work_", work_), new SqlParameter("@function_", function_), new SqlParameter("@confirmedSize1", confirmedSize1), new SqlParameter("@confirmedSize2", confirmedSize2), new SqlParameter("@countryId", countryId));
                }
                else
                {
                    FillDataWithStoredProcedure("LFS_LABOURHOURS_PRINTMANHOURSPERPHASERAGATEWAY_LOADBYSTARTDATEENDDATEPROJECTTIMESTATEWORKFUNCTION", new SqlParameter("@startDate", startDate), new SqlParameter("@endDate", endDate), new SqlParameter("@projectTimeState", projectTimeState), new SqlParameter("@work_", work_), new SqlParameter("@function_", function_), new SqlParameter("@confirmedSize1", confirmedSize1), new SqlParameter("@confirmedSize2", confirmedSize2));
                }
            }
            else
            {
                FillDataWithStoredProcedure("LFS_LABOURHOURS_PRINTMANHOURSPERPHASERAGATEWAY_LOADBYSTARTDATEENDDATEPROJECTTIMESTATEWORKFUNCTIONBYACCESS", new SqlParameter("@startDate", startDate), new SqlParameter("@endDate", endDate), new SqlParameter("@projectTimeState", projectTimeState), new SqlParameter("@work_", work_), new SqlParameter("@function_", function_), new SqlParameter("@confirmedSize1", confirmedSize1), new SqlParameter("@confirmedSize2", confirmedSize2), new SqlParameter("@accessType", accessType));
            }
        ...
        public DataSet LoadByCompaniesIdStartDateEndDateProjectTimeStateWorkFunction(int companiesId, DateTime startDate, DateTime endDate, string projectTimeState, string work_, string function_, string confirmedSize1, string confirmedSize2, string accessType)
        {
            if (accessType == "%")
            {
                FillDataWithStoredProcedure("LFS_LABOURHOURS_PRINTMANHOURSPERPHASERAGATEWAY_LOADBYCOMPANIESIDSTARTDATEENDDATEPROJECTTIMESTATEWORKFUNCTION", new SqlParameter("@companiesId", companiesId), new SqlParameter("@startDate", startDate), new SqlParameter("@endDate", endDate), new SqlParameter("@projectTimeState", projectTimeState), new SqlParameter("@work_", work_), new SqlParameter("@function_", function_), new SqlParameter("@confirmedSize1", confirmedSize1), new SqlParameter("@confirmedSize2", confirmedSize2));
            }
            else
            {
                FillDataWithStoredProcedure("LFS_LABOURHOURS_PRINTMANHOURSPERPHASERAGATEWAY_LOADBYCOMPANIESIDSTARTDATEENDDATEPROJECTTIMESTATEWORKFUNCTIONBYACCESS", new SqlParameter("@companiesId", companiesId), new SqlParameter("@startDate", startDate), new SqlParameter("@endDate", endDate), new SqlParameter("@projectTimeState", projectTimeState), new SqlParameter("@work_", work_), new SqlParameter("@function_", function_), new SqlParameter("@confirmedSize1", confirmedSize1), new SqlParameter("@confirmedSize2", confirmedSize2), new SqlParameter("@accessType", accessType));
            }
