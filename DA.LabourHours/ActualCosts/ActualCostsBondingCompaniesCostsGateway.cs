...
{
    /// <summary>
    /// ActualCostsBondingCompaniesCostsGateway
    /// </summary>
    public class ActualCostsBondingCompaniesCostsGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ActualCostsBondingCompaniesCostsGateway()
            : base("LFS_LABOUR_HOURS_ACTUAL_COSTS_BONDING_COSTS")
        {
        }
        ...
        public ActualCostsBondingCompaniesCostsGateway(DataSet data)
            : base(data, "LFS_LABOUR_HOURS_ACTUAL_COSTS_BONDING_COSTS")
        {
        }
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "LFS_LABOUR_HOURS_ACTUAL_COSTS_BONDING_COSTS";
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[LFS_LABOUR_HOURS_ACTUAL_COSTS_BONDING_COSTS] WHERE (([ProjectID] = @Original_ProjectID) AND ([RefID] = @Original_RefID) AND ([BondingCompanyID] = @Original_BondingCompanyID) AND ([Date] = @Original_Date) AND ([RateCad] = @Original_RateCad) AND ([RateUsd] = @Original_RateUsd) AND ([Deleted] = @Original_Deleted) AND ([COMPANY_ID] = @Original_COMPANY_ID))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[LFS_LABOUR_HOURS_ACTUAL_COSTS_BONDING_COSTS] ([ProjectID], [RefID], [BondingCompanyID], [Date], [RateCad], [RateUsd], [Comment], [Deleted], [COMPANY_ID]) VALUES (@ProjectID, @RefID, @BondingCompanyID, @Date, @RateCad, @RateUsd, @Comment, @Deleted, @COMPANY_ID);
SELECT ProjectID, RefID, BondingCompanyID, Date, RateCad, RateUsd, Comment, Deleted, COMPANY_ID FROM LFS_LABOUR_HOURS_ACTUAL_COSTS_BONDING_COSTS WHERE (ProjectID = @ProjectID) AND (RefID = @RefID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[LFS_LABOUR_HOURS_ACTUAL_COSTS_BONDING_COSTS] SET [ProjectID] = @ProjectID, [RefID] = @RefID, [BondingCompanyID] = @BondingCompanyID, [Date] = @Date, [RateCad] = @RateCad, [RateUsd] = @RateUsd, [Comment] = @Comment, [Deleted] = @Deleted, [COMPANY_ID] = @COMPANY_ID WHERE (([ProjectID] = @Original_ProjectID) AND ([RefID] = @Original_RefID) AND ([BondingCompanyID] = @Original_BondingCompanyID) AND ([Date] = @Original_Date) AND ([RateCad] = @Original_RateCad) AND ([RateUsd] = @Original_RateUsd) AND ([Deleted] = @Original_Deleted) AND ([COMPANY_ID] = @Original_COMPANY_ID));
SELECT ProjectID, RefID, BondingCompanyID, Date, RateCad, RateUsd, Comment, Deleted, COMPANY_ID FROM LFS_LABOUR_HOURS_ACTUAL_COSTS_BONDING_COSTS WHERE (ProjectID = @ProjectID) AND (RefID = @RefID)";
        ...
        /// <summary>
        /// Insert a  bondingCompanies cost (direct to DB)
        /// </summary>
        ...
        public int Insert(int projectId, int refId, int bondingCompanyId, DateTime date, decimal rateCad, decimal rateUsd, string comment, bool deleted, int companyId)
        {
            ...
            string command = "INSERT INTO [dbo].[LFS_LABOUR_HOURS_ACTUAL_COSTS_BONDING_COSTS] ([ProjectID], [RefID], [BondingCompanyID], [Date], [RateCad], [RateUsd], [Comment], [Deleted], [COMPANY_ID]) VALUES (@ProjectID, @RefID, @BondingCompanyID, @Date, @RateCad, @RateUsd, @Comment, @Deleted, @COMPANY_ID)";

            int rowsAffected = (int)ExecuteNonQuery(command, projectIdParameter, refIdParameter, bondingCompanyIdParameter, dateParameter, rateCadParameter, rateUsdParameter, commentParameter, deletedParameter, companyIdParameter);
        ...
        /// <summary>
        /// Update service bondingCompanies cost (direct to DB)
        /// </summary>
        ...
        public int Update(int originalProjectId, int originalRefId, int originalBondingCompanyId, DateTime originalDate, decimal originalRateCad, decimal originalRateUsd, string originalComment, bool originalDeleted, int originalCompanyId, int newProjectId, int newRefId, int newBondingCompanyId, DateTime newDate,  decimal newRateCad, decimal newRateUsd,  string newComment, bool newDeleted, int newCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_LABOUR_HOURS_ACTUAL_COSTS_BONDING_COSTS] SET [BondingCompanyID] = @BondingCompanyID, [Date] = @Date, [RateCad] = @RateCad,  [RateUsd] = @RateUsd, [Comment] = @Comment " +
                " WHERE (([ProjectID] = @Original_ProjectID) AND ([RefID] = @Original_RefID))";

            int rowsAffected = (int)ExecuteNonQuery(command, originalProjectIdParameter, originalRefIdParameter, originalBondingCompanyIdParameter, originalDateParameter, originalRateCadParameter, originalRateUsdParameter, originalCommentParameter, originalDeletedParameter, originalCompanyIdParameter, newProjectIdParameter, newRefIdParameter, newBondingCompanyIdParameter, newDateParameter, newRateCadParameter, newRateUsdParameter, newCommentParameter, newDeletedParameter, newCompanyIdParameter);
        ...
        public int Delete(int originalProjectId, int originalRefId, int originalCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_LABOUR_HOURS_ACTUAL_COSTS_BONDING_COSTS] SET  [Deleted] = @Deleted  " +
                             " WHERE (([ProjectID] = @Original_ProjectID) AND ([RefID] = @Original_RefID))";
