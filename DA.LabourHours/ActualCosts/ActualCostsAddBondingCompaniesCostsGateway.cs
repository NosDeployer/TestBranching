...
{
    /// <summary>
    /// ActualCostsAddBondingCompaniesCostsGateway
    /// </summary>
    public class ActualCostsAddBondingCompaniesCostsGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ActualCostsAddBondingCompaniesCostsGateway()
        ...
        public ActualCostsAddBondingCompaniesCostsGateway(DataSet data)
        ...
        {
            FillDataWithStoredProcedure("LFS_LABOURHOURS_ACTUALCOSTSADDBONDINGCOMPANIESCOSTSGATEWAY_LOADALLBYPROJECTID", new SqlParameter("@projectId", projectId), new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        public DataRow GetRow(int projectId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.LabourHours.ActualCosts.ActualCostsAddBondingCompaniesCostsGateway.GetRow");
            }
        }
