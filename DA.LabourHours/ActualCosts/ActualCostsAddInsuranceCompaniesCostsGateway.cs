...
{
    /// <summary>
    /// ActualCostsAddInsuranceCompaniesCostsGateway
    /// </summary>
    public class ActualCostsAddInsuranceCompaniesCostsGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ActualCostsAddInsuranceCompaniesCostsGateway()
        ...
        public ActualCostsAddInsuranceCompaniesCostsGateway(DataSet data)
        ...
        {
            FillDataWithStoredProcedure("LFS_LABOURHOURS_ACTUALCOSTSADDINSURANCECOMPANIESCOSTSGATEWAY_LOADALLBYPROJECTID", new SqlParameter("@projectId", projectId), new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        public DataRow GetRow(int projectId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.LabourHours.ActualCosts.ActualCostsAddInsuranceCompaniesCostsGateway.GetRow");
            }
        }
