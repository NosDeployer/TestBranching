...
{
    /// <summary>
    /// ActualCostsHotelCostsGateway
    /// </summary>
    public class ActualCostsHotelCostsGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ActualCostsHotelCostsGateway()
        ...
        public ActualCostsHotelCostsGateway(DataSet data)
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "LFS_LABOUR_HOURS_ACTUAL_COSTS_HOTEL_COSTS";
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[LFS_LABOUR_HOURS_ACTUAL_COSTS_HOTEL_COSTS] WHERE (([ProjectID] = @Original_ProjectID) AND ([RefID] = @Original_RefID) AND ([HotelID] = @Original_HotelID) AND ([Date] = @Original_Date) AND ([RateCad] = @Original_RateCad) AND ([RateUsd] = @Original_RateUsd) AND ([Deleted] = @Original_Deleted) AND ([COMPANY_ID] = @Original_COMPANY_ID))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[LFS_LABOUR_HOURS_ACTUAL_COSTS_HOTEL_COSTS] ([ProjectID], [RefID], [HotelID], [Date], [RateCad], [RateUsd], [Comment], [Deleted], [COMPANY_ID]) VALUES (@ProjectID, @RefID, @HotelID, @Date, @RateCad, @RateUsd, @Comment, @Deleted, @COMPANY_ID);
SELECT ProjectID, RefID, HotelID, Date, RateCad, RateUsd, Comment, Deleted, COMPANY_ID FROM LFS_LABOUR_HOURS_ACTUAL_COSTS_HOTEL_COSTS WHERE (ProjectID = @ProjectID) AND (RefID = @RefID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[LFS_LABOUR_HOURS_ACTUAL_COSTS_HOTEL_COSTS] SET [ProjectID] = @ProjectID, [RefID] = @RefID, [HotelID] = @HotelID, [Date] = @Date, [RateCad] = @RateCad, [RateUsd] = @RateUsd, [Comment] = @Comment, [Deleted] = @Deleted, [COMPANY_ID] = @COMPANY_ID WHERE (([ProjectID] = @Original_ProjectID) AND ([RefID] = @Original_RefID) AND ([HotelID] = @Original_HotelID) AND ([Date] = @Original_Date) AND ([RateCad] = @Original_RateCad) AND ([RateUsd] = @Original_RateUsd) AND ([Deleted] = @Original_Deleted) AND ([COMPANY_ID] = @Original_COMPANY_ID));
SELECT ProjectID, RefID, HotelID, Date, RateCad, RateUsd, Comment, Deleted, COMPANY_ID FROM LFS_LABOUR_HOURS_ACTUAL_COSTS_HOTEL_COSTS WHERE (ProjectID = @ProjectID) AND (RefID = @RefID)";
        ...
        /// <summary>
        /// Insert a  hotel cost (direct to DB)
        /// </summary>
        ...
        public int Insert(int projectId, int refId, int hotelId, DateTime date, decimal rateCad, decimal rateUsd, string comment, bool deleted, int companyId)
        {
            ...
            string command = "INSERT INTO [dbo].[LFS_LABOUR_HOURS_ACTUAL_COSTS_HOTEL_COSTS] ([ProjectID], [RefID], [HotelID], [Date], [RateCad], [RateUsd], [Comment], [Deleted], [COMPANY_ID]) VALUES (@ProjectID, @RefID, @HotelID, @Date, @RateCad, @RateUsd, @Comment, @Deleted, @COMPANY_ID)";

            int rowsAffected = (int)ExecuteNonQuery(command, projectIdParameter, refIdParameter, hotelIdParameter, dateParameter, rateCadParameter, rateUsdParameter, commentParameter, deletedParameter, companyIdParameter);
        ...
        /// <summary>
        /// Update hotel cost (direct to DB)
        /// </summary>
        ...
        public int Update(int originalProjectId, int originalRefId, int originalHotelId, DateTime originalDate, decimal originalRateCad, decimal originalRateUsd, string originalComment, bool originalDeleted, int originalCompanyId, int newProjectId, int newRefId, int newHotelId, DateTime newDate,  decimal newRateCad, decimal newRateUsd,  string newComment, bool newDeleted, int newCompanyId)
        {
            ...
            SqlParameter originalHotelIdParameter = new SqlParameter("Original_HotelID", originalHotelId);
            ...
            SqlParameter newHotelIdParameter = new SqlParameter("HotelID", newHotelId);
            ...
            string command = "UPDATE [dbo].[LFS_LABOUR_HOURS_ACTUAL_COSTS_HOTEL_COSTS] SET [HotelID] = @HotelID, [Date] = @Date, [RateCad] = @RateCad,  [RateUsd] = @RateUsd, [Comment] = @Comment " +
                " WHERE (([ProjectID] = @Original_ProjectID) AND ([RefID] = @Original_RefID))";

            int rowsAffected = (int)ExecuteNonQuery(command, originalProjectIdParameter, originalRefIdParameter, originalHotelIdParameter, originalDateParameter, originalRateCadParameter, originalRateUsdParameter, originalCommentParameter, originalDeletedParameter, originalCompanyIdParameter, newProjectIdParameter, newRefIdParameter, newHotelIdParameter, newDateParameter, newRateCadParameter, newRateUsdParameter, newCommentParameter, newDeletedParameter, newCompanyIdParameter);
        ...
        public int Delete(int originalProjectId, int originalRefId, int originalCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_LABOUR_HOURS_ACTUAL_COSTS_HOTEL_COSTS] SET  [Deleted] = @Deleted  " +
                             " WHERE (([ProjectID] = @Original_ProjectID) AND ([RefID] = @Original_RefID))";
