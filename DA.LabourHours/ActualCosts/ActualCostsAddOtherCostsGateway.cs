...
{
    /// <summary>
    /// ActualCostsAddOtherCostsGateway
    /// </summary>
    public class ActualCostsAddOtherCostsGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ActualCostsAddOtherCostsGateway()
            : base("OtherCosts")
        {
        }
        ...
        public ActualCostsAddOtherCostsGateway(DataSet data)
        ...
        {
            FillDataWithStoredProcedure("LFS_LABOURHOURS_ACTUALCOSTSADDOTHERCOSTSGATEWAY_LOADALLBYPROJECTID", new SqlParameter("@projectId", projectId), new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        public DataRow GetRow(int projectId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.LabourHours.ActualCosts.ActualCostsAddOtherCostsGateway.GetRow");
            }
        }
