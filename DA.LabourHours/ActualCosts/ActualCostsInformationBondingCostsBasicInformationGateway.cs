...
{
    /// <summary>
    ///  ActualCostsInformationBondingCostsBasicInformationGateway
    /// </summary>
    public class  ActualCostsInformationBondingCostsBasicInformationGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public  ActualCostsInformationBondingCostsBasicInformationGateway()
        ...
        public  ActualCostsInformationBondingCostsBasicInformationGateway(DataSet data)
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "BondingCostsBasicInformation";
        ...
        {
            FillDataWithStoredProcedure("LFS_LABOURHOURS_ACTUALCOSTSINFORMATIONBONDINGCOSTSBASICINFORMATIONGATEWAY_LOADBYPROJECTIDREFID", new SqlParameter("@projectId", projectId), new SqlParameter("@refId", refId), new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        public DataRow GetRow(int projectId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.LabourHours.ActualCosts.ActualCostsInformationBondingCostsBasicInformationGateway.GetRow");
            }
        }
        ...
        /// <param name="projectId">projectId</param>
        /// <param name="refId">refId</param>        
        /// <returns>BondingID or EMPTY</returns>
        public int GetBondingID(int projectId, int refId)
        {
            return (int)GetRow(projectId, refId)["BondingCompanyID"];
        }



        /// <summary>
        /// GetBondingID Original
        /// </summary>
        /// <param name="projectId">projectId</param>
        /// <param name="refId">refId</param>        
        /// <returns>Original BondingID or EMPTY</returns>
        public int GetBondingIDOriginal(int projectId, int refId)
        {
            return (int)GetRow(projectId, refId)["BondingCompanyID", DataRowVersion.Original];
        }
        ...
        /// <param name="projectId">projectId</param>
        /// <param name="refId">refId</param>        
        /// <returns>Bonding or EMPTY</returns>
        public string GetBonding(int projectId, int refId)
        {
            if (GetRow(projectId, refId).IsNull("Bonding"))
            {
                return "";
            }
            else
            {
                return (string)GetRow(projectId, refId)["Bonding"];
            }
        }
        ...
        /// <param name="projectId">projectId</param>
        /// <param name="refId">refId</param>        
        /// <returns>Original Bonding or EMPTY</returns>
        public string GetBondingOriginal(int projectId, int refId)
        {
            if (GetRow(projectId, refId).IsNull(Table.Columns["Bonding"], DataRowVersion.Original))
            {
                return "";
            }
            else
            {
                return (string)GetRow(projectId, refId)["Bonding", DataRowVersion.Original];
            }
        }
