...
namespace LiquiForce.LFSLive.DA.LabourHours.ActualCosts
{
    ...
    /// </summary>
    public class ActualCostsInformationSubcontractorBasicInformationGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ActualCostsInformationSubcontractorBasicInformationGateway()
        ...
        public ActualCostsInformationSubcontractorBasicInformationGateway(DataSet data)
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "SubcontractorBasicInformation";            
        ...
        {
            FillDataWithStoredProcedure("LFS_LABOURHOURS_ACTUALCOSTSINFORMATIONSUBCONTRACTORBASICINFORMATIONGATEWAY_LOADBYPROJECTIDREFID", new SqlParameter("@projectId", projectId), new SqlParameter("@refId", refId), new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        public DataRow GetRow(int projectId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.LabourHours.ActualCosts.ActualCostsInformationSubcontractorBasicInformationGateway.GetRow");
            }
        }
