...
{
    /// <summary>
    /// ActualCostsAddSubcontractorCostsGateway
    /// </summary>
    public class ActualCostsAddSubcontractorCostsGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ActualCostsAddSubcontractorCostsGateway()
        ...
        public ActualCostsAddSubcontractorCostsGateway(DataSet data)
        ...
        {
            FillDataWithStoredProcedure("LFS_LABOURHOURS_ACTUALCOSTSADDSUBCONTRACTORHOURSGATEWAY_LOADALLBYPROJECTID", new SqlParameter("@projectId", projectId), new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        public DataRow GetRow(int projectId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.LabourHours.ActualCosts.ActualCostsAddSubcontractorCostsGateway.GetRow");
            }
        }
