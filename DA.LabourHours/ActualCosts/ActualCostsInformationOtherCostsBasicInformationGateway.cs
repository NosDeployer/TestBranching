...
{
    /// <summary>
    ///  ActualCostsInformationOtherCostsBasicInformationGateway
    /// </summary>
    public class  ActualCostsInformationOtherCostsBasicInformationGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public  ActualCostsInformationOtherCostsBasicInformationGateway()
        ...
        public  ActualCostsInformationOtherCostsBasicInformationGateway(DataSet data)
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "OtherCostsBasicInformation";
        ...
        {
            FillDataWithStoredProcedure("LFS_LABOURHOURS_ACTUALCOSTSINFORMATIONOTHERCOSTSBASICINFORMATIONGATEWAY_LOADBYPROJECTIDREFID", new SqlParameter("@projectId", projectId), new SqlParameter("@refId", refId), new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        public DataRow GetRow(int projectId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.LabourHours.ActualCosts.ActualCostsInformationOtherCostsBasicInformationGateway.GetRow");
            }
        }
        ...
        /// <param name="projectId">projectId</param>
        /// <param name="refId">refId</param>        
        /// <returns>OtherID or EMPTY</returns>
        public int GetOtherID(int projectId, int refId)
        {
            return (int)GetRow(projectId, refId)["OtherID"];
        }
        ...
        /// <param name="projectId">projectId</param>
        /// <param name="refId">refId</param>        
        /// <returns>Original OtherID or EMPTY</returns>
        public int GetOtherIDOriginal(int projectId, int refId)
        {
            return (int)GetRow(projectId, refId)["OtherID", DataRowVersion.Original];
        }
        ...
        /// <param name="projectId">projectId</param>
        /// <param name="refId">refId</param>        
        /// <returns>Category or EMPTY</returns>
        public string GetCategory(int projectId, int refId)
        {
            if (GetRow(projectId, refId).IsNull("Category"))
            {
                return "";
            }
            else
            {
                return (string)GetRow(projectId, refId)["Category"];
            }
        }
        ...
        public string GetCategoryOriginal(int projectId, int refId)
        {
            if (GetRow(projectId, refId).IsNull(Table.Columns["Category"], DataRowVersion.Original))
            {
                return "";
            }
            else
            {
                return (string)GetRow(projectId, refId)["Category", DataRowVersion.Original];
            }
        }
