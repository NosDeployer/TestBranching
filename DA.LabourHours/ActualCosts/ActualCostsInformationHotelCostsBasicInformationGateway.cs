...
{
    /// <summary>
    ///  ActualCostsInformationHotelCostsBasicInformationGateway
    /// </summary>
    public class  ActualCostsInformationHotelCostsBasicInformationGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public  ActualCostsInformationHotelCostsBasicInformationGateway()
        ...
        public  ActualCostsInformationHotelCostsBasicInformationGateway(DataSet data)
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "HotelCostsBasicInformation";
        ...
        {
            FillDataWithStoredProcedure("LFS_LABOURHOURS_ACTUALCOSTSINFORMATIONHOTELCOSTSBASICINFORMATIONGATEWAY_LOADBYPROJECTIDREFID", new SqlParameter("@projectId", projectId), new SqlParameter("@refId", refId), new SqlParameter("@companyId", companyId));
            return Data;
        }
        ...
        public DataRow GetRow(int projectId, int refId)
        {
            ...
            {
                throw new Exception("Unavailable row in LiquiForce.LFSLive.DA.LabourHours.ActualCosts.ActualCostsInformationHotelCostsBasicInformationGateway.GetRow");
            }
        }
        ...
        /// <param name="projectId">projectId</param>
        /// <param name="refId">refId</param>        
        /// <returns>HotelID or EMPTY</returns>
        public int GetHotelID(int projectId, int refId)
        {
            return (int)GetRow(projectId, refId)["HotelID"];
        }
        ...
        /// <param name="projectId">projectId</param>
        /// <param name="refId">refId</param>        
        /// <returns>Original HotelID or EMPTY</returns>
        public int GetHotelIDOriginal(int projectId, int refId)
        {
            return (int)GetRow(projectId, refId)["HotelID", DataRowVersion.Original];
        }
        ...
        /// <param name="projectId">projectId</param>
        /// <param name="refId">refId</param>        
        /// <returns>Hotel or EMPTY</returns>
        public string GetHotel(int projectId, int refId)
        {
            if (GetRow(projectId, refId).IsNull("Hotel"))
            {
                return "";
            }
            else
            {
                return (string)GetRow(projectId, refId)["Hotel"];
            }
        }
        ...
        /// <param name="projectId">projectId</param>
        /// <param name="refId">refId</param>        
        /// <returns>Original Hotel or EMPTY</returns>
        public string GetHotelOriginal(int projectId, int refId)
        {
            if (GetRow(projectId, refId).IsNull(Table.Columns["Hotel"], DataRowVersion.Original))
            {
                return "";
            }
            else
            {
                return (string)GetRow(projectId, refId)["Hotel", DataRowVersion.Original];
            }
        }
