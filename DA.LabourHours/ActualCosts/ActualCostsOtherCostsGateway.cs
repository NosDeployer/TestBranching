...
{
    /// <summary>
    /// ActualCostsOtherCostsGateway
    /// </summary>
    public class ActualCostsOtherCostsGateway : DataTableGateway
    {
        // ////////////////////////////////////////////////////////////////////////
        // CONSTRUCTORS
        //
        ...
        /// Constructor
        /// </summary>
        public ActualCostsOtherCostsGateway()
        ...
        public ActualCostsOtherCostsGateway(DataSet data)
        ...
        protected override void InitAdapter()
        {
            ...
            tableMapping.DataSetTable = "LFS_LABOUR_HOURS_ACTUAL_COSTS_OTHER_COSTS";
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[LFS_LABOUR_HOURS_ACTUAL_COSTS_OTHER_COSTS] WHERE (([ProjectID] = @Original_ProjectID) AND ([RefID] = @Original_RefID) AND ([Category] = @Original_Category) AND ([Date] = @Original_Date) AND ([RateCad] = @Original_RateCad) AND ([RateUsd] = @Original_RateUsd) AND ([Deleted] = @Original_Deleted) AND ([COMPANY_ID] = @Original_COMPANY_ID))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[LFS_LABOUR_HOURS_ACTUAL_COSTS_OTHER_COSTS] ([ProjectID], [RefID], [Category], [Date], [RateCad], [RateUsd], [Comment], [Deleted], [COMPANY_ID]) VALUES (@ProjectID, @RefID, @Category, @Date, @RateCad, @RateUsd, @Comment, @Deleted, @COMPANY_ID);
SELECT ProjectID, RefID, Category, Date, RateCad, RateUsd, Comment, Deleted, COMPANY_ID FROM LFS_LABOUR_HOURS_ACTUAL_COSTS_OTHER_COSTS WHERE (ProjectID = @ProjectID) AND (RefID = @RefID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[LFS_LABOUR_HOURS_ACTUAL_COSTS_OTHER_COSTS] SET [ProjectID] = @ProjectID, [RefID] = @RefID, [Category] = @Category, [Date] = @Date, [RateCad] = @RateCad, [RateUsd] = @RateUsd, [Comment] = @Comment, [Deleted] = @Deleted, [COMPANY_ID] = @COMPANY_ID WHERE (([ProjectID] = @Original_ProjectID) AND ([RefID] = @Original_RefID) AND ([Category] = @Original_Category) AND ([Date] = @Original_Date) AND ([RateCad] = @Original_RateCad) AND ([RateUsd] = @Original_RateUsd) AND ([Deleted] = @Original_Deleted) AND ([COMPANY_ID] = @Original_COMPANY_ID));
SELECT ProjectID, RefID, Category, Date, RateCad, RateUsd, Comment, Deleted, COMPANY_ID FROM LFS_LABOUR_HOURS_ACTUAL_COSTS_OTHER_COSTS WHERE (ProjectID = @ProjectID) AND (RefID = @RefID)";
        ...
        /// <summary>
        /// Insert other cost (direct to DB)
        /// </summary>
        ...
        public int Insert(int projectId, int refId, string category, DateTime date, decimal rateCad, decimal rateUsd, string comment, bool deleted, int companyId)
        {
            ...
            SqlParameter categoryParameter = new SqlParameter("Category", category.Trim());
            ...
            string command = "INSERT INTO [dbo].[LFS_LABOUR_HOURS_ACTUAL_COSTS_OTHER_COSTS] ([ProjectID], [RefID], [Category], [Date], [RateCad], [RateUsd], [Comment], [Deleted], [COMPANY_ID]) VALUES (@ProjectID, @RefID, @Category, @Date, @RateCad, @RateUsd, @Comment, @Deleted, @COMPANY_ID)";

            int rowsAffected = (int)ExecuteNonQuery(command, projectIdParameter, refIdParameter, categoryParameter, dateParameter, rateCadParameter, rateUsdParameter, commentParameter, deletedParameter, companyIdParameter);
        ...
        /// <summary>
        /// Update other cost (direct to DB)
        /// </summary>
        ...
        public int Update(int originalProjectId, int originalRefId, string originalCategory, DateTime originalDate, decimal originalRateCad, decimal originalRateUsd, string originalComment, bool originalDeleted, int originalCompanyId, int newProjectId, int newRefId, string newCategory, DateTime newDate,  decimal newRateCad, decimal newRateUsd,  string newComment, bool newDeleted, int newCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_LABOUR_HOURS_ACTUAL_COSTS_OTHER_COSTS] SET [Category] = @Category, [Date] = @Date, [RateCad] = @RateCad,  [RateUsd] = @RateUsd, [Comment] = @Comment " +
                " WHERE (([ProjectID] = @Original_ProjectID) AND ([RefID] = @Original_RefID))";

            int rowsAffected = (int)ExecuteNonQuery(command, originalProjectIdParameter, originalRefIdParameter, originalCategoryParameter, originalDateParameter, originalRateCadParameter, originalRateUsdParameter, originalCommentParameter, originalDeletedParameter, originalCompanyIdParameter, newProjectIdParameter, newRefIdParameter, newCategoryParameter, newDateParameter, newRateCadParameter, newRateUsdParameter, newCommentParameter, newDeletedParameter, newCompanyIdParameter);
        ...
        public int Delete(int originalProjectId, int originalRefId, int originalCompanyId)
        {
            ...
            string command = "UPDATE [dbo].[LFS_LABOUR_HOURS_ACTUAL_COSTS_OTHER_COSTS] SET  [Deleted] = @Deleted  " +
                             " WHERE (([ProjectID] = @Original_ProjectID) AND ([RefID] = @Original_RefID))";
